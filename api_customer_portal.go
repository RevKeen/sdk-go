...
Offset-based with `limit` (default 25, max 100) and `offset`. The response `pagination` block includes `total` and `hasMore`. See [the pagination guide](/docs/fundamentals/pagination) for SDK auto-paging helpers.
	...
	*/
	...
	/*
	CustomerPortalMandatesCancel Cancel a Direct Debit mandate
...
Pass an `Idempotency-Key` header (UUID v4 recommended) to make retries safe. Keys are valid for 24 hours; see [the idempotency guide](/docs/fundamentals/idempotency).
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id Mandate ID
	@return ApiCustomerPortalMandatesCancelRequest
	*/
	CustomerPortalMandatesCancel(ctx context.Context, id string) ApiCustomerPortalMandatesCancelRequest

	// CustomerPortalMandatesCancelExecute executes the request
	//  @return CustomerPortalMandatesCancel200Response
	CustomerPortalMandatesCancelExecute(r ApiCustomerPortalMandatesCancelRequest) (*CustomerPortalMandatesCancel200Response, *http.Response, error)

	/*
	CustomerPortalMandatesList List the authenticated customer's Direct Debit mandates
...
Offset-based with `limit` (default 25, max 100) and `offset`. The response `pagination` block includes `total` and `hasMore`. See [the pagination guide](/docs/fundamentals/pagination) for SDK auto-paging helpers.
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiCustomerPortalMandatesListRequest
	*/
	CustomerPortalMandatesList(ctx context.Context) ApiCustomerPortalMandatesListRequest

	// CustomerPortalMandatesListExecute executes the request
	//  @return PortalMandateList
	CustomerPortalMandatesListExecute(r ApiCustomerPortalMandatesListRequest) (*PortalMandateList, *http.Response, error)

	/*
	CustomerPortalMandatesReauthorize Re-authorise a Direct Debit mandate with new bank details
...
Pass an `Idempotency-Key` header (UUID v4 recommended) to make retries safe. Keys are valid for 24 hours; see [the idempotency guide](/docs/fundamentals/idempotency).
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id ID of the mandate being replaced.
	@return ApiCustomerPortalMandatesReauthorizeRequest
	*/
	CustomerPortalMandatesReauthorize(ctx context.Context, id string) ApiCustomerPortalMandatesReauthorizeRequest

	// CustomerPortalMandatesReauthorizeExecute executes the request
	//  @return PortalReauthorizeMandateResponse
	CustomerPortalMandatesReauthorizeExecute(r ApiCustomerPortalMandatesReauthorizeRequest) (*PortalReauthorizeMandateResponse, *http.Response, error)

	/*
	CustomerPortalMandatesReauthorizeSendOtp Send a step-up OTP for a Direct Debit bank-detail change
...
Pass an `Idempotency-Key` header (UUID v4 recommended) to make retries safe. Keys are valid for 24 hours; see [the idempotency guide](/docs/fundamentals/idempotency).
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id
	@return ApiCustomerPortalMandatesReauthorizeSendOtpRequest
	*/
	CustomerPortalMandatesReauthorizeSendOtp(ctx context.Context, id string) ApiCustomerPortalMandatesReauthorizeSendOtpRequest

	// CustomerPortalMandatesReauthorizeSendOtpExecute executes the request
	//  @return PortalReauthorizeSendOtpResponse
	CustomerPortalMandatesReauthorizeSendOtpExecute(r ApiCustomerPortalMandatesReauthorizeSendOtpRequest) (*PortalReauthorizeSendOtpResponse, *http.Response, error)

	/*
	CustomerPortalMandatesReauthorizeVerifyOtp Verify a step-up OTP and receive a change-of-bank token
...
Pass an `Idempotency-Key` header (UUID v4 recommended) to make retries safe. Keys are valid for 24 hours; see [the idempotency guide](/docs/fundamentals/idempotency).
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id
	@return ApiCustomerPortalMandatesReauthorizeVerifyOtpRequest
	*/
	CustomerPortalMandatesReauthorizeVerifyOtp(ctx context.Context, id string) ApiCustomerPortalMandatesReauthorizeVerifyOtpRequest

	// CustomerPortalMandatesReauthorizeVerifyOtpExecute executes the request
	//  @return PortalReauthorizeVerifyOtpResponse
	CustomerPortalMandatesReauthorizeVerifyOtpExecute(r ApiCustomerPortalMandatesReauthorizeVerifyOtpRequest) (*PortalReauthorizeVerifyOtpResponse, *http.Response, error)
...
type ApiCustomerPortalMandatesCancelRequest struct {
	ctx context.Context
	ApiService CustomerPortalAPI
	id string
...
func (r ApiCustomerPortalMandatesCancelRequest) PaymentLinksExpireRequest(paymentLinksExpireRequest PaymentLinksExpireRequest) ApiCustomerPortalMandatesCancelRequest {
	r.paymentLinksExpireRequest = &paymentLinksExpireRequest
	return r
}

func (r ApiCustomerPortalMandatesCancelRequest) Execute() (*CustomerPortalMandatesCancel200Response, *http.Response, error) {
	return r.ApiService.CustomerPortalMandatesCancelExecute(r)
}
...
Pass an `Idempotency-Key` header (UUID v4 recommended) to make retries safe. Keys are valid for 24 hours; see [the idempotency guide](/docs/fundamentals/idempotency).
 ...
 @return ApiCustomerPortalMandatesCancelRequest
*/
func (a *CustomerPortalAPIService) CustomerPortalMandatesCancel(ctx context.Context, id string) ApiCustomerPortalMandatesCancelRequest {
	return ApiCustomerPortalMandatesCancelRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return CustomerPortalMandatesCancel200Response
func (a *CustomerPortalAPIService) CustomerPortalMandatesCancelExecute(r ApiCustomerPortalMandatesCancelRequest) (*CustomerPortalMandatesCancel200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *CustomerPortalMandatesCancel200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CustomerPortalAPIService.CustomerPortalMandatesCancel")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/customer-portal/mandates/{id}/cancel"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
...
type ApiCustomerPortalMandatesListRequest struct {
	ctx context.Context
	ApiService CustomerPortalAPI
}

func (r ApiCustomerPortalMandatesListRequest) Execute() (*PortalMandateList, *http.Response, error) {
	return r.ApiService.CustomerPortalMandatesListExecute(r)
}
...
Offset-based with `limit` (default 25, max 100) and `offset`. The response `pagination` block includes `total` and `hasMore`. See [the pagination guide](/docs/fundamentals/pagination) for SDK auto-paging helpers.
 ...
 @return ApiCustomerPortalMandatesListRequest
*/
func (a *CustomerPortalAPIService) CustomerPortalMandatesList(ctx context.Context) ApiCustomerPortalMandatesListRequest {
	return ApiCustomerPortalMandatesListRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return PortalMandateList
func (a *CustomerPortalAPIService) CustomerPortalMandatesListExecute(r ApiCustomerPortalMandatesListRequest) (*PortalMandateList, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *PortalMandateList
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CustomerPortalAPIService.CustomerPortalMandatesList")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/customer-portal/mandates"
...
type ApiCustomerPortalMandatesReauthorizeRequest struct {
	ctx context.Context
	ApiService CustomerPortalAPI
	id string
	portalReauthorizeMandateRequest *PortalReauthorizeMandateRequest
}

func (r ApiCustomerPortalMandatesReauthorizeRequest) PortalReauthorizeMandateRequest(portalReauthorizeMandateRequest PortalReauthorizeMandateRequest) ApiCustomerPortalMandatesReauthorizeRequest {
	r.portalReauthorizeMandateRequest = &portalReauthorizeMandateRequest
	return r
}

func (r ApiCustomerPortalMandatesReauthorizeRequest) Execute() (*PortalReauthorizeMandateResponse, *http.Response, error) {
	return r.ApiService.CustomerPortalMandatesReauthorizeExecute(r)
}
...
Pass an `Idempotency-Key` header (UUID v4 recommended) to make retries safe. Keys are valid for 24 hours; see [the idempotency guide](/docs/fundamentals/idempotency).
 ...
 @return ApiCustomerPortalMandatesReauthorizeRequest
*/
func (a *CustomerPortalAPIService) CustomerPortalMandatesReauthorize(ctx context.Context, id string) ApiCustomerPortalMandatesReauthorizeRequest {
	return ApiCustomerPortalMandatesReauthorizeRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return PortalReauthorizeMandateResponse
func (a *CustomerPortalAPIService) CustomerPortalMandatesReauthorizeExecute(r ApiCustomerPortalMandatesReauthorizeRequest) (*PortalReauthorizeMandateResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *PortalReauthorizeMandateResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CustomerPortalAPIService.CustomerPortalMandatesReauthorize")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/customer-portal/mandates/{id}/re-authorize"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.portalReauthorizeMandateRequest == nil {
		return localVarReturnValue, nil, reportError("portalReauthorizeMandateRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.portalReauthorizeMandateRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["apiKey"]; ok {
...
type ApiCustomerPortalMandatesReauthorizeSendOtpRequest struct {
	ctx context.Context
	ApiService CustomerPortalAPI
	id string
}

func (r ApiCustomerPortalMandatesReauthorizeSendOtpRequest) Execute() (*PortalReauthorizeSendOtpResponse, *http.Response, error) {
	return r.ApiService.CustomerPortalMandatesReauthorizeSendOtpExecute(r)
}
...
Pass an `Idempotency-Key` header (UUID v4 recommended) to make retries safe. Keys are valid for 24 hours; see [the idempotency guide](/docs/fundamentals/idempotency).
 ...
 @return ApiCustomerPortalMandatesReauthorizeSendOtpRequest
*/
func (a *CustomerPortalAPIService) CustomerPortalMandatesReauthorizeSendOtp(ctx context.Context, id string) ApiCustomerPortalMandatesReauthorizeSendOtpRequest {
	return ApiCustomerPortalMandatesReauthorizeSendOtpRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return PortalReauthorizeSendOtpResponse
func (a *CustomerPortalAPIService) CustomerPortalMandatesReauthorizeSendOtpExecute(r ApiCustomerPortalMandatesReauthorizeSendOtpRequest) (*PortalReauthorizeSendOtpResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *PortalReauthorizeSendOtpResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CustomerPortalAPIService.CustomerPortalMandatesReauthorizeSendOtp")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/customer-portal/mandates/{id}/re-authorize/send-otp"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
...
type ApiCustomerPortalMandatesReauthorizeVerifyOtpRequest struct {
	ctx context.Context
	ApiService CustomerPortalAPI
	id string
	portalReauthorizeVerifyOtpRequest *PortalReauthorizeVerifyOtpRequest
}

func (r ApiCustomerPortalMandatesReauthorizeVerifyOtpRequest) PortalReauthorizeVerifyOtpRequest(portalReauthorizeVerifyOtpRequest PortalReauthorizeVerifyOtpRequest) ApiCustomerPortalMandatesReauthorizeVerifyOtpRequest {
	r.portalReauthorizeVerifyOtpRequest = &portalReauthorizeVerifyOtpRequest
	return r
}

func (r ApiCustomerPortalMandatesReauthorizeVerifyOtpRequest) Execute() (*PortalReauthorizeVerifyOtpResponse, *http.Response, error) {
	return r.ApiService.CustomerPortalMandatesReauthorizeVerifyOtpExecute(r)
}
...
Pass an `Idempotency-Key` header (UUID v4 recommended) to make retries safe. Keys are valid for 24 hours; see [the idempotency guide](/docs/fundamentals/idempotency).
 ...
 @return ApiCustomerPortalMandatesReauthorizeVerifyOtpRequest
*/
func (a *CustomerPortalAPIService) CustomerPortalMandatesReauthorizeVerifyOtp(ctx context.Context, id string) ApiCustomerPortalMandatesReauthorizeVerifyOtpRequest {
	return ApiCustomerPortalMandatesReauthorizeVerifyOtpRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return PortalReauthorizeVerifyOtpResponse
func (a *CustomerPortalAPIService) CustomerPortalMandatesReauthorizeVerifyOtpExecute(r ApiCustomerPortalMandatesReauthorizeVerifyOtpRequest) (*PortalReauthorizeVerifyOtpResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *PortalReauthorizeVerifyOtpResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CustomerPortalAPIService.CustomerPortalMandatesReauthorizeVerifyOtp")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/customer-portal/mandates/{id}/re-authorize/verify-otp"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.portalReauthorizeVerifyOtpRequest == nil {
		return localVarReturnValue, nil, reportError("portalReauthorizeVerifyOtpRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.portalReauthorizeVerifyOtpRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["apiKey"]; ok {
