...
type UsageBalanceMeter struct {
	...
	PackageSize NullableFloat32 `json:"package_size"`
	// Percentage rate in basis points when billing_scheme is percentage. 70 = 0.7%.
	PercentageRateBps NullableFloat32 `json:"percentage_rate_bps"`
	...
	LastEventAt NullableString `json:"last_event_at"`
...
func NewUsageBalanceMeter(meterId string, meterName string, priceName NullableString, unitName NullableString, billingScheme NullableString, tiersMode NullableString, unitAmountMinor NullableFloat32, packageSize NullableFloat32, percentageRateBps NullableFloat32, currentValue float32, includedQuantity float32, usedQuantity float32, remainingIncluded float32, overageQuantity float32, estimatedAmountMinor float32, totalCostMinor NullableFloat32, marginMinor NullableFloat32, currency string, periodStart string, periodEnd string, lastEventAt NullableString) *UsageBalanceMeter {
	...
	this.PercentageRateBps = percentageRateBps
...
// GetPriceName returns the PriceName field value
// If the value is explicit nil, the zero value for string will be returned
func (o *UsageBalanceMeter) GetPriceName() string {
	if o == nil || o.PriceName.Get() == nil {
		var ret string
		return ret
	}

	return *o.PriceName.Get()
}

// GetPriceNameOk returns a tuple with the PriceName field value
// and a boolean to check if the value has been set.
...
func (o *UsageBalanceMeter) GetPriceNameOk() (*string, bool) {
	...
	return o.PriceName.Get(), o.PriceName.IsSet()
}

// SetPriceName sets field value
...
func (o *UsageBalanceMeter) GetBillingScheme() string {
	if o == nil || o.BillingScheme.Get() == nil {
		var ret string
		return ret
	}

	return *o.BillingScheme.Get()
}
...
func (o *UsageBalanceMeter) GetUnitAmountMinor() float32 {
	if o == nil || o.UnitAmountMinor.Get() == nil {
		var ret float32
		return ret
	}

	return *o.UnitAmountMinor.Get()
}
...
func (o *UsageBalanceMeter) GetUnitAmountDecimal() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *UsageBalanceMeter) GetUnitAmountDecimalOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *UsageBalanceMeter) HasUnitAmountDecimal() bool {
...
func (o *UsageBalanceMeter) UnsetUnitAmountDecimal() {
...
// GetPercentageRateBps returns the PercentageRateBps field value
// If the value is explicit nil, the zero value for float32 will be returned
func (o *UsageBalanceMeter) GetPercentageRateBps() float32 {
	if o == nil || o.PercentageRateBps.Get() == nil {
		var ret float32
		return ret
	}
...
// GetPercentageRateBpsOk returns a tuple with the PercentageRateBps field value
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// SetPercentageRateBps sets field value
...
func (o UsageBalanceMeter) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["price_name"] = o.PriceName.Get()
	toSerialize["unit_name"] = o.UnitName.Get()
	toSerialize["billing_scheme"] = o.BillingScheme.Get()
	toSerialize["tiers_mode"] = o.TiersMode.Get()
	toSerialize["unit_amount_minor"] = o.UnitAmountMinor.Get()
...
func (o *UsageBalanceMeter) UnmarshalJSON(data []byte) (err error) {
	...
	*o = UsageBalanceMeter(varUsageBalanceMeter)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "price_name")
