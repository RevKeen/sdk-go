...
type PaymentMethod struct {
	...
	BacsDirectDebit BacsDirectDebitDetails `json:"bacs_direct_debit"`
...
func NewPaymentMethod(id string, object string, publicId NullableString, type_ string, status string, customerId string, isDefault bool, card CardDetails, usBankAccount BankAccountDetails, bacsDirectDebit BacsDirectDebitDetails, billingDetails BillingDetails, metadata map[string]interface{}, createdAt time.Time, updatedAt time.Time) *PaymentMethod {
	this := PaymentMethod{}
	this.Id = id
	this.Object = object
...
// GetBacsDirectDebit returns the BacsDirectDebit field value
func (o *PaymentMethod) GetBacsDirectDebit() BacsDirectDebitDetails {
	if o == nil {
		var ret BacsDirectDebitDetails
		return ret
	}

	return o.BacsDirectDebit
}

// GetBacsDirectDebitOk returns a tuple with the BacsDirectDebit field value
// and a boolean to check if the value has been set.
func (o *PaymentMethod) GetBacsDirectDebitOk() (*BacsDirectDebitDetails, bool) {
	if o == nil {
		return nil, false
	}
	return &o.BacsDirectDebit, true
}

// SetBacsDirectDebit sets field value
func (o *PaymentMethod) SetBacsDirectDebit(v BacsDirectDebitDetails) {
	o.BacsDirectDebit = v
}
...
func (o PaymentMethod) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["bacs_direct_debit"] = o.BacsDirectDebit
...
func (o *PaymentMethod) UnmarshalJSON(data []byte) (err error) {
	...
	*o = PaymentMethod(varPaymentMethod)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "bacs_direct_debit")
