...
// checks if the ListPaymentLinks200ResponseDataInnerLineItemsInnerProductDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListPaymentLinks200ResponseDataInnerLineItemsInnerProductDetails{}

// ListPaymentLinks200ResponseDataInnerLineItemsInnerProductDetails struct for ListPaymentLinks200ResponseDataInnerLineItemsInnerProductDetails
type ListPaymentLinks200ResponseDataInnerLineItemsInnerProductDetails struct {
	Name string `json:"name"`
	Description NullableString `json:"description,omitempty"`
	UnitAmount int32 `json:"unit_amount"`
	Currency string `json:"currency"`
	Recurring *ListPaymentLinks200ResponseDataInnerLineItemsInnerProductDetailsRecurring `json:"recurring,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _ListPaymentLinks200ResponseDataInnerLineItemsInnerProductDetails ListPaymentLinks200ResponseDataInnerLineItemsInnerProductDetails
...
func NewListPaymentLinks200ResponseDataInnerLineItemsInnerProductDetails(name string, unitAmount int32, currency string) *ListPaymentLinks200ResponseDataInnerLineItemsInnerProductDetails {
	this := ListPaymentLinks200ResponseDataInnerLineItemsInnerProductDetails{}
	this.Name = name
...
func (o *ListPaymentLinks200ResponseDataInnerLineItemsInnerProductDetails) SetDescriptionNil() {
...
func (o *ListPaymentLinks200ResponseDataInnerLineItemsInnerProductDetails) GetRecurring() ListPaymentLinks200ResponseDataInnerLineItemsInnerProductDetailsRecurring {
	if o == nil || IsNil(o.Recurring) {
		var ret ListPaymentLinks200ResponseDataInnerLineItemsInnerProductDetailsRecurring
		return ret
	}
	return *o.Recurring
}
...
// SetRecurring gets a reference to the given ListPaymentLinks200ResponseDataInnerLineItemsInnerProductDetailsRecurring and assigns it to the Recurring field.
...
func (o ListPaymentLinks200ResponseDataInnerLineItemsInnerProductDetails) MarshalJSON() ([]byte, error) {
...
func (o ListPaymentLinks200ResponseDataInnerLineItemsInnerProductDetails) ToMap() (map[string]interface{}, error) {
...
func (o *ListPaymentLinks200ResponseDataInnerLineItemsInnerProductDetails) UnmarshalJSON(data []byte) (err error) {
	...
	varListPaymentLinks200ResponseDataInnerLineItemsInnerProductDetails := _ListPaymentLinks200ResponseDataInnerLineItemsInnerProductDetails{}

	err = json.Unmarshal(data, &varListPaymentLinks200ResponseDataInnerLineItemsInnerProductDetails)

	if err != nil {
		return err
	}

	*o = ListPaymentLinks200ResponseDataInnerLineItemsInnerProductDetails(varListPaymentLinks200ResponseDataInnerLineItemsInnerProductDetails)
...
type NullableListPaymentLinks200ResponseDataInnerLineItemsInnerProductDetails struct {
	value *ListPaymentLinks200ResponseDataInnerLineItemsInnerProductDetails
	isSet bool
}

func (v NullableListPaymentLinks200ResponseDataInnerLineItemsInnerProductDetails) Get() *ListPaymentLinks200ResponseDataInnerLineItemsInnerProductDetails {
	return v.value
}

func (v *NullableListPaymentLinks200ResponseDataInnerLineItemsInnerProductDetails) Set(val *ListPaymentLinks200ResponseDataInnerLineItemsInnerProductDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableListPaymentLinks200ResponseDataInnerLineItemsInnerProductDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableListPaymentLinks200ResponseDataInnerLineItemsInnerProductDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListPaymentLinks200ResponseDataInnerLineItemsInnerProductDetails(val *ListPaymentLinks200ResponseDataInnerLineItemsInnerProductDetails) *NullableListPaymentLinks200ResponseDataInnerLineItemsInnerProductDetails {
	return &NullableListPaymentLinks200ResponseDataInnerLineItemsInnerProductDetails{value: val, isSet: true}
}

func (v NullableListPaymentLinks200ResponseDataInnerLineItemsInnerProductDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListPaymentLinks200ResponseDataInnerLineItemsInnerProductDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
