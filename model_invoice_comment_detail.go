...
// checks if the InvoiceCommentDetail type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InvoiceCommentDetail{}

// InvoiceCommentDetail An invoice comment with extended author details including name, email, and avatar.
...
type _InvoiceCommentDetail InvoiceCommentDetail
...
func (o InvoiceCommentDetail) MarshalJSON() ([]byte, error) {
...
func (o InvoiceCommentDetail) ToMap() (map[string]interface{}, error) {
...
func (o *InvoiceCommentDetail) UnmarshalJSON(data []byte) (err error) {
	...
	varInvoiceCommentDetail := _InvoiceCommentDetail{}

	err = json.Unmarshal(data, &varInvoiceCommentDetail)

	if err != nil {
		return err
	}

	*o = InvoiceCommentDetail(varInvoiceCommentDetail)
...
type NullableInvoiceCommentDetail struct {
	value *InvoiceCommentDetail
	isSet bool
}

func (v NullableInvoiceCommentDetail) Get() *InvoiceCommentDetail {
	return v.value
}

func (v *NullableInvoiceCommentDetail) Set(val *InvoiceCommentDetail) {
	v.value = val
	v.isSet = true
}

func (v NullableInvoiceCommentDetail) IsSet() bool {
	return v.isSet
}

func (v *NullableInvoiceCommentDetail) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInvoiceCommentDetail(val *InvoiceCommentDetail) *NullableInvoiceCommentDetail {
	return &NullableInvoiceCommentDetail{value: val, isSet: true}
}

func (v NullableInvoiceCommentDetail) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInvoiceCommentDetail) UnmarshalJSON(src []byte) error {
	v.isSet = true
