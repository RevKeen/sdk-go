...
type WebhookEndpointsAPI interface {
	...
	/*
	WebhookEndpointsCreate Method for WebhookEndpointsCreate
	...
	*/
	...
	/*
	WebhookEndpointsDelete Method for WebhookEndpointsDelete
	...
	*/
	...
	/*
	WebhookEndpointsList Method for WebhookEndpointsList
	...
	*/
	...
	/*
	WebhookEndpointsRetrieve Method for WebhookEndpointsRetrieve

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id
	@return ApiWebhookEndpointsRetrieveRequest
	*/
	WebhookEndpointsRetrieve(ctx context.Context, id string) ApiWebhookEndpointsRetrieveRequest

	// WebhookEndpointsRetrieveExecute executes the request
	//  @return WebhookEndpointsRetrieve200Response
	WebhookEndpointsRetrieveExecute(r ApiWebhookEndpointsRetrieveRequest) (*WebhookEndpointsRetrieve200Response, *http.Response, error)

	/*
	WebhookEndpointsRotateSecret Method for WebhookEndpointsRotateSecret
	...
	*/
	...
	/*
	WebhookEndpointsUpdate Method for WebhookEndpointsUpdate
	...
	*/
	...
	//  @return WebhookEndpointsRetrieve200Response
	WebhookEndpointsUpdateExecute(r ApiWebhookEndpointsUpdateRequest) (*WebhookEndpointsRetrieve200Response, *http.Response, error)
}
...
type ApiWebhookEndpointsRetrieveRequest struct {
	ctx context.Context
	ApiService WebhookEndpointsAPI
	id string
}

func (r ApiWebhookEndpointsRetrieveRequest) Execute() (*WebhookEndpointsRetrieve200Response, *http.Response, error) {
	return r.ApiService.WebhookEndpointsRetrieveExecute(r)
}
...
WebhookEndpointsRetrieve Method for WebhookEndpointsRetrieve
 ...
 @return ApiWebhookEndpointsRetrieveRequest
*/
func (a *WebhookEndpointsAPIService) WebhookEndpointsRetrieve(ctx context.Context, id string) ApiWebhookEndpointsRetrieveRequest {
	return ApiWebhookEndpointsRetrieveRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return WebhookEndpointsRetrieve200Response
func (a *WebhookEndpointsAPIService) WebhookEndpointsRetrieveExecute(r ApiWebhookEndpointsRetrieveRequest) (*WebhookEndpointsRetrieve200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *WebhookEndpointsRetrieve200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WebhookEndpointsAPIService.WebhookEndpointsRetrieve")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiWebhookEndpointsUpdateRequest) Execute() (*WebhookEndpointsRetrieve200Response, *http.Response, error) {
...
// Execute executes the request
//  @return WebhookEndpointsRetrieve200Response
func (a *WebhookEndpointsAPIService) WebhookEndpointsUpdateExecute(r ApiWebhookEndpointsUpdateRequest) (*WebhookEndpointsRetrieve200Response, *http.Response, error) {
	var (
