...
**BacsDirectDebit** | [**BacsDirectDebitDetails**](BacsDirectDebitDetails.md) |  | 
...
GetBacsDirectDebit returns the BacsDirectDebit field if non-nil, zero value otherwise.

### GetBacsDirectDebitOk

`func (o *PaymentMethod) GetBacsDirectDebitOk() (*BacsDirectDebitDetails, bool)`

GetBacsDirectDebitOk returns a tuple with the BacsDirectDebit field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
SetBacsDirectDebit sets BacsDirectDebit field to given value.
