...
type PortalSubscription struct {
	...
	BillingEndStrategy NullableString `json:"billing_end_strategy"`
	BillingMaxCycles NullableInt32 `json:"billing_max_cycles"`
...
func NewPortalSubscription(id string, object string, status string, currency NullableString, amountMinor NullableInt32, interval NullableString, intervalCount NullableInt32, billingEndStrategy NullableString, billingMaxCycles NullableInt32, currentPeriodStart NullableTime, currentPeriodEnd NullableTime, trialEnd NullableTime, cancelAt NullableTime, canceledAt NullableTime, startedAt NullableTime, createdAt time.Time) *PortalSubscription {
	...
	this.BillingEndStrategy = billingEndStrategy
	this.BillingMaxCycles = billingMaxCycles
...
// GetBillingEndStrategy returns the BillingEndStrategy field value
// If the value is explicit nil, the zero value for string will be returned
func (o *PortalSubscription) GetBillingEndStrategy() string {
	if o == nil || o.BillingEndStrategy.Get() == nil {
		var ret string
		return ret
	}

	return *o.BillingEndStrategy.Get()
}

// GetBillingEndStrategyOk returns a tuple with the BillingEndStrategy field value
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PortalSubscription) GetBillingEndStrategyOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return o.BillingEndStrategy.Get(), o.BillingEndStrategy.IsSet()
}

// SetBillingEndStrategy sets field value
func (o *PortalSubscription) SetBillingEndStrategy(v string) {
	o.BillingEndStrategy.Set(&v)
}

// GetBillingMaxCycles returns the BillingMaxCycles field value
// If the value is explicit nil, the zero value for int32 will be returned
func (o *PortalSubscription) GetBillingMaxCycles() int32 {
	if o == nil || o.BillingMaxCycles.Get() == nil {
		var ret int32
		return ret
	}
...
// GetBillingMaxCyclesOk returns a tuple with the BillingMaxCycles field value
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PortalSubscription) GetBillingMaxCyclesOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
// SetBillingMaxCycles sets field value
func (o *PortalSubscription) SetBillingMaxCycles(v int32) {
...
func (o PortalSubscription) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["billing_end_strategy"] = o.BillingEndStrategy.Get()
...
func (o *PortalSubscription) UnmarshalJSON(data []byte) (err error) {
	...
	*o = PortalSubscription(varPortalSubscription)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "billing_end_strategy")
