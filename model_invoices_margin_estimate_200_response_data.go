...
// checks if the InvoicesMarginEstimate200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InvoicesMarginEstimate200ResponseData{}

// InvoicesMarginEstimate200ResponseData struct for InvoicesMarginEstimate200ResponseData
type InvoicesMarginEstimate200ResponseData struct {
	InvoiceId string `json:"invoice_id"`
	AmountMinor int32 `json:"amount_minor"`
	Currency string `json:"currency"`
	Estimates []InvoicesMarginEstimate200ResponseDataEstimatesInner `json:"estimates"`
	AdditionalProperties map[string]interface{}
}

type _InvoicesMarginEstimate200ResponseData InvoicesMarginEstimate200ResponseData
...
func NewInvoicesMarginEstimate200ResponseData(invoiceId string, amountMinor int32, currency string, estimates []InvoicesMarginEstimate200ResponseDataEstimatesInner) *InvoicesMarginEstimate200ResponseData {
	this := InvoicesMarginEstimate200ResponseData{}
...
func (o *InvoicesMarginEstimate200ResponseData) GetEstimates() []InvoicesMarginEstimate200ResponseDataEstimatesInner {
	if o == nil {
		var ret []InvoicesMarginEstimate200ResponseDataEstimatesInner
		return ret
	}
...
func (o InvoicesMarginEstimate200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o InvoicesMarginEstimate200ResponseData) ToMap() (map[string]interface{}, error) {
...
func (o *InvoicesMarginEstimate200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varInvoicesMarginEstimate200ResponseData := _InvoicesMarginEstimate200ResponseData{}

	err = json.Unmarshal(data, &varInvoicesMarginEstimate200ResponseData)

	if err != nil {
		return err
	}

	*o = InvoicesMarginEstimate200ResponseData(varInvoicesMarginEstimate200ResponseData)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "estimates")
...
type NullableInvoicesMarginEstimate200ResponseData struct {
	value *InvoicesMarginEstimate200ResponseData
	isSet bool
}

func (v NullableInvoicesMarginEstimate200ResponseData) Get() *InvoicesMarginEstimate200ResponseData {
	return v.value
}

func (v *NullableInvoicesMarginEstimate200ResponseData) Set(val *InvoicesMarginEstimate200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableInvoicesMarginEstimate200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableInvoicesMarginEstimate200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInvoicesMarginEstimate200ResponseData(val *InvoicesMarginEstimate200ResponseData) *NullableInvoicesMarginEstimate200ResponseData {
	return &NullableInvoicesMarginEstimate200ResponseData{value: val, isSet: true}
}

func (v NullableInvoicesMarginEstimate200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInvoicesMarginEstimate200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
