...
// checks if the DiscountListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DiscountListResponse{}

// DiscountListResponse A paginated list of discounts matching the query filters.
type DiscountListResponse struct {
	Data []Discount `json:"data"`
	Meta DiscountListResponseMeta `json:"meta"`
	AdditionalProperties map[string]interface{}
}

type _DiscountListResponse DiscountListResponse
...
func (o *DiscountListResponse) GetMeta() DiscountListResponseMeta {
	if o == nil {
		var ret DiscountListResponseMeta
		return ret
	}
...
func (o DiscountListResponse) MarshalJSON() ([]byte, error) {
...
func (o DiscountListResponse) ToMap() (map[string]interface{}, error) {
...
func (o *DiscountListResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varDiscountListResponse := _DiscountListResponse{}

	err = json.Unmarshal(data, &varDiscountListResponse)

	if err != nil {
		return err
	}

	*o = DiscountListResponse(varDiscountListResponse)
...
type NullableDiscountListResponse struct {
	value *DiscountListResponse
	isSet bool
}

func (v NullableDiscountListResponse) Get() *DiscountListResponse {
	return v.value
}

func (v *NullableDiscountListResponse) Set(val *DiscountListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDiscountListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDiscountListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDiscountListResponse(val *DiscountListResponse) *NullableDiscountListResponse {
	return &NullableDiscountListResponse{value: val, isSet: true}
}

func (v NullableDiscountListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDiscountListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
