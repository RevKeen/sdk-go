...
// checks if the SetupIntentError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SetupIntentError{}

// SetupIntentError Last error encountered during setup
type SetupIntentError struct {
	// Error code
	...
	PaymentMethod *SetupIntentErrorPaymentMethod `json:"payment_method,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _SetupIntentError SetupIntentError
...
func (o *SetupIntentError) GetPaymentMethod() SetupIntentErrorPaymentMethod {
	if o == nil || IsNil(o.PaymentMethod) {
		var ret SetupIntentErrorPaymentMethod
		return ret
	}
...
// SetPaymentMethod gets a reference to the given SetupIntentErrorPaymentMethod and assigns it to the PaymentMethod field.
func (o *SetupIntentError) SetPaymentMethod(v SetupIntentErrorPaymentMethod) {
	o.PaymentMethod = &v
}

func (o SetupIntentError) MarshalJSON() ([]byte, error) {
...
func (o SetupIntentError) ToMap() (map[string]interface{}, error) {
...
func (o *SetupIntentError) UnmarshalJSON(data []byte) (err error) {
	...
	varSetupIntentError := _SetupIntentError{}

	err = json.Unmarshal(data, &varSetupIntentError)

	if err != nil {
		return err
	}

	*o = SetupIntentError(varSetupIntentError)
...
type NullableSetupIntentError struct {
	value *SetupIntentError
	isSet bool
}

func (v NullableSetupIntentError) Get() *SetupIntentError {
	return v.value
}

func (v *NullableSetupIntentError) Set(val *SetupIntentError) {
	v.value = val
	v.isSet = true
}

func (v NullableSetupIntentError) IsSet() bool {
	return v.isSet
}

func (v *NullableSetupIntentError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSetupIntentError(val *SetupIntentError) *NullableSetupIntentError {
	return &NullableSetupIntentError{value: val, isSet: true}
}

func (v NullableSetupIntentError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSetupIntentError) UnmarshalJSON(src []byte) error {
	v.isSet = true
