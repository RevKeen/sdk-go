...
// checks if the CancelSubscriptionScheduleRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CancelSubscriptionScheduleRequest{}

// CancelSubscriptionScheduleRequest Parameters for canceling a subscription schedule, optionally reverting the subscription to its pre-schedule state.
...
type _CancelSubscriptionScheduleRequest CancelSubscriptionScheduleRequest
...
func NewCancelSubscriptionScheduleRequest() *CancelSubscriptionScheduleRequest {
	this := CancelSubscriptionScheduleRequest{}
	return &this
}
...
func (o CancelSubscriptionScheduleRequest) MarshalJSON() ([]byte, error) {
...
func (o CancelSubscriptionScheduleRequest) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.InvoiceNow) {
		toSerialize["invoice_now"] = o.InvoiceNow
	}
	if !IsNil(o.Prorate) {
...
func (o *CancelSubscriptionScheduleRequest) UnmarshalJSON(data []byte) (err error) {
	varCancelSubscriptionScheduleRequest := _CancelSubscriptionScheduleRequest{}

	err = json.Unmarshal(data, &varCancelSubscriptionScheduleRequest)

	if err != nil {
		return err
	}

	*o = CancelSubscriptionScheduleRequest(varCancelSubscriptionScheduleRequest)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "invoice_now")
...
type NullableCancelSubscriptionScheduleRequest struct {
	value *CancelSubscriptionScheduleRequest
	isSet bool
}

func (v NullableCancelSubscriptionScheduleRequest) Get() *CancelSubscriptionScheduleRequest {
	return v.value
}

func (v *NullableCancelSubscriptionScheduleRequest) Set(val *CancelSubscriptionScheduleRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCancelSubscriptionScheduleRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCancelSubscriptionScheduleRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCancelSubscriptionScheduleRequest(val *CancelSubscriptionScheduleRequest) *NullableCancelSubscriptionScheduleRequest {
	return &NullableCancelSubscriptionScheduleRequest{value: val, isSet: true}
}

func (v NullableCancelSubscriptionScheduleRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCancelSubscriptionScheduleRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
