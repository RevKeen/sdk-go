...
// BacsDirectDebitDetails Bacs Direct Debit details (if type is 'bacs_direct_debit')
type BacsDirectDebitDetails struct {
	// Masked sort code — never the full value
	SortCode NullableString `json:"sort_code"`
	...
	MandateRef NullableString `json:"mandate_ref"`
	// Mandate status
	MandateStatus string `json:"mandate_status"`
	AdditionalProperties map[string]interface{}
}

type _BacsDirectDebitDetails BacsDirectDebitDetails
...
func (o *BacsDirectDebitDetails) UnmarshalJSON(data []byte) (err error) {
	...
	varBacsDirectDebitDetails := _BacsDirectDebitDetails{}

	err = json.Unmarshal(data, &varBacsDirectDebitDetails)

	if err != nil {
		return err
	}

	*o = BacsDirectDebitDetails(varBacsDirectDebitDetails)
