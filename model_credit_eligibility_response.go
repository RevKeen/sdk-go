...
// checks if the CreditEligibilityResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreditEligibilityResponse{}

// CreditEligibilityResponse Shows whether an invoice is eligible for a credit note and the maximum amount that can be credited.
type CreditEligibilityResponse struct {
	Data CreditEligibilityResponseData `json:"data"`
	RequestId string `json:"requestId"`
	AdditionalProperties map[string]interface{}
}

type _CreditEligibilityResponse CreditEligibilityResponse
...
func NewCreditEligibilityResponse(data CreditEligibilityResponseData, requestId string) *CreditEligibilityResponse {
	this := CreditEligibilityResponse{}
	this.Data = data
...
func (o *CreditEligibilityResponse) GetData() CreditEligibilityResponseData {
	if o == nil {
		var ret CreditEligibilityResponseData
		return ret
	}
...
func (o CreditEligibilityResponse) MarshalJSON() ([]byte, error) {
...
func (o CreditEligibilityResponse) ToMap() (map[string]interface{}, error) {
...
func (o *CreditEligibilityResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varCreditEligibilityResponse := _CreditEligibilityResponse{}

	err = json.Unmarshal(data, &varCreditEligibilityResponse)

	if err != nil {
		return err
	}

	*o = CreditEligibilityResponse(varCreditEligibilityResponse)
...
type NullableCreditEligibilityResponse struct {
	value *CreditEligibilityResponse
	isSet bool
}

func (v NullableCreditEligibilityResponse) Get() *CreditEligibilityResponse {
	return v.value
}

func (v *NullableCreditEligibilityResponse) Set(val *CreditEligibilityResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCreditEligibilityResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCreditEligibilityResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreditEligibilityResponse(val *CreditEligibilityResponse) *NullableCreditEligibilityResponse {
	return &NullableCreditEligibilityResponse{value: val, isSet: true}
}

func (v NullableCreditEligibilityResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreditEligibilityResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
