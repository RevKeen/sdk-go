...
// checks if the UpdatePaymentLinkStatus200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdatePaymentLinkStatus200Response{}

// UpdatePaymentLinkStatus200Response struct for UpdatePaymentLinkStatus200Response
type UpdatePaymentLinkStatus200Response struct {
	Id string `json:"id"`
...
type _UpdatePaymentLinkStatus200Response UpdatePaymentLinkStatus200Response
...
func NewUpdatePaymentLinkStatus200Response(id string, status string, statusChangedAt time.Time, isActive bool, updatedAt time.Time) *UpdatePaymentLinkStatus200Response {
	this := UpdatePaymentLinkStatus200Response{}
	this.Id = id
	this.Status = status
...
func (o UpdatePaymentLinkStatus200Response) MarshalJSON() ([]byte, error) {
...
func (o UpdatePaymentLinkStatus200Response) ToMap() (map[string]interface{}, error) {
...
func (o *UpdatePaymentLinkStatus200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdatePaymentLinkStatus200Response := _UpdatePaymentLinkStatus200Response{}

	err = json.Unmarshal(data, &varUpdatePaymentLinkStatus200Response)

	if err != nil {
		return err
	}

	*o = UpdatePaymentLinkStatus200Response(varUpdatePaymentLinkStatus200Response)
...
type NullableUpdatePaymentLinkStatus200Response struct {
	value *UpdatePaymentLinkStatus200Response
	isSet bool
}

func (v NullableUpdatePaymentLinkStatus200Response) Get() *UpdatePaymentLinkStatus200Response {
	return v.value
}

func (v *NullableUpdatePaymentLinkStatus200Response) Set(val *UpdatePaymentLinkStatus200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdatePaymentLinkStatus200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdatePaymentLinkStatus200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdatePaymentLinkStatus200Response(val *UpdatePaymentLinkStatus200Response) *NullableUpdatePaymentLinkStatus200Response {
	return &NullableUpdatePaymentLinkStatus200Response{value: val, isSet: true}
}

func (v NullableUpdatePaymentLinkStatus200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdatePaymentLinkStatus200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
