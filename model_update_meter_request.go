...
type UpdateMeterRequest struct {
	...
	ValueExpression NullableString `json:"value_expression,omitempty"`
...
// GetValueExpression returns the ValueExpression field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *UpdateMeterRequest) GetValueExpression() string {
	if o == nil || IsNil(o.ValueExpression.Get()) {
		var ret string
		return ret
	}
	return *o.ValueExpression.Get()
}

// GetValueExpressionOk returns a tuple with the ValueExpression field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *UpdateMeterRequest) GetValueExpressionOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return o.ValueExpression.Get(), o.ValueExpression.IsSet()
}

// HasValueExpression returns a boolean if a field has been set.
func (o *UpdateMeterRequest) HasValueExpression() bool {
	if o != nil && o.ValueExpression.IsSet() {
		return true
	}
...
// SetValueExpression gets a reference to the given NullableString and assigns it to the ValueExpression field.
func (o *UpdateMeterRequest) SetValueExpression(v string) {
	o.ValueExpression.Set(&v)
}
// SetValueExpressionNil sets the value for ValueExpression to be an explicit nil
func (o *UpdateMeterRequest) SetValueExpressionNil() {
	o.ValueExpression.Set(nil)
}

// UnsetValueExpression ensures that no value is present for ValueExpression, not even an explicit nil
func (o *UpdateMeterRequest) UnsetValueExpression() {
	o.ValueExpression.Unset()
}
...
func (o UpdateMeterRequest) ToMap() (map[string]interface{}, error) {
	...
	if o.ValueExpression.IsSet() {
		toSerialize["value_expression"] = o.ValueExpression.Get()
	}
...
func (o *UpdateMeterRequest) UnmarshalJSON(data []byte) (err error) {
	...
	*o = UpdateMeterRequest(varUpdateMeterRequest)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "value_expression")
