...
// checks if the ProductsExternalUpsert200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProductsExternalUpsert200Response{}

// ProductsExternalUpsert200Response struct for ProductsExternalUpsert200Response
type ProductsExternalUpsert200Response struct {
	Data ProductsExternalUpsert200ResponseData `json:"data"`
	Created bool `json:"created"`
	Skipped *bool `json:"skipped,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _ProductsExternalUpsert200Response ProductsExternalUpsert200Response
...
func NewProductsExternalUpsert200Response(data ProductsExternalUpsert200ResponseData, created bool) *ProductsExternalUpsert200Response {
	this := ProductsExternalUpsert200Response{}
	this.Data = data
...
func (o *ProductsExternalUpsert200Response) GetData() ProductsExternalUpsert200ResponseData {
	if o == nil {
		var ret ProductsExternalUpsert200ResponseData
		return ret
	}
...
func (o ProductsExternalUpsert200Response) MarshalJSON() ([]byte, error) {
...
func (o ProductsExternalUpsert200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ProductsExternalUpsert200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varProductsExternalUpsert200Response := _ProductsExternalUpsert200Response{}

	err = json.Unmarshal(data, &varProductsExternalUpsert200Response)

	if err != nil {
		return err
	}

	*o = ProductsExternalUpsert200Response(varProductsExternalUpsert200Response)
...
type NullableProductsExternalUpsert200Response struct {
	value *ProductsExternalUpsert200Response
	isSet bool
}

func (v NullableProductsExternalUpsert200Response) Get() *ProductsExternalUpsert200Response {
	return v.value
}

func (v *NullableProductsExternalUpsert200Response) Set(val *ProductsExternalUpsert200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableProductsExternalUpsert200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableProductsExternalUpsert200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProductsExternalUpsert200Response(val *ProductsExternalUpsert200Response) *NullableProductsExternalUpsert200Response {
	return &NullableProductsExternalUpsert200Response{value: val, isSet: true}
}

func (v NullableProductsExternalUpsert200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProductsExternalUpsert200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
