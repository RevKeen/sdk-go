...
var _ MappedNullable = &BankAccountDetails{}

// BankAccountDetails Bank account details (if type is 'us_bank_account')
type BankAccountDetails struct {
	...
	RoutingNumberLast4 NullableString `json:"routing_number_last4"`
	// The type of bank account
	AccountType NullableString `json:"account_type"`
	AdditionalProperties map[string]interface{}
}

type _BankAccountDetails BankAccountDetails
...
func NewBankAccountDetails(bankName NullableString, last4 NullableString, routingNumberLast4 NullableString, accountType NullableString) *BankAccountDetails {
	...
	this.Last4 = last4
	this.RoutingNumberLast4 = routingNumberLast4
...
// GetRoutingNumberLast4 returns the RoutingNumberLast4 field value
// If the value is explicit nil, the zero value for string will be returned
func (o *BankAccountDetails) GetRoutingNumberLast4() string {
	if o == nil || o.RoutingNumberLast4.Get() == nil {
		var ret string
		return ret
	}

	return *o.RoutingNumberLast4.Get()
}

// GetRoutingNumberLast4Ok returns a tuple with the RoutingNumberLast4 field value
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *BankAccountDetails) GetRoutingNumberLast4Ok() (*string, bool) {
	...
	return o.RoutingNumberLast4.Get(), o.RoutingNumberLast4.IsSet()
}

// SetRoutingNumberLast4 sets field value
func (o *BankAccountDetails) SetRoutingNumberLast4(v string) {
	o.RoutingNumberLast4.Set(&v)
}
...
func (o BankAccountDetails) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["routing_number_last4"] = o.RoutingNumberLast4.Get()
...
func (o *BankAccountDetails) UnmarshalJSON(data []byte) (err error) {
	...
	varBankAccountDetails := _BankAccountDetails{}

	err = json.Unmarshal(data, &varBankAccountDetails)

	if err != nil {
		return err
	}

	*o = BankAccountDetails(varBankAccountDetails)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "routing_number_last4")
