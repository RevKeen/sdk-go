...
type CreatePaymentLinkRequest struct {
	...
	LineItems []CreatePaymentLinkRequestLineItemsInner `json:"line_items,omitempty"`
...
func (o *CreatePaymentLinkRequest) GetLineItems() []CreatePaymentLinkRequestLineItemsInner {
	if o == nil || IsNil(o.LineItems) {
		var ret []CreatePaymentLinkRequestLineItemsInner
		return ret
	}
	return o.LineItems
}
...
// SetLineItems gets a reference to the given []CreatePaymentLinkRequestLineItemsInner and assigns it to the LineItems field.
