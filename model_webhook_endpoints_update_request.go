...
// checks if the WebhookEndpointsUpdateRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WebhookEndpointsUpdateRequest{}

// WebhookEndpointsUpdateRequest struct for WebhookEndpointsUpdateRequest
...
type _WebhookEndpointsUpdateRequest WebhookEndpointsUpdateRequest
...
func NewWebhookEndpointsUpdateRequest() *WebhookEndpointsUpdateRequest {
	this := WebhookEndpointsUpdateRequest{}
	return &this
}
...
func (o *WebhookEndpointsUpdateRequest) SetDescriptionNil() {
...
func (o WebhookEndpointsUpdateRequest) MarshalJSON() ([]byte, error) {
...
func (o WebhookEndpointsUpdateRequest) ToMap() (map[string]interface{}, error) {
...
func (o *WebhookEndpointsUpdateRequest) UnmarshalJSON(data []byte) (err error) {
	varWebhookEndpointsUpdateRequest := _WebhookEndpointsUpdateRequest{}

	err = json.Unmarshal(data, &varWebhookEndpointsUpdateRequest)

	if err != nil {
		return err
	}

	*o = WebhookEndpointsUpdateRequest(varWebhookEndpointsUpdateRequest)
...
type NullableWebhookEndpointsUpdateRequest struct {
	value *WebhookEndpointsUpdateRequest
	isSet bool
}

func (v NullableWebhookEndpointsUpdateRequest) Get() *WebhookEndpointsUpdateRequest {
	return v.value
}

func (v *NullableWebhookEndpointsUpdateRequest) Set(val *WebhookEndpointsUpdateRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableWebhookEndpointsUpdateRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableWebhookEndpointsUpdateRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebhookEndpointsUpdateRequest(val *WebhookEndpointsUpdateRequest) *NullableWebhookEndpointsUpdateRequest {
	return &NullableWebhookEndpointsUpdateRequest{value: val, isSet: true}
}

func (v NullableWebhookEndpointsUpdateRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebhookEndpointsUpdateRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
