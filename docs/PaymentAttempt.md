...
**GatewayOrderId** | **NullableString** | Order ID sent to the processor. Format: payatt_&lt;public_id&gt;. Primary correlation key for webhook mapping. | 
**GatewayTransactionId** | **NullableString** | Processor-assigned transaction reference. | 
