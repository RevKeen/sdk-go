...
// checks if the ResendWebhookResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResendWebhookResponse{}

// ResendWebhookResponse Confirmation that a webhook event was resent to the specified endpoint.
...
type _ResendWebhookResponse ResendWebhookResponse
...
func (o ResendWebhookResponse) MarshalJSON() ([]byte, error) {
...
func (o ResendWebhookResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["success"] = o.Success
	if !IsNil(o.WebhookEndpointId) {
...
func (o *ResendWebhookResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varResendWebhookResponse := _ResendWebhookResponse{}

	err = json.Unmarshal(data, &varResendWebhookResponse)

	if err != nil {
		return err
	}

	*o = ResendWebhookResponse(varResendWebhookResponse)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "success")
		delete(additionalProperties, "webhook_endpoint_id")
...
type NullableResendWebhookResponse struct {
	value *ResendWebhookResponse
	isSet bool
}

func (v NullableResendWebhookResponse) Get() *ResendWebhookResponse {
	return v.value
}

func (v *NullableResendWebhookResponse) Set(val *ResendWebhookResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableResendWebhookResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableResendWebhookResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResendWebhookResponse(val *ResendWebhookResponse) *NullableResendWebhookResponse {
	return &NullableResendWebhookResponse{value: val, isSet: true}
}

func (v NullableResendWebhookResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResendWebhookResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
