...
// ForbiddenError Returned when the authenticated API key lacks the required scopes for the requested operation.
...
func NewForbiddenError(error_ ForbiddenErrorError) *ForbiddenError {
	this := ForbiddenError{}
	this.Error = error_
	return &this
}
