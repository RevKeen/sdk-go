...
// GetStartRule returns the StartRule field value if set, zero value otherwise.
func (o *CreatePriceRequest) GetStartRule() string {
	if o == nil || IsNil(o.StartRule) {
		var ret string
		return ret
	}
	return *o.StartRule
...
// and a boolean to check if the value has been set.
func (o *CreatePriceRequest) GetStartRuleOk() (*string, bool) {
	if o == nil || IsNil(o.StartRule) {
		return nil, false
	}
	return o.StartRule, true
}

// HasStartRule returns a boolean if a field has been set.
func (o *CreatePriceRequest) HasStartRule() bool {
	if o != nil && !IsNil(o.StartRule) {
		return true
	}
...
// SetStartRule gets a reference to the given string and assigns it to the StartRule field.
func (o *CreatePriceRequest) SetStartRule(v string) {
	o.StartRule = &v
}
...
func (o *CreatePriceRequest) GetDescription() string {
...
// and a boolean to check if the value has been set.
func (o *CreatePriceRequest) GetDescriptionOk() (*string, bool) {
	if o == nil || IsNil(o.Description) {
		return nil, false
	}
...
func (o *CreatePriceRequest) HasDescription() bool {
	if o != nil && !IsNil(o.Description) {
		return true
	}
...
func (o *CreatePriceRequest) SetDescription(v string) {
	o.Description = &v
}
...
func (o *CreatePriceRequest) GetPercentageRateBps() int32 {
...
// and a boolean to check if the value has been set.
func (o *CreatePriceRequest) GetPercentageRateBpsOk() (*int32, bool) {
	if o == nil || IsNil(o.PercentageRateBps) {
		return nil, false
	}
...
func (o *CreatePriceRequest) HasPercentageRateBps() bool {
	if o != nil && !IsNil(o.PercentageRateBps) {
		return true
	}
...
func (o *CreatePriceRequest) SetPercentageRateBps(v int32) {
...
func (o CreatePriceRequest) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.StartRule) {
		toSerialize["start_rule"] = o.StartRule
	}
