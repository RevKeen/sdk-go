...
// checks if the ProductsExternalBatch200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProductsExternalBatch200Response{}

// ProductsExternalBatch200Response struct for ProductsExternalBatch200Response
type ProductsExternalBatch200Response struct {
	...
	Failed []ProductsExternalBatch200ResponseFailedInner `json:"failed"`
	AdditionalProperties map[string]interface{}
}

type _ProductsExternalBatch200Response ProductsExternalBatch200Response
...
func NewProductsExternalBatch200Response(created int32, updated int32, skipped int32, failed []ProductsExternalBatch200ResponseFailedInner) *ProductsExternalBatch200Response {
	this := ProductsExternalBatch200Response{}
...
func (o *ProductsExternalBatch200Response) GetFailed() []ProductsExternalBatch200ResponseFailedInner {
	if o == nil {
		var ret []ProductsExternalBatch200ResponseFailedInner
		return ret
	}
...
func (o ProductsExternalBatch200Response) MarshalJSON() ([]byte, error) {
...
func (o ProductsExternalBatch200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ProductsExternalBatch200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varProductsExternalBatch200Response := _ProductsExternalBatch200Response{}

	err = json.Unmarshal(data, &varProductsExternalBatch200Response)

	if err != nil {
		return err
	}

	*o = ProductsExternalBatch200Response(varProductsExternalBatch200Response)
...
type NullableProductsExternalBatch200Response struct {
	value *ProductsExternalBatch200Response
	isSet bool
}

func (v NullableProductsExternalBatch200Response) Get() *ProductsExternalBatch200Response {
	return v.value
}

func (v *NullableProductsExternalBatch200Response) Set(val *ProductsExternalBatch200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableProductsExternalBatch200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableProductsExternalBatch200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProductsExternalBatch200Response(val *ProductsExternalBatch200Response) *NullableProductsExternalBatch200Response {
	return &NullableProductsExternalBatch200Response{value: val, isSet: true}
}

func (v NullableProductsExternalBatch200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProductsExternalBatch200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
