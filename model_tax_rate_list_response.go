...
// checks if the TaxRateListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TaxRateListResponse{}

// TaxRateListResponse A paginated list of tax rates.
...
type _TaxRateListResponse TaxRateListResponse
...
func (o TaxRateListResponse) MarshalJSON() ([]byte, error) {
...
func (o TaxRateListResponse) ToMap() (map[string]interface{}, error) {
...
func (o *TaxRateListResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varTaxRateListResponse := _TaxRateListResponse{}

	err = json.Unmarshal(data, &varTaxRateListResponse)

	if err != nil {
		return err
	}

	*o = TaxRateListResponse(varTaxRateListResponse)
...
type NullableTaxRateListResponse struct {
	value *TaxRateListResponse
	isSet bool
}

func (v NullableTaxRateListResponse) Get() *TaxRateListResponse {
	return v.value
}

func (v *NullableTaxRateListResponse) Set(val *TaxRateListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableTaxRateListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableTaxRateListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTaxRateListResponse(val *TaxRateListResponse) *NullableTaxRateListResponse {
	return &NullableTaxRateListResponse{value: val, isSet: true}
}

func (v NullableTaxRateListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTaxRateListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
