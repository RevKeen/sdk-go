...
type InvoicesAPI interface {
	...
	*/
	InvoicesRetrieve(ctx context.Context, id string) ApiInvoicesRetrieveRequest

	// InvoicesRetrieveExecute executes the request
	//  @return InvoiceResponse
	InvoicesRetrieveExecute(r ApiInvoicesRetrieveRequest) (*InvoiceResponse, *http.Response, error)
...
func (r ApiInvoicesRetrieveRequest) Execute() (*InvoiceResponse, *http.Response, error) {
...
Get a single invoice by ID.
 ...
 @return ApiInvoicesRetrieveRequest
*/
func (a *InvoicesAPIService) InvoicesRetrieve(ctx context.Context, id string) ApiInvoicesRetrieveRequest {
	return ApiInvoicesRetrieveRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return InvoiceResponse
func (a *InvoicesAPIService) InvoicesRetrieveExecute(r ApiInvoicesRetrieveRequest) (*InvoiceResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
