...
- `404 resource_missing` — the referenced resource does not exist or is not visible to your key.
	...
	*/
	EventsGet(ctx context.Context, id string) ApiEventsGetRequest
...
Offset-based with `limit` (default 25, max 100) and `offset`. The response `pagination` block includes `total` and `hasMore`. See [the pagination guide](/docs/fundamentals/pagination) for SDK auto-paging helpers.
	...
	*/
	EventsList(ctx context.Context) ApiEventsListRequest

	// EventsListExecute executes the request
	//  @return EventListResponse
	EventsListExecute(r ApiEventsListRequest) (*EventListResponse, *http.Response, error)

	/*
	EventsResend Resend webhook for an event
...
Pass an `Idempotency-Key` header (UUID v4 recommended) to make retries safe. Keys are valid for 24 hours; see [the idempotency guide](/docs/fundamentals/idempotency).
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id Event ID
	@return ApiEventsResendRequest
	*/
	EventsResend(ctx context.Context, id string) ApiEventsResendRequest

	// EventsResendExecute executes the request
	//  @return ResendWebhookResponse
	EventsResendExecute(r ApiEventsResendRequest) (*ResendWebhookResponse, *http.Response, error)
}
...
- `404 resource_missing` — the referenced resource does not exist or is not visible to your key.
 ...
 @return ApiEventsGetRequest
*/
func (a *EventsAPIService) EventsGet(ctx context.Context, id string) ApiEventsGetRequest {
	return ApiEventsGetRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
func (r ApiEventsListRequest) Type_(type_ string) ApiEventsListRequest {
	r.type_ = &type_
	return r
}

// Filter by multiple event types (comma-separated)
func (r ApiEventsListRequest) Types(types string) ApiEventsListRequest {
	r.types = &types
	return r
}

// Filter by customer ID
func (r ApiEventsListRequest) CustomerId(customerId string) ApiEventsListRequest {
	r.customerId = &customerId
	return r
}

// Filter by invoice ID
func (r ApiEventsListRequest) InvoiceId(invoiceId string) ApiEventsListRequest {
	r.invoiceId = &invoiceId
	return r
}

// Filter by subscription ID
func (r ApiEventsListRequest) SubscriptionId(subscriptionId string) ApiEventsListRequest {
	r.subscriptionId = &subscriptionId
	return r
}

// Filter by order ID
func (r ApiEventsListRequest) OrderId(orderId string) ApiEventsListRequest {
	r.orderId = &orderId
	return r
}

// Filter by created_at &gt;&#x3D; (Unix timestamp)
func (r ApiEventsListRequest) CreatedGte(createdGte float32) ApiEventsListRequest {
	r.createdGte = &createdGte
	return r
}

// Filter by created_at &lt;&#x3D; (Unix timestamp)
func (r ApiEventsListRequest) CreatedLte(createdLte float32) ApiEventsListRequest {
...
func (r ApiEventsListRequest) StartingAfter(startingAfter string) ApiEventsListRequest {
	r.startingAfter = &startingAfter
	return r
}

// Cursor for pagination - return results before this event ID
func (r ApiEventsListRequest) EndingBefore(endingBefore string) ApiEventsListRequest {
	r.endingBefore = &endingBefore
	return r
}

func (r ApiEventsListRequest) Execute() (*EventListResponse, *http.Response, error) {
...
Offset-based with `limit` (default 25, max 100) and `offset`. The response `pagination` block includes `total` and `hasMore`. See [the pagination guide](/docs/fundamentals/pagination) for SDK auto-paging helpers.
 ...
 @return ApiEventsListRequest
*/
func (a *EventsAPIService) EventsList(ctx context.Context) ApiEventsListRequest {
	return ApiEventsListRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return EventListResponse
func (a *EventsAPIService) EventsListExecute(r ApiEventsListRequest) (*EventListResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiEventsResendRequest struct {
	ctx context.Context
	ApiService EventsAPI
	id string
}

func (r ApiEventsResendRequest) Execute() (*ResendWebhookResponse, *http.Response, error) {
	return r.ApiService.EventsResendExecute(r)
}
...
Pass an `Idempotency-Key` header (UUID v4 recommended) to make retries safe. Keys are valid for 24 hours; see [the idempotency guide](/docs/fundamentals/idempotency).
 ...
 @return ApiEventsResendRequest
*/
func (a *EventsAPIService) EventsResend(ctx context.Context, id string) ApiEventsResendRequest {
	return ApiEventsResendRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return ResendWebhookResponse
func (a *EventsAPIService) EventsResendExecute(r ApiEventsResendRequest) (*ResendWebhookResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ResendWebhookResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EventsAPIService.EventsResend")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/events/{id}/resend"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
