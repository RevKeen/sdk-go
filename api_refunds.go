...
type RefundsAPI interface {
	...
	*/
	RefundsGet(ctx context.Context, id string) ApiRefundsGetRequest

	// RefundsGetExecute executes the request
	//  @return RefundRetrieveResponse
	RefundsGetExecute(r ApiRefundsGetRequest) (*RefundRetrieveResponse, *http.Response, error)
...
func (r ApiRefundsGetRequest) Execute() (*RefundRetrieveResponse, *http.Response, error) {
...
Retrieve a single refund by its public ID (ref_xxx) or internal UUID.
 ...
 @return ApiRefundsGetRequest
*/
func (a *RefundsAPIService) RefundsGet(ctx context.Context, id string) ApiRefundsGetRequest {
	return ApiRefundsGetRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return RefundRetrieveResponse
func (a *RefundsAPIService) RefundsGetExecute(r ApiRefundsGetRequest) (*RefundRetrieveResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RefundsAPIService.RefundsGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
