...
// checks if the CustomersUpdateRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CustomersUpdateRequest{}

// CustomersUpdateRequest struct for CustomersUpdateRequest
...
type _CustomersUpdateRequest CustomersUpdateRequest
...
func (o CustomersUpdateRequest) MarshalJSON() ([]byte, error) {
...
func (o CustomersUpdateRequest) ToMap() (map[string]interface{}, error) {
...
func (o *CustomersUpdateRequest) UnmarshalJSON(data []byte) (err error) {
	varCustomersUpdateRequest := _CustomersUpdateRequest{}

	err = json.Unmarshal(data, &varCustomersUpdateRequest)

	if err != nil {
		return err
	}

	*o = CustomersUpdateRequest(varCustomersUpdateRequest)
...
type NullableCustomersUpdateRequest struct {
	value *CustomersUpdateRequest
	isSet bool
}

func (v NullableCustomersUpdateRequest) Get() *CustomersUpdateRequest {
	return v.value
}

func (v *NullableCustomersUpdateRequest) Set(val *CustomersUpdateRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCustomersUpdateRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCustomersUpdateRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCustomersUpdateRequest(val *CustomersUpdateRequest) *NullableCustomersUpdateRequest {
	return &NullableCustomersUpdateRequest{value: val, isSet: true}
}

func (v NullableCustomersUpdateRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCustomersUpdateRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
