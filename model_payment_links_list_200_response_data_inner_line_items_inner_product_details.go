...
// checks if the PaymentLinksList200ResponseDataInnerLineItemsInnerProductDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaymentLinksList200ResponseDataInnerLineItemsInnerProductDetails{}

// PaymentLinksList200ResponseDataInnerLineItemsInnerProductDetails struct for PaymentLinksList200ResponseDataInnerLineItemsInnerProductDetails
type PaymentLinksList200ResponseDataInnerLineItemsInnerProductDetails struct {
...
type _PaymentLinksList200ResponseDataInnerLineItemsInnerProductDetails PaymentLinksList200ResponseDataInnerLineItemsInnerProductDetails
...
func NewPaymentLinksList200ResponseDataInnerLineItemsInnerProductDetails(name string, unitAmount int32, currency string) *PaymentLinksList200ResponseDataInnerLineItemsInnerProductDetails {
	this := PaymentLinksList200ResponseDataInnerLineItemsInnerProductDetails{}
	this.Name = name
...
func (o *PaymentLinksList200ResponseDataInnerLineItemsInnerProductDetails) SetDescriptionNil() {
...
func (o PaymentLinksList200ResponseDataInnerLineItemsInnerProductDetails) MarshalJSON() ([]byte, error) {
...
func (o PaymentLinksList200ResponseDataInnerLineItemsInnerProductDetails) ToMap() (map[string]interface{}, error) {
...
func (o *PaymentLinksList200ResponseDataInnerLineItemsInnerProductDetails) UnmarshalJSON(data []byte) (err error) {
	...
	varPaymentLinksList200ResponseDataInnerLineItemsInnerProductDetails := _PaymentLinksList200ResponseDataInnerLineItemsInnerProductDetails{}

	err = json.Unmarshal(data, &varPaymentLinksList200ResponseDataInnerLineItemsInnerProductDetails)

	if err != nil {
		return err
	}

	*o = PaymentLinksList200ResponseDataInnerLineItemsInnerProductDetails(varPaymentLinksList200ResponseDataInnerLineItemsInnerProductDetails)
...
type NullablePaymentLinksList200ResponseDataInnerLineItemsInnerProductDetails struct {
	value *PaymentLinksList200ResponseDataInnerLineItemsInnerProductDetails
	isSet bool
}

func (v NullablePaymentLinksList200ResponseDataInnerLineItemsInnerProductDetails) Get() *PaymentLinksList200ResponseDataInnerLineItemsInnerProductDetails {
	return v.value
}

func (v *NullablePaymentLinksList200ResponseDataInnerLineItemsInnerProductDetails) Set(val *PaymentLinksList200ResponseDataInnerLineItemsInnerProductDetails) {
	v.value = val
	v.isSet = true
}

func (v NullablePaymentLinksList200ResponseDataInnerLineItemsInnerProductDetails) IsSet() bool {
	return v.isSet
}

func (v *NullablePaymentLinksList200ResponseDataInnerLineItemsInnerProductDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaymentLinksList200ResponseDataInnerLineItemsInnerProductDetails(val *PaymentLinksList200ResponseDataInnerLineItemsInnerProductDetails) *NullablePaymentLinksList200ResponseDataInnerLineItemsInnerProductDetails {
	return &NullablePaymentLinksList200ResponseDataInnerLineItemsInnerProductDetails{value: val, isSet: true}
}

func (v NullablePaymentLinksList200ResponseDataInnerLineItemsInnerProductDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaymentLinksList200ResponseDataInnerLineItemsInnerProductDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
