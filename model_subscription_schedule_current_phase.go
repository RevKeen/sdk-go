...
// checks if the SubscriptionScheduleCurrentPhase type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SubscriptionScheduleCurrentPhase{}

// SubscriptionScheduleCurrentPhase Current phase being executed
type SubscriptionScheduleCurrentPhase struct {
	...
	EndDate NullableInt32 `json:"end_date"`
	AdditionalProperties map[string]interface{}
}

type _SubscriptionScheduleCurrentPhase SubscriptionScheduleCurrentPhase
...
func NewSubscriptionScheduleCurrentPhase(startDate int32, endDate NullableInt32) *SubscriptionScheduleCurrentPhase {
	this := SubscriptionScheduleCurrentPhase{}
...
func (o SubscriptionScheduleCurrentPhase) MarshalJSON() ([]byte, error) {
...
func (o SubscriptionScheduleCurrentPhase) ToMap() (map[string]interface{}, error) {
...
func (o *SubscriptionScheduleCurrentPhase) UnmarshalJSON(data []byte) (err error) {
	...
	varSubscriptionScheduleCurrentPhase := _SubscriptionScheduleCurrentPhase{}

	err = json.Unmarshal(data, &varSubscriptionScheduleCurrentPhase)

	if err != nil {
		return err
	}

	*o = SubscriptionScheduleCurrentPhase(varSubscriptionScheduleCurrentPhase)
...
type NullableSubscriptionScheduleCurrentPhase struct {
	value *SubscriptionScheduleCurrentPhase
	isSet bool
}

func (v NullableSubscriptionScheduleCurrentPhase) Get() *SubscriptionScheduleCurrentPhase {
	return v.value
}

func (v *NullableSubscriptionScheduleCurrentPhase) Set(val *SubscriptionScheduleCurrentPhase) {
	v.value = val
	v.isSet = true
}

func (v NullableSubscriptionScheduleCurrentPhase) IsSet() bool {
	return v.isSet
}

func (v *NullableSubscriptionScheduleCurrentPhase) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSubscriptionScheduleCurrentPhase(val *SubscriptionScheduleCurrentPhase) *NullableSubscriptionScheduleCurrentPhase {
	return &NullableSubscriptionScheduleCurrentPhase{value: val, isSet: true}
}

func (v NullableSubscriptionScheduleCurrentPhase) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSubscriptionScheduleCurrentPhase) UnmarshalJSON(src []byte) error {
	v.isSet = true
