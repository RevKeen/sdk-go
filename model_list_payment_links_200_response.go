...
type ListPaymentLinks200Response struct {
	Data []ListPaymentLinks200ResponseDataInner `json:"data"`
	Pagination ListPaymentLinks200ResponsePagination `json:"pagination"`
	AdditionalProperties map[string]interface{}
}

type _ListPaymentLinks200Response ListPaymentLinks200Response
...
func (o *ListPaymentLinks200Response) GetData() []ListPaymentLinks200ResponseDataInner {
	if o == nil {
		var ret []ListPaymentLinks200ResponseDataInner
		return ret
	}
...
func (o *ListPaymentLinks200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varListPaymentLinks200Response := _ListPaymentLinks200Response{}

	err = json.Unmarshal(data, &varListPaymentLinks200Response)

	if err != nil {
		return err
	}

	*o = ListPaymentLinks200Response(varListPaymentLinks200Response)
