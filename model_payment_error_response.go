...
// PaymentErrorResponse Error response returned when a payment operation fails.
...
func NewPaymentErrorResponse(error_ PriceErrorResponseError) *PaymentErrorResponse {
...
func (o *PaymentErrorResponse) GetError() PriceErrorResponseError {
	if o == nil {
...
func (o *PaymentErrorResponse) GetErrorOk() (*PriceErrorResponseError, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Error, true
...
func (o *PaymentErrorResponse) SetError(v PriceErrorResponseError) {
	o.Error = v
}
...
func (o *PaymentErrorResponse) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varPaymentErrorResponse)
