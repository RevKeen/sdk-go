...
// checks if the EntitlementCheck type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EntitlementCheck{}

// EntitlementCheck struct for EntitlementCheck
...
type _EntitlementCheck EntitlementCheck
...
func (o EntitlementCheck) MarshalJSON() ([]byte, error) {
...
func (o EntitlementCheck) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["benefit_key"] = o.BenefitKey
...
func (o *EntitlementCheck) UnmarshalJSON(data []byte) (err error) {
	...
	varEntitlementCheck := _EntitlementCheck{}

	err = json.Unmarshal(data, &varEntitlementCheck)

	if err != nil {
		return err
	}

	*o = EntitlementCheck(varEntitlementCheck)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "benefit_key")
...
type NullableEntitlementCheck struct {
	value *EntitlementCheck
	isSet bool
}

func (v NullableEntitlementCheck) Get() *EntitlementCheck {
	return v.value
}

func (v *NullableEntitlementCheck) Set(val *EntitlementCheck) {
	v.value = val
	v.isSet = true
}

func (v NullableEntitlementCheck) IsSet() bool {
	return v.isSet
}

func (v *NullableEntitlementCheck) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEntitlementCheck(val *EntitlementCheck) *NullableEntitlementCheck {
	return &NullableEntitlementCheck{value: val, isSet: true}
}

func (v NullableEntitlementCheck) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEntitlementCheck) UnmarshalJSON(src []byte) error {
	v.isSet = true
