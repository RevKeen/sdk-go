...
// EventData Event data containing the affected object
type EventData struct {
	Object interface{} `json:"object,omitempty"`
	PreviousAttributes interface{} `json:"previous_attributes,omitempty"`
...
func (o *EventData) GetObject() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
func (o *EventData) GetObjectOk() (*interface{}, bool) {
...
func (o *EventData) HasObject() bool {
	if o != nil && !IsNil(o.Object) {
		return true
	}
...
func (o *EventData) SetObject(v interface{}) {
	o.Object = v
}

// GetPreviousAttributes returns the PreviousAttributes field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *EventData) GetPreviousAttributes() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *EventData) GetPreviousAttributesOk() (*interface{}, bool) {
...
func (o *EventData) HasPreviousAttributes() bool {
	if o != nil && !IsNil(o.PreviousAttributes) {
		return true
	}
...
// SetPreviousAttributes gets a reference to the given interface{} and assigns it to the PreviousAttributes field.
func (o *EventData) SetPreviousAttributes(v interface{}) {
...
func (o *EventData) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varEventData)
