...
// CreateMandateRequest Parameters for creating a Direct Debit mandate. Bank details are validated with the bureau and stored KMS-encrypted; only masked values are ever returned.
type CreateMandateRequest struct {
	...
	BackupPaymentMethodId *string `json:"backupPaymentMethodId,omitempty"`
	// Signed mandate-request token to consume on creation
	RequestToken *string `json:"requestToken,omitempty"`
	Acceptance *CreateMandateRequestAcceptance `json:"acceptance,omitempty"`
...
// GetBackupPaymentMethodId returns the BackupPaymentMethodId field value if set, zero value otherwise.
func (o *CreateMandateRequest) GetBackupPaymentMethodId() string {
	if o == nil || IsNil(o.BackupPaymentMethodId) {
		var ret string
		return ret
	}
	return *o.BackupPaymentMethodId
}
...
func (o *CreateMandateRequest) GetBackupPaymentMethodIdOk() (*string, bool) {
	...
	return o.BackupPaymentMethodId, true
}
...
// SetBackupPaymentMethodId gets a reference to the given string and assigns it to the BackupPaymentMethodId field.
func (o *CreateMandateRequest) SetBackupPaymentMethodId(v string) {
	o.BackupPaymentMethodId = &v
}
...
func (o *CreateMandateRequest) GetAcceptance() CreateMandateRequestAcceptance {
	if o == nil || IsNil(o.Acceptance) {
		var ret CreateMandateRequestAcceptance
		return ret
	}
	return *o.Acceptance
}
...
// SetAcceptance gets a reference to the given CreateMandateRequestAcceptance and assigns it to the Acceptance field.
...
func (o CreateMandateRequest) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.BackupPaymentMethodId) {
		toSerialize["backupPaymentMethodId"] = o.BackupPaymentMethodId
	}
...
func (o *CreateMandateRequest) UnmarshalJSON(data []byte) (err error) {
	...
	*o = CreateMandateRequest(varCreateMandateRequest)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "backupPaymentMethodId")
