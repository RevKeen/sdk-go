...
// checks if the WebhookEndpointsCreateRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WebhookEndpointsCreateRequest{}

// WebhookEndpointsCreateRequest struct for WebhookEndpointsCreateRequest
...
type _WebhookEndpointsCreateRequest WebhookEndpointsCreateRequest
...
func NewWebhookEndpointsCreateRequest(url string, enabledEvents []string) *WebhookEndpointsCreateRequest {
	this := WebhookEndpointsCreateRequest{}
	this.Url = url
...
func (o WebhookEndpointsCreateRequest) MarshalJSON() ([]byte, error) {
...
func (o WebhookEndpointsCreateRequest) ToMap() (map[string]interface{}, error) {
...
func (o *WebhookEndpointsCreateRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varWebhookEndpointsCreateRequest := _WebhookEndpointsCreateRequest{}

	err = json.Unmarshal(data, &varWebhookEndpointsCreateRequest)

	if err != nil {
		return err
	}

	*o = WebhookEndpointsCreateRequest(varWebhookEndpointsCreateRequest)
...
type NullableWebhookEndpointsCreateRequest struct {
	value *WebhookEndpointsCreateRequest
	isSet bool
}

func (v NullableWebhookEndpointsCreateRequest) Get() *WebhookEndpointsCreateRequest {
	return v.value
}

func (v *NullableWebhookEndpointsCreateRequest) Set(val *WebhookEndpointsCreateRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableWebhookEndpointsCreateRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableWebhookEndpointsCreateRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebhookEndpointsCreateRequest(val *WebhookEndpointsCreateRequest) *NullableWebhookEndpointsCreateRequest {
	return &NullableWebhookEndpointsCreateRequest{value: val, isSet: true}
}

func (v NullableWebhookEndpointsCreateRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebhookEndpointsCreateRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
