...
// checks if the CartCheckoutSession type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CartCheckoutSession{}

// CartCheckoutSession struct for CartCheckoutSession
type CartCheckoutSession struct {
	Id string `json:"id"`
	Object string `json:"object"`
	MerchantId string `json:"merchant_id"`
	CustomerId NullableString `json:"customer_id"`
	SessionToken NullableString `json:"session_token"`
...
type _CartCheckoutSession CartCheckoutSession
...
func (o *CartCheckoutSession) GetSessionToken() string {
	if o == nil || o.SessionToken.Get() == nil {
		var ret string
		return ret
	}
...
func (o CartCheckoutSession) MarshalJSON() ([]byte, error) {
...
func (o CartCheckoutSession) ToMap() (map[string]interface{}, error) {
...
func (o *CartCheckoutSession) UnmarshalJSON(data []byte) (err error) {
	...
	varCartCheckoutSession := _CartCheckoutSession{}

	err = json.Unmarshal(data, &varCartCheckoutSession)

	if err != nil {
		return err
	}

	*o = CartCheckoutSession(varCartCheckoutSession)
...
type NullableCartCheckoutSession struct {
	value *CartCheckoutSession
	isSet bool
}

func (v NullableCartCheckoutSession) Get() *CartCheckoutSession {
	return v.value
}

func (v *NullableCartCheckoutSession) Set(val *CartCheckoutSession) {
	v.value = val
	v.isSet = true
}

func (v NullableCartCheckoutSession) IsSet() bool {
	return v.isSet
}

func (v *NullableCartCheckoutSession) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCartCheckoutSession(val *CartCheckoutSession) *NullableCartCheckoutSession {
	return &NullableCartCheckoutSession{value: val, isSet: true}
}

func (v NullableCartCheckoutSession) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCartCheckoutSession) UnmarshalJSON(src []byte) error {
	v.isSet = true
