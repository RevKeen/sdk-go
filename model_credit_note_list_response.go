...
// checks if the CreditNoteListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreditNoteListResponse{}

// CreditNoteListResponse A list of credit notes matching the query filters.
...
type _CreditNoteListResponse CreditNoteListResponse
...
func (o CreditNoteListResponse) MarshalJSON() ([]byte, error) {
...
func (o CreditNoteListResponse) ToMap() (map[string]interface{}, error) {
...
func (o *CreditNoteListResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varCreditNoteListResponse := _CreditNoteListResponse{}

	err = json.Unmarshal(data, &varCreditNoteListResponse)

	if err != nil {
		return err
	}

	*o = CreditNoteListResponse(varCreditNoteListResponse)
...
type NullableCreditNoteListResponse struct {
	value *CreditNoteListResponse
	isSet bool
}

func (v NullableCreditNoteListResponse) Get() *CreditNoteListResponse {
	return v.value
}

func (v *NullableCreditNoteListResponse) Set(val *CreditNoteListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCreditNoteListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCreditNoteListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreditNoteListResponse(val *CreditNoteListResponse) *NullableCreditNoteListResponse {
	return &NullableCreditNoteListResponse{value: val, isSet: true}
}

func (v NullableCreditNoteListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreditNoteListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
