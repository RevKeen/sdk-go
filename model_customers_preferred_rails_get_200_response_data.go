...
// checks if the CustomersPreferredRailsGet200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CustomersPreferredRailsGet200ResponseData{}

// CustomersPreferredRailsGet200ResponseData struct for CustomersPreferredRailsGet200ResponseData
type CustomersPreferredRailsGet200ResponseData struct {
	...
	PreferredRails []CustomersPreferredRailsGet200ResponseDataPreferredRailsInner `json:"preferred_rails"`
	AdditionalProperties map[string]interface{}
}

type _CustomersPreferredRailsGet200ResponseData CustomersPreferredRailsGet200ResponseData
...
func NewCustomersPreferredRailsGet200ResponseData(customerId string, invoiceId NullableString, amountMinor NullableInt32, currency NullableString, preferredRails []CustomersPreferredRailsGet200ResponseDataPreferredRailsInner) *CustomersPreferredRailsGet200ResponseData {
	this := CustomersPreferredRailsGet200ResponseData{}
...
// GetPreferredRails returns the PreferredRails field value
func (o *CustomersPreferredRailsGet200ResponseData) GetPreferredRails() []CustomersPreferredRailsGet200ResponseDataPreferredRailsInner {
	if o == nil {
		var ret []CustomersPreferredRailsGet200ResponseDataPreferredRailsInner
		return ret
	}

	return o.PreferredRails
}

// GetPreferredRailsOk returns a tuple with the PreferredRails field value
// and a boolean to check if the value has been set.
func (o *CustomersPreferredRailsGet200ResponseData) GetPreferredRailsOk() ([]CustomersPreferredRailsGet200ResponseDataPreferredRailsInner, bool) {
	...
	return o.PreferredRails, true
}

// SetPreferredRails sets field value
...
func (o CustomersPreferredRailsGet200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o CustomersPreferredRailsGet200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["customer_id"] = o.CustomerId
	toSerialize["invoice_id"] = o.InvoiceId.Get()
	toSerialize["amount_minor"] = o.AmountMinor.Get()
	toSerialize["currency"] = o.Currency.Get()
	toSerialize["preferred_rails"] = o.PreferredRails
...
func (o *CustomersPreferredRailsGet200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varCustomersPreferredRailsGet200ResponseData := _CustomersPreferredRailsGet200ResponseData{}

	err = json.Unmarshal(data, &varCustomersPreferredRailsGet200ResponseData)

	if err != nil {
		return err
	}

	*o = CustomersPreferredRailsGet200ResponseData(varCustomersPreferredRailsGet200ResponseData)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "preferred_rails")
...
type NullableCustomersPreferredRailsGet200ResponseData struct {
	value *CustomersPreferredRailsGet200ResponseData
	isSet bool
}

func (v NullableCustomersPreferredRailsGet200ResponseData) Get() *CustomersPreferredRailsGet200ResponseData {
	return v.value
}

func (v *NullableCustomersPreferredRailsGet200ResponseData) Set(val *CustomersPreferredRailsGet200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableCustomersPreferredRailsGet200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableCustomersPreferredRailsGet200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCustomersPreferredRailsGet200ResponseData(val *CustomersPreferredRailsGet200ResponseData) *NullableCustomersPreferredRailsGet200ResponseData {
	return &NullableCustomersPreferredRailsGet200ResponseData{value: val, isSet: true}
}

func (v NullableCustomersPreferredRailsGet200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCustomersPreferredRailsGet200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
