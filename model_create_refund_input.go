...
// checks if the CreateRefundInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateRefundInput{}

// CreateRefundInput Parameters for creating a refund. Specify the transaction ID and optionally a partial amount.
type CreateRefundInput struct {
	// The ID of the payment to refund
	PaymentId string `json:"payment_id"`
	// Amount to refund in cents. If not provided, refunds the full remaining amount.
	AmountMinor *float32 `json:"amount_minor,omitempty"`
...
type _CreateRefundInput CreateRefundInput
...
// GetReasonDetails returns the ReasonDetails field value if set, zero value otherwise.
func (o *CreateRefundInput) GetReasonDetails() string {
	if o == nil || IsNil(o.ReasonDetails) {
		var ret string
		return ret
	}
...
// GetReasonDetailsOk returns a tuple with the ReasonDetails field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetReasonDetails gets a reference to the given string and assigns it to the ReasonDetails field.
func (o *CreateRefundInput) SetReasonDetails(v string) {
	o.ReasonDetails = &v
}

func (o CreateRefundInput) MarshalJSON() ([]byte, error) {
...
func (o CreateRefundInput) ToMap() (map[string]interface{}, error) {
...
func (o *CreateRefundInput) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateRefundInput := _CreateRefundInput{}

	err = json.Unmarshal(data, &varCreateRefundInput)

	if err != nil {
		return err
	}

	*o = CreateRefundInput(varCreateRefundInput)
...
type NullableCreateRefundInput struct {
	value *CreateRefundInput
	isSet bool
}

func (v NullableCreateRefundInput) Get() *CreateRefundInput {
	return v.value
}

func (v *NullableCreateRefundInput) Set(val *CreateRefundInput) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateRefundInput) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateRefundInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateRefundInput(val *CreateRefundInput) *NullableCreateRefundInput {
	return &NullableCreateRefundInput{value: val, isSet: true}
}

func (v NullableCreateRefundInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateRefundInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
