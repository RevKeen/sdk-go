...
// checks if the ConfirmSetupIntentRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConfirmSetupIntentRequest{}

// ConfirmSetupIntentRequest Parameters for confirming a setup intent, which verifies the payment method and saves it for future use.
...
type _ConfirmSetupIntentRequest ConfirmSetupIntentRequest
...
func NewConfirmSetupIntentRequest() *ConfirmSetupIntentRequest {
	this := ConfirmSetupIntentRequest{}
	return &this
}
...
func (o ConfirmSetupIntentRequest) MarshalJSON() ([]byte, error) {
...
func (o ConfirmSetupIntentRequest) ToMap() (map[string]interface{}, error) {
...
func (o *ConfirmSetupIntentRequest) UnmarshalJSON(data []byte) (err error) {
	varConfirmSetupIntentRequest := _ConfirmSetupIntentRequest{}

	err = json.Unmarshal(data, &varConfirmSetupIntentRequest)

	if err != nil {
		return err
	}

	*o = ConfirmSetupIntentRequest(varConfirmSetupIntentRequest)
...
type NullableConfirmSetupIntentRequest struct {
	value *ConfirmSetupIntentRequest
	isSet bool
}

func (v NullableConfirmSetupIntentRequest) Get() *ConfirmSetupIntentRequest {
	return v.value
}

func (v *NullableConfirmSetupIntentRequest) Set(val *ConfirmSetupIntentRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableConfirmSetupIntentRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableConfirmSetupIntentRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConfirmSetupIntentRequest(val *ConfirmSetupIntentRequest) *NullableConfirmSetupIntentRequest {
	return &NullableConfirmSetupIntentRequest{value: val, isSet: true}
}

func (v NullableConfirmSetupIntentRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConfirmSetupIntentRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
