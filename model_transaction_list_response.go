...
// TransactionListResponse A paginated list of transactions matching the query filters.
...
type _TransactionListResponse TransactionListResponse
...
func (o *TransactionListResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varTransactionListResponse := _TransactionListResponse{}

	err = json.Unmarshal(data, &varTransactionListResponse)

	if err != nil {
		return err
	}

	*o = TransactionListResponse(varTransactionListResponse)
