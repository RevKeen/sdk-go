...
// UpdatePriceRequest Parameters for updating an existing price. Amounts cannot be changed — archive and create a new price instead.
...
func (o *UpdatePriceRequest) SetNicknameNil() {
	o.Nickname.Set(nil)
}
...
func (o *UpdatePriceRequest) SetDescriptionNil() {
...
func (o *UpdatePriceRequest) SetLookupKeyNil() {
	o.LookupKey.Set(nil)
}
