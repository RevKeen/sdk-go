...
// BillingDetails Billing details associated with the payment method
type BillingDetails struct {
	...
	Address BillingDetailsAddress `json:"address"`
	AdditionalProperties map[string]interface{}
}

type _BillingDetails BillingDetails
...
func (o *BillingDetails) UnmarshalJSON(data []byte) (err error) {
	...
	varBillingDetails := _BillingDetails{}

	err = json.Unmarshal(data, &varBillingDetails)

	if err != nil {
		return err
	}

	*o = BillingDetails(varBillingDetails)
