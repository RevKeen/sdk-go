...
// checks if the CreateCartSessionInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateCartSessionInput{}

// CreateCartSessionInput struct for CreateCartSessionInput
type CreateCartSessionInput struct {
	Currency string `json:"currency"`
	Mode *string `json:"mode,omitempty"`
	CustomerId *string `json:"customer_id,omitempty"`
	LineItems []CartLineItemInput `json:"line_items,omitempty"`
	AddOnsOffered []string `json:"add_ons_offered,omitempty"`
	Metadata map[string]interface{} `json:"metadata,omitempty"`
	// Seed this cart from a cart-enabled payment link.
	PaymentLinkId *string `json:"payment_link_id,omitempty"`
}

type _CreateCartSessionInput CreateCartSessionInput
...
// SetLineItems gets a reference to the given []CartLineItemInput and assigns it to the LineItems field.
func (o *CreateCartSessionInput) SetLineItems(v []CartLineItemInput) {
	o.LineItems = v
}

// GetAddOnsOffered returns the AddOnsOffered field value if set, zero value otherwise.
func (o *CreateCartSessionInput) GetAddOnsOffered() []string {
	if o == nil || IsNil(o.AddOnsOffered) {
		var ret []string
		return ret
	}
...
// GetAddOnsOfferedOk returns a tuple with the AddOnsOffered field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetAddOnsOffered gets a reference to the given []string and assigns it to the AddOnsOffered field.
...
func (o *CreateCartSessionInput) GetPaymentLinkId() string {
...
// and a boolean to check if the value has been set.
func (o *CreateCartSessionInput) GetPaymentLinkIdOk() (*string, bool) {
	if o == nil || IsNil(o.PaymentLinkId) {
		return nil, false
	}
...
func (o *CreateCartSessionInput) HasPaymentLinkId() bool {
	if o != nil && !IsNil(o.PaymentLinkId) {
		return true
	}
...
func (o *CreateCartSessionInput) SetPaymentLinkId(v string) {
	o.PaymentLinkId = &v
}

func (o CreateCartSessionInput) MarshalJSON() ([]byte, error) {
...
func (o CreateCartSessionInput) ToMap() (map[string]interface{}, error) {
...
func (o *CreateCartSessionInput) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateCartSessionInput := _CreateCartSessionInput{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateCartSessionInput)

	if err != nil {
		return err
	}

	*o = CreateCartSessionInput(varCreateCartSessionInput)

	return err
}

type NullableCreateCartSessionInput struct {
	value *CreateCartSessionInput
	isSet bool
}

func (v NullableCreateCartSessionInput) Get() *CreateCartSessionInput {
	return v.value
}

func (v *NullableCreateCartSessionInput) Set(val *CreateCartSessionInput) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateCartSessionInput) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateCartSessionInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateCartSessionInput(val *CreateCartSessionInput) *NullableCreateCartSessionInput {
	return &NullableCreateCartSessionInput{value: val, isSet: true}
}

func (v NullableCreateCartSessionInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateCartSessionInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
