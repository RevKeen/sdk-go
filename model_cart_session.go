...
func NewCartSession(id string, object string, merchantId string, customerId NullableString, currency string, mode string, status CartSessionStatus, lineItems []CartLineItem, addOnsOffered []string, addOnsSelected []string, discountCode NullableString, subtotalMinor int32, totalMinor int32, metadata map[string]interface{}, convertedToCheckoutSessionId NullableString, createdAt time.Time, updatedAt time.Time, expiresAt time.Time) *CartSession {
	this := CartSession{}
	this.Id = id
	this.Object = object
