...
// checks if the InvoicesUpdateRequestSubscriptionTerms type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InvoicesUpdateRequestSubscriptionTerms{}

// InvoicesUpdateRequestSubscriptionTerms Subscription billing terms — set to null to remove
type InvoicesUpdateRequestSubscriptionTerms struct {
	...
	FirstPaymentBehavior string `json:"first_payment_behavior"`
	AdditionalProperties map[string]interface{}
}

type _InvoicesUpdateRequestSubscriptionTerms InvoicesUpdateRequestSubscriptionTerms
...
func NewInvoicesUpdateRequestSubscriptionTerms(collectionMethod string, startMode string, durationType string, firstPaymentBehavior string) *InvoicesUpdateRequestSubscriptionTerms {
	this := InvoicesUpdateRequestSubscriptionTerms{}
	this.CollectionMethod = collectionMethod
	this.StartMode = startMode
	this.DurationType = durationType
	this.FirstPaymentBehavior = firstPaymentBehavior
	return &this
}
...
// GetStartMode returns the StartMode field value
...
// GetStartModeOk returns a tuple with the StartMode field value
// and a boolean to check if the value has been set.
...
// GetDurationCount returns the DurationCount field value if set, zero value otherwise.
func (o *InvoicesUpdateRequestSubscriptionTerms) GetDurationCount() int32 {
	if o == nil || IsNil(o.DurationCount) {
		var ret int32
		return ret
	}
	return *o.DurationCount
}

// GetDurationCountOk returns a tuple with the DurationCount field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *InvoicesUpdateRequestSubscriptionTerms) GetDurationCountOk() (*int32, bool) {
	if o == nil || IsNil(o.DurationCount) {
		return nil, false
	}
	return o.DurationCount, true
}
...
// SetDurationCount gets a reference to the given int32 and assigns it to the DurationCount field.
...
// GetFirstPaymentBehavior returns the FirstPaymentBehavior field value
func (o *InvoicesUpdateRequestSubscriptionTerms) GetFirstPaymentBehavior() string {
	...
	return o.FirstPaymentBehavior
}

// GetFirstPaymentBehaviorOk returns a tuple with the FirstPaymentBehavior field value
// and a boolean to check if the value has been set.
func (o *InvoicesUpdateRequestSubscriptionTerms) GetFirstPaymentBehaviorOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.FirstPaymentBehavior, true
}

// SetFirstPaymentBehavior sets field value
func (o *InvoicesUpdateRequestSubscriptionTerms) SetFirstPaymentBehavior(v string) {
	o.FirstPaymentBehavior = v
}

func (o InvoicesUpdateRequestSubscriptionTerms) MarshalJSON() ([]byte, error) {
...
func (o InvoicesUpdateRequestSubscriptionTerms) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.DurationCount) {
		toSerialize["duration_count"] = o.DurationCount
	}
	if !IsNil(o.EndDate) {
		toSerialize["end_date"] = o.EndDate
	}
	toSerialize["first_payment_behavior"] = o.FirstPaymentBehavior
...
func (o *InvoicesUpdateRequestSubscriptionTerms) UnmarshalJSON(data []byte) (err error) {
	...
	varInvoicesUpdateRequestSubscriptionTerms := _InvoicesUpdateRequestSubscriptionTerms{}

	err = json.Unmarshal(data, &varInvoicesUpdateRequestSubscriptionTerms)

	if err != nil {
		return err
	}

	*o = InvoicesUpdateRequestSubscriptionTerms(varInvoicesUpdateRequestSubscriptionTerms)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "collection_method")
		delete(additionalProperties, "start_mode")
		delete(additionalProperties, "start_date")
		delete(additionalProperties, "duration_type")
		delete(additionalProperties, "duration_count")
		delete(additionalProperties, "end_date")
		delete(additionalProperties, "first_payment_behavior")
...
type NullableInvoicesUpdateRequestSubscriptionTerms struct {
	value *InvoicesUpdateRequestSubscriptionTerms
	isSet bool
}

func (v NullableInvoicesUpdateRequestSubscriptionTerms) Get() *InvoicesUpdateRequestSubscriptionTerms {
	return v.value
}

func (v *NullableInvoicesUpdateRequestSubscriptionTerms) Set(val *InvoicesUpdateRequestSubscriptionTerms) {
	v.value = val
	v.isSet = true
}

func (v NullableInvoicesUpdateRequestSubscriptionTerms) IsSet() bool {
	return v.isSet
}

func (v *NullableInvoicesUpdateRequestSubscriptionTerms) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInvoicesUpdateRequestSubscriptionTerms(val *InvoicesUpdateRequestSubscriptionTerms) *NullableInvoicesUpdateRequestSubscriptionTerms {
	return &NullableInvoicesUpdateRequestSubscriptionTerms{value: val, isSet: true}
}

func (v NullableInvoicesUpdateRequestSubscriptionTerms) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInvoicesUpdateRequestSubscriptionTerms) UnmarshalJSON(src []byte) error {
	v.isSet = true
