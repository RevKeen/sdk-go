...
// CreatePaymentIntentRequest Parameters for creating a new payment intent. Specify the amount, currency, customer, and optionally a payment method and capture strategy.
...
// GetCaptureMethod returns the CaptureMethod field value if set, zero value otherwise.
func (o *CreatePaymentIntentRequest) GetCaptureMethod() string {
	if o == nil || IsNil(o.CaptureMethod) {
		var ret string
		return ret
	}
...
// SetCaptureMethod gets a reference to the given string and assigns it to the CaptureMethod field.
...
func (o *CreatePaymentIntentRequest) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varCreatePaymentIntentRequest)
	...
	*o = CreatePaymentIntentRequest(varCreatePaymentIntentRequest)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "gateway_merchant_id")
