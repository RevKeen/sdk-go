...
// checks if the ProductsExternalBatchRequestProductsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProductsExternalBatchRequestProductsInner{}

// ProductsExternalBatchRequestProductsInner struct for ProductsExternalBatchRequestProductsInner
type ProductsExternalBatchRequestProductsInner struct {
...
type _ProductsExternalBatchRequestProductsInner ProductsExternalBatchRequestProductsInner
...
func NewProductsExternalBatchRequestProductsInner(externalId string, name string, amountCents int32) *ProductsExternalBatchRequestProductsInner {
	this := ProductsExternalBatchRequestProductsInner{}
...
func (o ProductsExternalBatchRequestProductsInner) MarshalJSON() ([]byte, error) {
...
func (o ProductsExternalBatchRequestProductsInner) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ExternalUpdatedAt) {
		toSerialize["external_updated_at"] = o.ExternalUpdatedAt
	}
...
func (o *ProductsExternalBatchRequestProductsInner) UnmarshalJSON(data []byte) (err error) {
	...
	varProductsExternalBatchRequestProductsInner := _ProductsExternalBatchRequestProductsInner{}

	err = json.Unmarshal(data, &varProductsExternalBatchRequestProductsInner)

	if err != nil {
		return err
	}

	*o = ProductsExternalBatchRequestProductsInner(varProductsExternalBatchRequestProductsInner)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "external_updated_at")
...
type NullableProductsExternalBatchRequestProductsInner struct {
	value *ProductsExternalBatchRequestProductsInner
	isSet bool
}

func (v NullableProductsExternalBatchRequestProductsInner) Get() *ProductsExternalBatchRequestProductsInner {
	return v.value
}

func (v *NullableProductsExternalBatchRequestProductsInner) Set(val *ProductsExternalBatchRequestProductsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableProductsExternalBatchRequestProductsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableProductsExternalBatchRequestProductsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProductsExternalBatchRequestProductsInner(val *ProductsExternalBatchRequestProductsInner) *NullableProductsExternalBatchRequestProductsInner {
	return &NullableProductsExternalBatchRequestProductsInner{value: val, isSet: true}
}

func (v NullableProductsExternalBatchRequestProductsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProductsExternalBatchRequestProductsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
