...
// checks if the PaymentIntentLastPaymentError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaymentIntentLastPaymentError{}

// PaymentIntentLastPaymentError Last error from payment attempt
type PaymentIntentLastPaymentError struct {
	...
	PaymentMethod *PaymentIntentLastPaymentErrorPaymentMethod `json:"payment_method,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _PaymentIntentLastPaymentError PaymentIntentLastPaymentError
...
func NewPaymentIntentLastPaymentError(code string, message string) *PaymentIntentLastPaymentError {
	this := PaymentIntentLastPaymentError{}
	this.Code = code
...
func (o *PaymentIntentLastPaymentError) GetPaymentMethod() PaymentIntentLastPaymentErrorPaymentMethod {
	if o == nil || IsNil(o.PaymentMethod) {
		var ret PaymentIntentLastPaymentErrorPaymentMethod
		return ret
	}
...
// SetPaymentMethod gets a reference to the given PaymentIntentLastPaymentErrorPaymentMethod and assigns it to the PaymentMethod field.
func (o *PaymentIntentLastPaymentError) SetPaymentMethod(v PaymentIntentLastPaymentErrorPaymentMethod) {
	o.PaymentMethod = &v
}

func (o PaymentIntentLastPaymentError) MarshalJSON() ([]byte, error) {
...
func (o PaymentIntentLastPaymentError) ToMap() (map[string]interface{}, error) {
...
func (o *PaymentIntentLastPaymentError) UnmarshalJSON(data []byte) (err error) {
	...
	varPaymentIntentLastPaymentError := _PaymentIntentLastPaymentError{}

	err = json.Unmarshal(data, &varPaymentIntentLastPaymentError)

	if err != nil {
		return err
	}

	*o = PaymentIntentLastPaymentError(varPaymentIntentLastPaymentError)
...
type NullablePaymentIntentLastPaymentError struct {
	value *PaymentIntentLastPaymentError
	isSet bool
}

func (v NullablePaymentIntentLastPaymentError) Get() *PaymentIntentLastPaymentError {
	return v.value
}

func (v *NullablePaymentIntentLastPaymentError) Set(val *PaymentIntentLastPaymentError) {
	v.value = val
	v.isSet = true
}

func (v NullablePaymentIntentLastPaymentError) IsSet() bool {
	return v.isSet
}

func (v *NullablePaymentIntentLastPaymentError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaymentIntentLastPaymentError(val *PaymentIntentLastPaymentError) *NullablePaymentIntentLastPaymentError {
	return &NullablePaymentIntentLastPaymentError{value: val, isSet: true}
}

func (v NullablePaymentIntentLastPaymentError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaymentIntentLastPaymentError) UnmarshalJSON(src []byte) error {
	v.isSet = true
