...
- `period_end`: cancelAtPeriodEnd flag set, access continues until period end
	...
	@return ApiSubscriptionsCancelSubscriptionRequest
	*/
	SubscriptionsCancelSubscription(ctx context.Context, id string) ApiSubscriptionsCancelSubscriptionRequest

	// SubscriptionsCancelSubscriptionExecute executes the request
	//  @return SubscriptionCancelSubscriptionResponse
	SubscriptionsCancelSubscriptionExecute(r ApiSubscriptionsCancelSubscriptionRequest) (*SubscriptionCancelSubscriptionResponse, *http.Response, error)
	...
	*/
	...
	/*
	SubscriptionsRetrieve Get subscription by ID
	...
	*/
	SubscriptionsRetrieve(ctx context.Context, id string) ApiSubscriptionsRetrieveRequest

	// SubscriptionsRetrieveExecute executes the request
	//  @return SubscriptionRetrieveResponse
	SubscriptionsRetrieveExecute(r ApiSubscriptionsRetrieveRequest) (*SubscriptionRetrieveResponse, *http.Response, error)
...
type ApiSubscriptionsCancelSubscriptionRequest struct {
	ctx context.Context
...
func (r ApiSubscriptionsCancelSubscriptionRequest) CancelSubscriptionInput(cancelSubscriptionInput CancelSubscriptionInput) ApiSubscriptionsCancelSubscriptionRequest {
	r.cancelSubscriptionInput = &cancelSubscriptionInput
	return r
}

func (r ApiSubscriptionsCancelSubscriptionRequest) Execute() (*SubscriptionCancelSubscriptionResponse, *http.Response, error) {
	return r.ApiService.SubscriptionsCancelSubscriptionExecute(r)
}
...
- `period_end`: cancelAtPeriodEnd flag set, access continues until period end
 ...
 @return ApiSubscriptionsCancelSubscriptionRequest
*/
func (a *SubscriptionsAPIService) SubscriptionsCancelSubscription(ctx context.Context, id string) ApiSubscriptionsCancelSubscriptionRequest {
	return ApiSubscriptionsCancelSubscriptionRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
//  @return SubscriptionCancelSubscriptionResponse
func (a *SubscriptionsAPIService) SubscriptionsCancelSubscriptionExecute(r ApiSubscriptionsCancelSubscriptionRequest) (*SubscriptionCancelSubscriptionResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SubscriptionsAPIService.SubscriptionsCancelSubscription")
	if err != nil {
...
func (r ApiSubscriptionsRetrieveRequest) Execute() (*SubscriptionRetrieveResponse, *http.Response, error) {
...
Retrieve detailed information about a specific subscription
 ...
 @return ApiSubscriptionsRetrieveRequest
*/
func (a *SubscriptionsAPIService) SubscriptionsRetrieve(ctx context.Context, id string) ApiSubscriptionsRetrieveRequest {
	return ApiSubscriptionsRetrieveRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return SubscriptionRetrieveResponse
func (a *SubscriptionsAPIService) SubscriptionsRetrieveExecute(r ApiSubscriptionsRetrieveRequest) (*SubscriptionRetrieveResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
