...
type Price struct {
	...
	UnitAmountDecimal NullableString `json:"unit_amount_decimal,omitempty"`
	// Price type
	...
	StartRule NullableString `json:"start_rule,omitempty"`
	...
	PercentageRateBps NullableInt32 `json:"percentage_rate_bps,omitempty"`
...
func NewPrice(id string, object string, productId string, active bool, currency string, unitAmount NullableInt32, type_ string, pricingModel string, version int32, billingScheme string, createdAt time.Time, updatedAt time.Time) *Price {
	this := Price{}
	this.Id = id
	this.Object = object
...
// GetUnitAmountDecimal returns the UnitAmountDecimal field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *Price) GetUnitAmountDecimal() string {
	if o == nil || IsNil(o.UnitAmountDecimal.Get()) {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Price) GetUnitAmountDecimalOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Price) HasUnitAmountDecimal() bool {
	if o != nil && o.UnitAmountDecimal.IsSet() {
		return true
	}
...
// SetUnitAmountDecimal gets a reference to the given NullableString and assigns it to the UnitAmountDecimal field.
func (o *Price) SetUnitAmountDecimal(v string) {
	o.UnitAmountDecimal.Set(&v)
}
// SetUnitAmountDecimalNil sets the value for UnitAmountDecimal to be an explicit nil
func (o *Price) SetUnitAmountDecimalNil() {
	o.UnitAmountDecimal.Set(nil)
}

// UnsetUnitAmountDecimal ensures that no value is present for UnitAmountDecimal, not even an explicit nil
func (o *Price) UnsetUnitAmountDecimal() {
	o.UnitAmountDecimal.Unset()
}
...
func (o *Price) GetStartRule() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Price) GetStartRuleOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Price) HasStartRule() bool {
...
// SetStartRule gets a reference to the given NullableString and assigns it to the StartRule field.
func (o *Price) SetStartRule(v string) {
	o.StartRule.Set(&v)
}
// SetStartRuleNil sets the value for StartRule to be an explicit nil
func (o *Price) SetStartRuleNil() {
	o.StartRule.Set(nil)
}

// UnsetStartRule ensures that no value is present for StartRule, not even an explicit nil
func (o *Price) UnsetStartRule() {
	o.StartRule.Unset()
}
...
func (o *Price) SetNameNil() {
	o.Name.Set(nil)
}

// UnsetName ensures that no value is present for Name, not even an explicit nil
func (o *Price) UnsetName() {
	o.Name.Unset()
}
...
func (o *Price) SetDescriptionNil() {
	o.Description.Set(nil)
}

// UnsetDescription ensures that no value is present for Description, not even an explicit nil
func (o *Price) UnsetDescription() {
	o.Description.Unset()
}

// GetVersion returns the Version field value
func (o *Price) GetVersion() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *Price) GetVersionOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Price) SetVersion(v int32) {
	o.Version = v
}
...
// GetPercentageRateBps returns the PercentageRateBps field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *Price) GetPercentageRateBps() int32 {
	if o == nil || IsNil(o.PercentageRateBps.Get()) {
		var ret int32
		return ret
	}
	return *o.PercentageRateBps.Get()
}

// GetPercentageRateBpsOk returns a tuple with the PercentageRateBps field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Price) GetPercentageRateBpsOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return o.PercentageRateBps.Get(), o.PercentageRateBps.IsSet()
}

// HasPercentageRateBps returns a boolean if a field has been set.
func (o *Price) HasPercentageRateBps() bool {
	if o != nil && o.PercentageRateBps.IsSet() {
		return true
	}
...
// SetPercentageRateBps gets a reference to the given NullableInt32 and assigns it to the PercentageRateBps field.
func (o *Price) SetPercentageRateBps(v int32) {
	o.PercentageRateBps.Set(&v)
}
// SetPercentageRateBpsNil sets the value for PercentageRateBps to be an explicit nil
func (o *Price) SetPercentageRateBpsNil() {
	o.PercentageRateBps.Set(nil)
}

// UnsetPercentageRateBps ensures that no value is present for PercentageRateBps, not even an explicit nil
func (o *Price) UnsetPercentageRateBps() {
	o.PercentageRateBps.Unset()
}

// GetPayInAdvance returns the PayInAdvance field value if set, zero value otherwise.
func (o *Price) GetPayInAdvance() bool {
...
// and a boolean to check if the value has been set.
func (o *Price) GetPayInAdvanceOk() (*bool, bool) {
	if o == nil || IsNil(o.PayInAdvance) {
		return nil, false
	}
...
func (o *Price) HasPayInAdvance() bool {
	if o != nil && !IsNil(o.PayInAdvance) {
		return true
	}
...
func (o *Price) SetPayInAdvance(v bool) {
	o.PayInAdvance = &v
}
...
func (o *Price) GetSpendingMinimumCents() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Price) GetSpendingMinimumCentsOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Price) HasSpendingMinimumCents() bool {
...
func (o *Price) UnsetSpendingMinimumCents() {
...
func (o Price) ToMap() (map[string]interface{}, error) {
	...
	if o.PercentageRateBps.IsSet() {
		toSerialize["percentage_rate_bps"] = o.PercentageRateBps.Get()
	}
