...
// checks if the ListPaymentLinks400Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListPaymentLinks400Response{}

// ListPaymentLinks400Response struct for ListPaymentLinks400Response
type ListPaymentLinks400Response struct {
	Error string `json:"error"`
	Details interface{} `json:"details,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _ListPaymentLinks400Response ListPaymentLinks400Response
...
func NewListPaymentLinks400Response(error_ string) *ListPaymentLinks400Response {
	this := ListPaymentLinks400Response{}
	this.Error = error_
	return &this
}
...
func (o ListPaymentLinks400Response) MarshalJSON() ([]byte, error) {
...
func (o ListPaymentLinks400Response) ToMap() (map[string]interface{}, error) {
...
func (o *ListPaymentLinks400Response) UnmarshalJSON(data []byte) (err error) {
	...
	varListPaymentLinks400Response := _ListPaymentLinks400Response{}

	err = json.Unmarshal(data, &varListPaymentLinks400Response)

	if err != nil {
		return err
	}

	*o = ListPaymentLinks400Response(varListPaymentLinks400Response)
...
type NullableListPaymentLinks400Response struct {
	value *ListPaymentLinks400Response
	isSet bool
}

func (v NullableListPaymentLinks400Response) Get() *ListPaymentLinks400Response {
	return v.value
}

func (v *NullableListPaymentLinks400Response) Set(val *ListPaymentLinks400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListPaymentLinks400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListPaymentLinks400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListPaymentLinks400Response(val *ListPaymentLinks400Response) *NullableListPaymentLinks400Response {
	return &NullableListPaymentLinks400Response{value: val, isSet: true}
}

func (v NullableListPaymentLinks400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListPaymentLinks400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
