...
// checks if the StorefrontStatusCheck type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StorefrontStatusCheck{}

// StorefrontStatusCheck struct for StorefrontStatusCheck
type StorefrontStatusCheck struct {
	Id string `json:"id"`
...
type _StorefrontStatusCheck StorefrontStatusCheck
...
func (o StorefrontStatusCheck) MarshalJSON() ([]byte, error) {
...
func (o StorefrontStatusCheck) ToMap() (map[string]interface{}, error) {
...
func (o *StorefrontStatusCheck) UnmarshalJSON(data []byte) (err error) {
	...
	varStorefrontStatusCheck := _StorefrontStatusCheck{}

	err = json.Unmarshal(data, &varStorefrontStatusCheck)

	if err != nil {
		return err
	}

	*o = StorefrontStatusCheck(varStorefrontStatusCheck)
...
type NullableStorefrontStatusCheck struct {
	value *StorefrontStatusCheck
	isSet bool
}

func (v NullableStorefrontStatusCheck) Get() *StorefrontStatusCheck {
	return v.value
}

func (v *NullableStorefrontStatusCheck) Set(val *StorefrontStatusCheck) {
	v.value = val
	v.isSet = true
}

func (v NullableStorefrontStatusCheck) IsSet() bool {
	return v.isSet
}

func (v *NullableStorefrontStatusCheck) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStorefrontStatusCheck(val *StorefrontStatusCheck) *NullableStorefrontStatusCheck {
	return &NullableStorefrontStatusCheck{value: val, isSet: true}
}

func (v NullableStorefrontStatusCheck) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStorefrontStatusCheck) UnmarshalJSON(src []byte) error {
	v.isSet = true
