...
// checks if the CreatePaymentLinkRequestLineItemsInnerPriceData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreatePaymentLinkRequestLineItemsInnerPriceData{}

// CreatePaymentLinkRequestLineItemsInnerPriceData struct for CreatePaymentLinkRequestLineItemsInnerPriceData
type CreatePaymentLinkRequestLineItemsInnerPriceData struct {
	Currency *string `json:"currency,omitempty"`
	UnitAmount int32 `json:"unit_amount"`
	ProductData *CreatePaymentLinkRequestLineItemsInnerPriceDataProductData `json:"product_data,omitempty"`
...
type _CreatePaymentLinkRequestLineItemsInnerPriceData CreatePaymentLinkRequestLineItemsInnerPriceData
...
func NewCreatePaymentLinkRequestLineItemsInnerPriceData(unitAmount int32) *CreatePaymentLinkRequestLineItemsInnerPriceData {
	this := CreatePaymentLinkRequestLineItemsInnerPriceData{}
...
func (o *CreatePaymentLinkRequestLineItemsInnerPriceData) GetProductData() CreatePaymentLinkRequestLineItemsInnerPriceDataProductData {
	if o == nil || IsNil(o.ProductData) {
		var ret CreatePaymentLinkRequestLineItemsInnerPriceDataProductData
		return ret
	}
...
// SetProductData gets a reference to the given CreatePaymentLinkRequestLineItemsInnerPriceDataProductData and assigns it to the ProductData field.
...
func (o *CreatePaymentLinkRequestLineItemsInnerPriceData) SetTaxBehaviorNil() {
...
func (o CreatePaymentLinkRequestLineItemsInnerPriceData) MarshalJSON() ([]byte, error) {
...
func (o CreatePaymentLinkRequestLineItemsInnerPriceData) ToMap() (map[string]interface{}, error) {
...
func (o *CreatePaymentLinkRequestLineItemsInnerPriceData) UnmarshalJSON(data []byte) (err error) {
	...
	varCreatePaymentLinkRequestLineItemsInnerPriceData := _CreatePaymentLinkRequestLineItemsInnerPriceData{}

	err = json.Unmarshal(data, &varCreatePaymentLinkRequestLineItemsInnerPriceData)

	if err != nil {
		return err
	}

	*o = CreatePaymentLinkRequestLineItemsInnerPriceData(varCreatePaymentLinkRequestLineItemsInnerPriceData)
...
type NullableCreatePaymentLinkRequestLineItemsInnerPriceData struct {
	value *CreatePaymentLinkRequestLineItemsInnerPriceData
	isSet bool
}

func (v NullableCreatePaymentLinkRequestLineItemsInnerPriceData) Get() *CreatePaymentLinkRequestLineItemsInnerPriceData {
	return v.value
}

func (v *NullableCreatePaymentLinkRequestLineItemsInnerPriceData) Set(val *CreatePaymentLinkRequestLineItemsInnerPriceData) {
	v.value = val
	v.isSet = true
}

func (v NullableCreatePaymentLinkRequestLineItemsInnerPriceData) IsSet() bool {
	return v.isSet
}

func (v *NullableCreatePaymentLinkRequestLineItemsInnerPriceData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreatePaymentLinkRequestLineItemsInnerPriceData(val *CreatePaymentLinkRequestLineItemsInnerPriceData) *NullableCreatePaymentLinkRequestLineItemsInnerPriceData {
	return &NullableCreatePaymentLinkRequestLineItemsInnerPriceData{value: val, isSet: true}
}

func (v NullableCreatePaymentLinkRequestLineItemsInnerPriceData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreatePaymentLinkRequestLineItemsInnerPriceData) UnmarshalJSON(src []byte) error {
	v.isSet = true
