...
// checks if the InvoicesFinalizeRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InvoicesFinalizeRequest{}

// InvoicesFinalizeRequest struct for InvoicesFinalizeRequest
...
type _InvoicesFinalizeRequest InvoicesFinalizeRequest
...
func (o InvoicesFinalizeRequest) MarshalJSON() ([]byte, error) {
...
func (o InvoicesFinalizeRequest) ToMap() (map[string]interface{}, error) {
...
func (o *InvoicesFinalizeRequest) UnmarshalJSON(data []byte) (err error) {
	varInvoicesFinalizeRequest := _InvoicesFinalizeRequest{}

	err = json.Unmarshal(data, &varInvoicesFinalizeRequest)

	if err != nil {
		return err
	}

	*o = InvoicesFinalizeRequest(varInvoicesFinalizeRequest)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "auto_advance")
...
type NullableInvoicesFinalizeRequest struct {
	value *InvoicesFinalizeRequest
	isSet bool
}

func (v NullableInvoicesFinalizeRequest) Get() *InvoicesFinalizeRequest {
	return v.value
}

func (v *NullableInvoicesFinalizeRequest) Set(val *InvoicesFinalizeRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableInvoicesFinalizeRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableInvoicesFinalizeRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInvoicesFinalizeRequest(val *InvoicesFinalizeRequest) *NullableInvoicesFinalizeRequest {
	return &NullableInvoicesFinalizeRequest{value: val, isSet: true}
}

func (v NullableInvoicesFinalizeRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInvoicesFinalizeRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
