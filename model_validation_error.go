...
// ValidationError Returned when request parameters or body fail schema validation. The details.fields object maps each invalid parameter to its validation errors.
...
func NewValidationError(error_ ValidationErrorError) *ValidationError {
...
func (o *ValidationError) GetError() ValidationErrorError {
	if o == nil {
		var ret ValidationErrorError
		return ret
	}
...
func (o *ValidationError) GetErrorOk() (*ValidationErrorError, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Error, true
...
func (o *ValidationError) SetError(v ValidationErrorError) {
	o.Error = v
}
