...
**BillingEndStrategy** | **NullableString** |  | 
**BillingMaxCycles** | **NullableInt32** |  | 
...
### SetBillingEndStrategyNil

`func (o *PortalSubscription) SetBillingEndStrategyNil(b bool)`

 SetBillingEndStrategyNil sets the value for BillingEndStrategy to be an explicit nil

### UnsetBillingEndStrategy
`func (o *PortalSubscription) UnsetBillingEndStrategy()`

UnsetBillingEndStrategy ensures that no value is present for BillingEndStrategy, not even an explicit nil
### GetBillingMaxCycles
...
`func (o *PortalSubscription) SetBillingMaxCyclesNil(b bool)`

 SetBillingMaxCyclesNil sets the value for BillingMaxCycles to be an explicit nil

### UnsetBillingMaxCycles
`func (o *PortalSubscription) UnsetBillingMaxCycles()`
