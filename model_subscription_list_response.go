...
// SubscriptionListResponse A paginated list of subscriptions matching the query filters.
type SubscriptionListResponse struct {
	Data []Subscription `json:"data"`
	Pagination SubscriptionListResponsePagination `json:"pagination"`
...
func NewSubscriptionListResponse(data []Subscription, pagination SubscriptionListResponsePagination) *SubscriptionListResponse {
...
func (o *SubscriptionListResponse) GetData() []Subscription {
	if o == nil {
...
func (o *SubscriptionListResponse) GetDataOk() ([]Subscription, bool) {
	if o == nil {
		return nil, false
	}
	return o.Data, true
...
func (o *SubscriptionListResponse) SetData(v []Subscription) {
	o.Data = v
}
...
func (o *SubscriptionListResponse) GetPagination() SubscriptionListResponsePagination {
	if o == nil {
		var ret SubscriptionListResponsePagination
		return ret
	}
...
func (o *SubscriptionListResponse) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varSubscriptionListResponse)
