...
// checks if the ValidateBankAccountRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ValidateBankAccountRequest{}

// ValidateBankAccountRequest Parameters for validating a UK bank account for Direct Debit eligibility.
...
type _ValidateBankAccountRequest ValidateBankAccountRequest
...
func NewValidateBankAccountRequest(sortCode string, accountNumber string) *ValidateBankAccountRequest {
	this := ValidateBankAccountRequest{}
...
func (o ValidateBankAccountRequest) MarshalJSON() ([]byte, error) {
...
func (o ValidateBankAccountRequest) ToMap() (map[string]interface{}, error) {
...
func (o *ValidateBankAccountRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varValidateBankAccountRequest := _ValidateBankAccountRequest{}

	err = json.Unmarshal(data, &varValidateBankAccountRequest)

	if err != nil {
		return err
	}

	*o = ValidateBankAccountRequest(varValidateBankAccountRequest)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "sortCode")
...
type NullableValidateBankAccountRequest struct {
	value *ValidateBankAccountRequest
	isSet bool
}

func (v NullableValidateBankAccountRequest) Get() *ValidateBankAccountRequest {
	return v.value
}

func (v *NullableValidateBankAccountRequest) Set(val *ValidateBankAccountRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableValidateBankAccountRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableValidateBankAccountRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableValidateBankAccountRequest(val *ValidateBankAccountRequest) *NullableValidateBankAccountRequest {
	return &NullableValidateBankAccountRequest{value: val, isSet: true}
}

func (v NullableValidateBankAccountRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableValidateBankAccountRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
