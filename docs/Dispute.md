...
**PaymentRail** | **NullableString** | Rail/payment method for the disputed transaction | 
**DisputeKind** | **NullableString** | Rail-specific dispute subtype, when available | 
...
`func (o *Dispute) SetPaymentRailNil(b bool)`

 SetPaymentRailNil sets the value for PaymentRail to be an explicit nil

### UnsetPaymentRail
`func (o *Dispute) UnsetPaymentRail()`

UnsetPaymentRail ensures that no value is present for PaymentRail, not even an explicit nil
### GetDisputeKind

`func (o *Dispute) GetDisputeKind() string`

GetDisputeKind returns the DisputeKind field if non-nil, zero value otherwise.

### GetDisputeKindOk

`func (o *Dispute) GetDisputeKindOk() (*string, bool)`

GetDisputeKindOk returns a tuple with the DisputeKind field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
SetDisputeKind sets DisputeKind field to given value.


### SetDisputeKindNil

`func (o *Dispute) SetDisputeKindNil(b bool)`

 SetDisputeKindNil sets the value for DisputeKind to be an explicit nil

### UnsetDisputeKind
`func (o *Dispute) UnsetDisputeKind()`

UnsetDisputeKind ensures that no value is present for DisputeKind, not even an explicit nil
### GetGatewayDisputeId
