...
// UpdatePaymentMethodRequest Parameters for updating a payment method's billing details or metadata.
...
type _UpdatePaymentMethodRequest UpdatePaymentMethodRequest
...
func (o *UpdatePaymentMethodRequest) UnmarshalJSON(data []byte) (err error) {
	varUpdatePaymentMethodRequest := _UpdatePaymentMethodRequest{}

	err = json.Unmarshal(data, &varUpdatePaymentMethodRequest)

	if err != nil {
		return err
	}

	*o = UpdatePaymentMethodRequest(varUpdatePaymentMethodRequest)
