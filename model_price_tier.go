...
type PriceTier struct {
	...
	UnitAmountMinor NullableInt32 `json:"unit_amount_minor"`
	...
	FlatAmountMinor NullableInt32 `json:"flat_amount_minor"`
...
func NewPriceTier(upTo NullableInt32, unitAmountMinor NullableInt32, flatAmountMinor NullableInt32) *PriceTier {
	...
	this.FlatAmountMinor = flatAmountMinor
	return &this
}
...
func (o *PriceTier) SetUnitAmountDecimalNil() {
...
// GetFlatAmountMinor returns the FlatAmountMinor field value
// If the value is explicit nil, the zero value for int32 will be returned
func (o *PriceTier) GetFlatAmountMinor() int32 {
	if o == nil || o.FlatAmountMinor.Get() == nil {
		var ret int32
		return ret
	}

	return *o.FlatAmountMinor.Get()
}

// GetFlatAmountMinorOk returns a tuple with the FlatAmountMinor field value
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PriceTier) GetFlatAmountMinorOk() (*int32, bool) {
	...
	return o.FlatAmountMinor.Get(), o.FlatAmountMinor.IsSet()
}

// SetFlatAmountMinor sets field value
func (o *PriceTier) SetFlatAmountMinor(v int32) {
	o.FlatAmountMinor.Set(&v)
}
...
func (o PriceTier) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["flat_amount_minor"] = o.FlatAmountMinor.Get()
...
func (o *PriceTier) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varPriceTier)
