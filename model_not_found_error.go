...
// NotFoundError Returned when the requested resource does not exist or does not belong to this merchant.
...
func NewNotFoundError(error_ NotFoundErrorError) *NotFoundError {
	this := NotFoundError{}
	this.Error = error_
	return &this
}
