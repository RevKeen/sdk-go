...
func main() {
	id := "38400000-8cf0-11bd-b23e-10b96e4ef00d" // string | ID of the mandate being replaced.
	portalReauthorizeMandateRequest := *openapiclient.NewPortalReauthorizeMandateRequest("AccountHolderName_example", "SortCode_example", "AccountNumber_example") // PortalReauthorizeMandateRequest | 
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**id** | **string** | ID of the mandate being replaced. | 
