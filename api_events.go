...
type EventsAPI interface {
	...
	*/
	...
	/*
	EventsRetrieve Retrieve an event
	...
	*/
	EventsRetrieve(ctx context.Context, id string) ApiEventsRetrieveRequest

	// EventsRetrieveExecute executes the request
	//  @return Event
	EventsRetrieveExecute(r ApiEventsRetrieveRequest) (*Event, *http.Response, error)
}
...
func (r ApiEventsRetrieveRequest) Execute() (*Event, *http.Response, error) {
...
Retrieves the details of an event by its ID.
 ...
 @return ApiEventsRetrieveRequest
*/
func (a *EventsAPIService) EventsRetrieve(ctx context.Context, id string) ApiEventsRetrieveRequest {
	return ApiEventsRetrieveRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return Event
func (a *EventsAPIService) EventsRetrieveExecute(r ApiEventsRetrieveRequest) (*Event, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
