...
// checks if the UpdateSubscriptionItemInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateSubscriptionItemInput{}

// UpdateSubscriptionItemInput Parameters for updating a subscription line item, such as changing the quantity.
...
type _UpdateSubscriptionItemInput UpdateSubscriptionItemInput
...
func NewUpdateSubscriptionItemInput() *UpdateSubscriptionItemInput {
	this := UpdateSubscriptionItemInput{}
	return &this
}
...
func (o *UpdateSubscriptionItemInput) GetPriceId() string {
...
// and a boolean to check if the value has been set.
func (o *UpdateSubscriptionItemInput) GetPriceIdOk() (*string, bool) {
	if o == nil || IsNil(o.PriceId) {
		return nil, false
	}
...
func (o *UpdateSubscriptionItemInput) HasPriceId() bool {
	if o != nil && !IsNil(o.PriceId) {
		return true
	}
...
func (o *UpdateSubscriptionItemInput) SetPriceId(v string) {
	o.PriceId = &v
}

func (o UpdateSubscriptionItemInput) MarshalJSON() ([]byte, error) {
...
func (o UpdateSubscriptionItemInput) ToMap() (map[string]interface{}, error) {
...
func (o *UpdateSubscriptionItemInput) UnmarshalJSON(data []byte) (err error) {
	varUpdateSubscriptionItemInput := _UpdateSubscriptionItemInput{}

	err = json.Unmarshal(data, &varUpdateSubscriptionItemInput)

	if err != nil {
		return err
	}

	*o = UpdateSubscriptionItemInput(varUpdateSubscriptionItemInput)
...
type NullableUpdateSubscriptionItemInput struct {
	value *UpdateSubscriptionItemInput
	isSet bool
}

func (v NullableUpdateSubscriptionItemInput) Get() *UpdateSubscriptionItemInput {
	return v.value
}

func (v *NullableUpdateSubscriptionItemInput) Set(val *UpdateSubscriptionItemInput) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateSubscriptionItemInput) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateSubscriptionItemInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateSubscriptionItemInput(val *UpdateSubscriptionItemInput) *NullableUpdateSubscriptionItemInput {
	return &NullableUpdateSubscriptionItemInput{value: val, isSet: true}
}

func (v NullableUpdateSubscriptionItemInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateSubscriptionItemInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
