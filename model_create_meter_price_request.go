...
// CreateMeterPriceRequest Parameters for creating a price attached to a usage meter, defining per-unit cost, tiered tiers, or a percentage rate.
type CreateMeterPriceRequest struct {
	...
	SpendingMinimumCents *int32 `json:"spending_minimum_cents,omitempty"`
...
func (o *CreateMeterPriceRequest) GetTiers() []MeterPriceTierInput {
...
// and a boolean to check if the value has been set.
func (o *CreateMeterPriceRequest) GetTiersOk() ([]MeterPriceTierInput, bool) {
	if o == nil || IsNil(o.Tiers) {
		return nil, false
	}
	return o.Tiers, true
...
func (o *CreateMeterPriceRequest) SetTiers(v []MeterPriceTierInput) {
	o.Tiers = v
}
...
// GetSpendingMinimumCents returns the SpendingMinimumCents field value if set, zero value otherwise.
func (o *CreateMeterPriceRequest) GetSpendingMinimumCents() int32 {
	if o == nil || IsNil(o.SpendingMinimumCents) {
		var ret int32
		return ret
	}
	return *o.SpendingMinimumCents
}
...
func (o *CreateMeterPriceRequest) GetSpendingMinimumCentsOk() (*int32, bool) {
	...
	return o.SpendingMinimumCents, true
}
...
// SetSpendingMinimumCents gets a reference to the given int32 and assigns it to the SpendingMinimumCents field.
func (o *CreateMeterPriceRequest) SetSpendingMinimumCents(v int32) {
	o.SpendingMinimumCents = &v
}
...
func (o CreateMeterPriceRequest) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.SpendingMinimumCents) {
		toSerialize["spending_minimum_cents"] = o.SpendingMinimumCents
	}
