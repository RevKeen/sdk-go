...
// checks if the ProductsExternalBatchRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProductsExternalBatchRequest{}

// ProductsExternalBatchRequest struct for ProductsExternalBatchRequest
type ProductsExternalBatchRequest struct {
	...
	Products []ProductsExternalBatchRequestProductsInner `json:"products"`
	AdditionalProperties map[string]interface{}
}

type _ProductsExternalBatchRequest ProductsExternalBatchRequest
...
func NewProductsExternalBatchRequest(source string, products []ProductsExternalBatchRequestProductsInner) *ProductsExternalBatchRequest {
	this := ProductsExternalBatchRequest{}
	this.Source = source
...
func (o *ProductsExternalBatchRequest) GetProducts() []ProductsExternalBatchRequestProductsInner {
	if o == nil {
		var ret []ProductsExternalBatchRequestProductsInner
		return ret
	}
...
func (o ProductsExternalBatchRequest) MarshalJSON() ([]byte, error) {
...
func (o ProductsExternalBatchRequest) ToMap() (map[string]interface{}, error) {
...
func (o *ProductsExternalBatchRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varProductsExternalBatchRequest := _ProductsExternalBatchRequest{}

	err = json.Unmarshal(data, &varProductsExternalBatchRequest)

	if err != nil {
		return err
	}

	*o = ProductsExternalBatchRequest(varProductsExternalBatchRequest)
...
type NullableProductsExternalBatchRequest struct {
	value *ProductsExternalBatchRequest
	isSet bool
}

func (v NullableProductsExternalBatchRequest) Get() *ProductsExternalBatchRequest {
	return v.value
}

func (v *NullableProductsExternalBatchRequest) Set(val *ProductsExternalBatchRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableProductsExternalBatchRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableProductsExternalBatchRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProductsExternalBatchRequest(val *ProductsExternalBatchRequest) *NullableProductsExternalBatchRequest {
	return &NullableProductsExternalBatchRequest{value: val, isSet: true}
}

func (v NullableProductsExternalBatchRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProductsExternalBatchRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
