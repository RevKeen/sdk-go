...
// checks if the InvoicesSendRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InvoicesSendRequest{}

// InvoicesSendRequest struct for InvoicesSendRequest
...
type _InvoicesSendRequest InvoicesSendRequest
...
func (o InvoicesSendRequest) MarshalJSON() ([]byte, error) {
...
func (o InvoicesSendRequest) ToMap() (map[string]interface{}, error) {
...
func (o *InvoicesSendRequest) UnmarshalJSON(data []byte) (err error) {
	varInvoicesSendRequest := _InvoicesSendRequest{}

	err = json.Unmarshal(data, &varInvoicesSendRequest)

	if err != nil {
		return err
	}

	*o = InvoicesSendRequest(varInvoicesSendRequest)
...
type NullableInvoicesSendRequest struct {
	value *InvoicesSendRequest
	isSet bool
}

func (v NullableInvoicesSendRequest) Get() *InvoicesSendRequest {
	return v.value
}

func (v *NullableInvoicesSendRequest) Set(val *InvoicesSendRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableInvoicesSendRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableInvoicesSendRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInvoicesSendRequest(val *InvoicesSendRequest) *NullableInvoicesSendRequest {
	return &NullableInvoicesSendRequest{value: val, isSet: true}
}

func (v NullableInvoicesSendRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInvoicesSendRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
