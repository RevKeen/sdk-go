...
**ValueExpression** | Pointer to **string** | Constrained arithmetic expression over numeric event properties. Example: input_tokens + output_tokens | [optional] 
...
`func (o *CreateMeterRequest) GetValueExpression() string`

GetValueExpression returns the ValueExpression field if non-nil, zero value otherwise.

### GetValueExpressionOk

`func (o *CreateMeterRequest) GetValueExpressionOk() (*string, bool)`
...
`func (o *CreateMeterRequest) SetValueExpression(v string)`

SetValueExpression sets ValueExpression field to given value.

### HasValueExpression

`func (o *CreateMeterRequest) HasValueExpression() bool`
