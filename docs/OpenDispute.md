...
`func (o *OpenDispute) GetPaymentRail() string`

GetPaymentRail returns the PaymentRail field if non-nil, zero value otherwise.

### GetPaymentRailOk

`func (o *OpenDispute) GetPaymentRailOk() (*string, bool)`
...
`func (o *OpenDispute) SetPaymentRail(v string)`
...
`func (o *OpenDispute) SetDisputeKind(v string)`
...
`func (o *OpenDispute) SetDisputeKindNil(b bool)`

 SetDisputeKindNil sets the value for DisputeKind to be an explicit nil

### UnsetDisputeKind
`func (o *OpenDispute) UnsetDisputeKind()`
