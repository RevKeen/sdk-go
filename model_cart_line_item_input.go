...
// checks if the CartLineItemInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CartLineItemInput{}

// CartLineItemInput struct for CartLineItemInput
type CartLineItemInput struct {
	...
	Recurring *CartLineItemRecurring `json:"recurring,omitempty"`
	Metadata map[string]interface{} `json:"metadata,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _CartLineItemInput CartLineItemInput
...
// SetRecurring gets a reference to the given CartLineItemRecurring and assigns it to the Recurring field.
...
func (o CartLineItemInput) MarshalJSON() ([]byte, error) {
...
func (o CartLineItemInput) ToMap() (map[string]interface{}, error) {
...
func (o *CartLineItemInput) UnmarshalJSON(data []byte) (err error) {
	...
	varCartLineItemInput := _CartLineItemInput{}

	err = json.Unmarshal(data, &varCartLineItemInput)

	if err != nil {
		return err
	}

	*o = CartLineItemInput(varCartLineItemInput)
...
type NullableCartLineItemInput struct {
	value *CartLineItemInput
	isSet bool
}

func (v NullableCartLineItemInput) Get() *CartLineItemInput {
	return v.value
}

func (v *NullableCartLineItemInput) Set(val *CartLineItemInput) {
	v.value = val
	v.isSet = true
}

func (v NullableCartLineItemInput) IsSet() bool {
	return v.isSet
}

func (v *NullableCartLineItemInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCartLineItemInput(val *CartLineItemInput) *NullableCartLineItemInput {
	return &NullableCartLineItemInput{value: val, isSet: true}
}

func (v NullableCartLineItemInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCartLineItemInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
