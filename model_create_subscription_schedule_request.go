...
// checks if the CreateSubscriptionScheduleRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateSubscriptionScheduleRequest{}

// CreateSubscriptionScheduleRequest Parameters for creating a subscription schedule with one or more phases of pricing and billing changes.
type CreateSubscriptionScheduleRequest struct {
	...
	StartDate *CreateSubscriptionScheduleRequestStartDate `json:"start_date,omitempty"`
...
type _CreateSubscriptionScheduleRequest CreateSubscriptionScheduleRequest
...
func NewCreateSubscriptionScheduleRequest(phases []SchedulePhase) *CreateSubscriptionScheduleRequest {
	this := CreateSubscriptionScheduleRequest{}
	this.Phases = phases
	var endBehavior string = "cancel"
...
func (o *CreateSubscriptionScheduleRequest) GetStartDate() CreateSubscriptionScheduleRequestStartDate {
	if o == nil || IsNil(o.StartDate) {
		var ret CreateSubscriptionScheduleRequestStartDate
		return ret
	}
	return *o.StartDate
}
...
// SetStartDate gets a reference to the given CreateSubscriptionScheduleRequestStartDate and assigns it to the StartDate field.
...
func (o CreateSubscriptionScheduleRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateSubscriptionScheduleRequest) ToMap() (map[string]interface{}, error) {
...
func (o *CreateSubscriptionScheduleRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateSubscriptionScheduleRequest := _CreateSubscriptionScheduleRequest{}

	err = json.Unmarshal(data, &varCreateSubscriptionScheduleRequest)

	if err != nil {
		return err
	}

	*o = CreateSubscriptionScheduleRequest(varCreateSubscriptionScheduleRequest)
...
type NullableCreateSubscriptionScheduleRequest struct {
	value *CreateSubscriptionScheduleRequest
	isSet bool
}

func (v NullableCreateSubscriptionScheduleRequest) Get() *CreateSubscriptionScheduleRequest {
	return v.value
}

func (v *NullableCreateSubscriptionScheduleRequest) Set(val *CreateSubscriptionScheduleRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateSubscriptionScheduleRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateSubscriptionScheduleRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateSubscriptionScheduleRequest(val *CreateSubscriptionScheduleRequest) *NullableCreateSubscriptionScheduleRequest {
	return &NullableCreateSubscriptionScheduleRequest{value: val, isSet: true}
}

func (v NullableCreateSubscriptionScheduleRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateSubscriptionScheduleRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
