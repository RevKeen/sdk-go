...
// checks if the CvvCodeInterpretation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CvvCodeInterpretation{}

// CvvCodeInterpretation CVV verification result
type CvvCodeInterpretation struct {
...
type _CvvCodeInterpretation CvvCodeInterpretation
...
func (o CvvCodeInterpretation) MarshalJSON() ([]byte, error) {
...
func (o CvvCodeInterpretation) ToMap() (map[string]interface{}, error) {
...
func (o *CvvCodeInterpretation) UnmarshalJSON(data []byte) (err error) {
	...
	varCvvCodeInterpretation := _CvvCodeInterpretation{}

	err = json.Unmarshal(data, &varCvvCodeInterpretation)

	if err != nil {
		return err
	}

	*o = CvvCodeInterpretation(varCvvCodeInterpretation)
...
type NullableCvvCodeInterpretation struct {
	value *CvvCodeInterpretation
	isSet bool
}

func (v NullableCvvCodeInterpretation) Get() *CvvCodeInterpretation {
	return v.value
}

func (v *NullableCvvCodeInterpretation) Set(val *CvvCodeInterpretation) {
	v.value = val
	v.isSet = true
}

func (v NullableCvvCodeInterpretation) IsSet() bool {
	return v.isSet
}

func (v *NullableCvvCodeInterpretation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCvvCodeInterpretation(val *CvvCodeInterpretation) *NullableCvvCodeInterpretation {
	return &NullableCvvCodeInterpretation{value: val, isSet: true}
}

func (v NullableCvvCodeInterpretation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCvvCodeInterpretation) UnmarshalJSON(src []byte) error {
	v.isSet = true
