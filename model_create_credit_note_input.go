...
type CreateCreditNoteInput struct {
	...
	TaxAmountMinor *float32 `json:"tax_amount_minor,omitempty"`
	...
	ProrationDaysTotal *float32 `json:"proration_days_total,omitempty"`
	// Unused days in the billing period (for prorated credits)
	ProrationDaysUnused *float32 `json:"proration_days_unused,omitempty"`
...
// SetTaxAmountMinor gets a reference to the given float32 and assigns it to the TaxAmountMinor field.
...
// SetProrationDaysTotal gets a reference to the given float32 and assigns it to the ProrationDaysTotal field.
...
// SetProrationDaysUnused gets a reference to the given float32 and assigns it to the ProrationDaysUnused field.
...
// GetCustomerPresent returns the CustomerPresent field value if set, zero value otherwise.
func (o *CreateCreditNoteInput) GetCustomerPresent() bool {
	if o == nil || IsNil(o.CustomerPresent) {
		var ret bool
		return ret
	}
	return *o.CustomerPresent
}

// GetCustomerPresentOk returns a tuple with the CustomerPresent field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CreateCreditNoteInput) GetCustomerPresentOk() (*bool, bool) {
	if o == nil || IsNil(o.CustomerPresent) {
		return nil, false
	}
	return o.CustomerPresent, true
}
...
// SetCustomerPresent gets a reference to the given bool and assigns it to the CustomerPresent field.
...
func (o CreateCreditNoteInput) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.CustomerPresent) {
		toSerialize["customer_present"] = o.CustomerPresent
	}
...
func (o *CreateCreditNoteInput) UnmarshalJSON(data []byte) (err error) {
	...
	*o = CreateCreditNoteInput(varCreateCreditNoteInput)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "customer_present")
