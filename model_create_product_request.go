...
func (o *CreateProductRequest) SetStockQuantityNil() {
...
func (o *CreateProductRequest) SetImageUrlNil() {
	o.ImageUrl.Set(nil)
}
...
func (o *CreateProductRequest) UnmarshalJSON(data []byte) (err error) {
	...
	*o = CreateProductRequest(varCreateProductRequest)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "track_inventory")
		delete(additionalProperties, "stock_quantity")
