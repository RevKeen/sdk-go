...
// checks if the InvoicesVoidRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InvoicesVoidRequest{}

// InvoicesVoidRequest struct for InvoicesVoidRequest
...
type _InvoicesVoidRequest InvoicesVoidRequest
...
func (o InvoicesVoidRequest) MarshalJSON() ([]byte, error) {
...
func (o InvoicesVoidRequest) ToMap() (map[string]interface{}, error) {
...
func (o *InvoicesVoidRequest) UnmarshalJSON(data []byte) (err error) {
	varInvoicesVoidRequest := _InvoicesVoidRequest{}

	err = json.Unmarshal(data, &varInvoicesVoidRequest)

	if err != nil {
		return err
	}

	*o = InvoicesVoidRequest(varInvoicesVoidRequest)
...
type NullableInvoicesVoidRequest struct {
	value *InvoicesVoidRequest
	isSet bool
}

func (v NullableInvoicesVoidRequest) Get() *InvoicesVoidRequest {
	return v.value
}

func (v *NullableInvoicesVoidRequest) Set(val *InvoicesVoidRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableInvoicesVoidRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableInvoicesVoidRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInvoicesVoidRequest(val *InvoicesVoidRequest) *NullableInvoicesVoidRequest {
	return &NullableInvoicesVoidRequest{value: val, isSet: true}
}

func (v NullableInvoicesVoidRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInvoicesVoidRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
