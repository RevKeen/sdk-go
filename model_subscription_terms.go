...
// checks if the SubscriptionTerms type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SubscriptionTerms{}

// SubscriptionTerms Subscription billing terms for recurring invoices
...
type _SubscriptionTerms SubscriptionTerms
...
func (o SubscriptionTerms) MarshalJSON() ([]byte, error) {
...
func (o SubscriptionTerms) ToMap() (map[string]interface{}, error) {
...
func (o *SubscriptionTerms) UnmarshalJSON(data []byte) (err error) {
	...
	varSubscriptionTerms := _SubscriptionTerms{}

	err = json.Unmarshal(data, &varSubscriptionTerms)

	if err != nil {
		return err
	}

	*o = SubscriptionTerms(varSubscriptionTerms)
...
type NullableSubscriptionTerms struct {
	value *SubscriptionTerms
	isSet bool
}

func (v NullableSubscriptionTerms) Get() *SubscriptionTerms {
	return v.value
}

func (v *NullableSubscriptionTerms) Set(val *SubscriptionTerms) {
	v.value = val
	v.isSet = true
}

func (v NullableSubscriptionTerms) IsSet() bool {
	return v.isSet
}

func (v *NullableSubscriptionTerms) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSubscriptionTerms(val *SubscriptionTerms) *NullableSubscriptionTerms {
	return &NullableSubscriptionTerms{value: val, isSet: true}
}

func (v NullableSubscriptionTerms) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSubscriptionTerms) UnmarshalJSON(src []byte) error {
	v.isSet = true
