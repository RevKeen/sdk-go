...
// checks if the ListPaymentLinks200ResponseDataInnerLineItemsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListPaymentLinks200ResponseDataInnerLineItemsInner{}

// ListPaymentLinks200ResponseDataInnerLineItemsInner struct for ListPaymentLinks200ResponseDataInnerLineItemsInner
type ListPaymentLinks200ResponseDataInnerLineItemsInner struct {
	...
	ProductDetails *ListPaymentLinks200ResponseDataInnerLineItemsInnerProductDetails `json:"product_details,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _ListPaymentLinks200ResponseDataInnerLineItemsInner ListPaymentLinks200ResponseDataInnerLineItemsInner
...
func NewListPaymentLinks200ResponseDataInnerLineItemsInner(productId string, quantity int32, isAdhoc bool) *ListPaymentLinks200ResponseDataInnerLineItemsInner {
	this := ListPaymentLinks200ResponseDataInnerLineItemsInner{}
...
func (o *ListPaymentLinks200ResponseDataInnerLineItemsInner) SetPriceIdNil() {
	o.PriceId.Set(nil)
}
...
func (o *ListPaymentLinks200ResponseDataInnerLineItemsInner) SetMerchantReferenceNil() {
...
func (o *ListPaymentLinks200ResponseDataInnerLineItemsInner) GetProductDetails() ListPaymentLinks200ResponseDataInnerLineItemsInnerProductDetails {
	if o == nil || IsNil(o.ProductDetails) {
		var ret ListPaymentLinks200ResponseDataInnerLineItemsInnerProductDetails
		return ret
	}
...
// SetProductDetails gets a reference to the given ListPaymentLinks200ResponseDataInnerLineItemsInnerProductDetails and assigns it to the ProductDetails field.
...
func (o ListPaymentLinks200ResponseDataInnerLineItemsInner) MarshalJSON() ([]byte, error) {
...
func (o ListPaymentLinks200ResponseDataInnerLineItemsInner) ToMap() (map[string]interface{}, error) {
...
func (o *ListPaymentLinks200ResponseDataInnerLineItemsInner) UnmarshalJSON(data []byte) (err error) {
	...
	varListPaymentLinks200ResponseDataInnerLineItemsInner := _ListPaymentLinks200ResponseDataInnerLineItemsInner{}

	err = json.Unmarshal(data, &varListPaymentLinks200ResponseDataInnerLineItemsInner)

	if err != nil {
		return err
	}

	*o = ListPaymentLinks200ResponseDataInnerLineItemsInner(varListPaymentLinks200ResponseDataInnerLineItemsInner)
...
type NullableListPaymentLinks200ResponseDataInnerLineItemsInner struct {
	value *ListPaymentLinks200ResponseDataInnerLineItemsInner
	isSet bool
}

func (v NullableListPaymentLinks200ResponseDataInnerLineItemsInner) Get() *ListPaymentLinks200ResponseDataInnerLineItemsInner {
	return v.value
}

func (v *NullableListPaymentLinks200ResponseDataInnerLineItemsInner) Set(val *ListPaymentLinks200ResponseDataInnerLineItemsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableListPaymentLinks200ResponseDataInnerLineItemsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableListPaymentLinks200ResponseDataInnerLineItemsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListPaymentLinks200ResponseDataInnerLineItemsInner(val *ListPaymentLinks200ResponseDataInnerLineItemsInner) *NullableListPaymentLinks200ResponseDataInnerLineItemsInner {
	return &NullableListPaymentLinks200ResponseDataInnerLineItemsInner{value: val, isSet: true}
}

func (v NullableListPaymentLinks200ResponseDataInnerLineItemsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListPaymentLinks200ResponseDataInnerLineItemsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
