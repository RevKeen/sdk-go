...
// checks if the ImportErrorsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImportErrorsInner{}

// ImportErrorsInner struct for ImportErrorsInner
type ImportErrorsInner struct {
	// Row number (1-based)
	Row int32 `json:"row"`
...
type _ImportErrorsInner ImportErrorsInner
...
func (o ImportErrorsInner) MarshalJSON() ([]byte, error) {
...
func (o ImportErrorsInner) ToMap() (map[string]interface{}, error) {
...
func (o *ImportErrorsInner) UnmarshalJSON(data []byte) (err error) {
	...
	varImportErrorsInner := _ImportErrorsInner{}

	err = json.Unmarshal(data, &varImportErrorsInner)

	if err != nil {
		return err
	}

	*o = ImportErrorsInner(varImportErrorsInner)
...
type NullableImportErrorsInner struct {
	value *ImportErrorsInner
	isSet bool
}

func (v NullableImportErrorsInner) Get() *ImportErrorsInner {
	return v.value
}

func (v *NullableImportErrorsInner) Set(val *ImportErrorsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableImportErrorsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableImportErrorsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableImportErrorsInner(val *ImportErrorsInner) *NullableImportErrorsInner {
	return &NullableImportErrorsInner{value: val, isSet: true}
}

func (v NullableImportErrorsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableImportErrorsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
