...
type PaymentAttempt struct {
	...
	AvsCode NullableString `json:"avs_code"`
	// CVV verification response code
	CvvCode NullableString `json:"cvv_code"`
	// Issuer-specific response code
	IssuerCode NullableString `json:"issuer_code"`
...
func (o *PaymentAttempt) GetIssuerCode() string {
	if o == nil || o.IssuerCode.Get() == nil {
		var ret string
		return ret
	}

	return *o.IssuerCode.Get()
}
...
func (o *PaymentAttempt) GetIssuerCodeOk() (*string, bool) {
	...
	return o.IssuerCode.Get(), o.IssuerCode.IsSet()
}
...
func (o PaymentAttempt) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["avs_code"] = o.AvsCode.Get()
	toSerialize["cvv_code"] = o.CvvCode.Get()
	toSerialize["issuer_code"] = o.IssuerCode.Get()
