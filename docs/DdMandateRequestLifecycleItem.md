...
**NotificationDeliveryEventType** | **NullableString** |  | 
**NotificationDeliveryStatus** | **NullableString** |  | 
**NotificationDeliveryError** | **NullableString** |  | 
**NotificationDeliveryUpdatedAt** | **NullableString** |  | 
**PdfDocuments** | [**[]DdMandatePdfReference**](DdMandatePdfReference.md) |  | 

## Methods

### NewDdMandateRequestLifecycleItem

`func NewDdMandateRequestLifecycleItem(id string, merchantId string, customerId string, invoiceId NullableString, subscriptionId NullableString, mandateId NullableString, token string, signableUrl string, createdAt NullableString, expiresAt NullableString, consumedAt NullableString, cancelledAt NullableString, expiredAt NullableString, status DdMandateRequestLifecycleStatus, notificationDeliveryEventType NullableString, notificationDeliveryStatus NullableString, notificationDeliveryError NullableString, notificationDeliveryUpdatedAt NullableString, pdfDocuments []DdMandatePdfReference, ) *DdMandateRequestLifecycleItem`
...
### GetNotificationDeliveryEventType

`func (o *DdMandateRequestLifecycleItem) GetNotificationDeliveryEventType() string`

GetNotificationDeliveryEventType returns the NotificationDeliveryEventType field if non-nil, zero value otherwise.

### GetNotificationDeliveryEventTypeOk

`func (o *DdMandateRequestLifecycleItem) GetNotificationDeliveryEventTypeOk() (*string, bool)`

GetNotificationDeliveryEventTypeOk returns a tuple with the NotificationDeliveryEventType field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetNotificationDeliveryEventType

`func (o *DdMandateRequestLifecycleItem) SetNotificationDeliveryEventType(v string)`

SetNotificationDeliveryEventType sets NotificationDeliveryEventType field to given value.


### SetNotificationDeliveryEventTypeNil

`func (o *DdMandateRequestLifecycleItem) SetNotificationDeliveryEventTypeNil(b bool)`

 SetNotificationDeliveryEventTypeNil sets the value for NotificationDeliveryEventType to be an explicit nil

### UnsetNotificationDeliveryEventType
`func (o *DdMandateRequestLifecycleItem) UnsetNotificationDeliveryEventType()`

UnsetNotificationDeliveryEventType ensures that no value is present for NotificationDeliveryEventType, not even an explicit nil
### GetNotificationDeliveryStatus

`func (o *DdMandateRequestLifecycleItem) GetNotificationDeliveryStatus() string`

GetNotificationDeliveryStatus returns the NotificationDeliveryStatus field if non-nil, zero value otherwise.

### GetNotificationDeliveryStatusOk

`func (o *DdMandateRequestLifecycleItem) GetNotificationDeliveryStatusOk() (*string, bool)`

GetNotificationDeliveryStatusOk returns a tuple with the NotificationDeliveryStatus field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetNotificationDeliveryStatus

`func (o *DdMandateRequestLifecycleItem) SetNotificationDeliveryStatus(v string)`

SetNotificationDeliveryStatus sets NotificationDeliveryStatus field to given value.


### SetNotificationDeliveryStatusNil

`func (o *DdMandateRequestLifecycleItem) SetNotificationDeliveryStatusNil(b bool)`

 SetNotificationDeliveryStatusNil sets the value for NotificationDeliveryStatus to be an explicit nil

### UnsetNotificationDeliveryStatus
`func (o *DdMandateRequestLifecycleItem) UnsetNotificationDeliveryStatus()`

UnsetNotificationDeliveryStatus ensures that no value is present for NotificationDeliveryStatus, not even an explicit nil
### GetNotificationDeliveryError

`func (o *DdMandateRequestLifecycleItem) GetNotificationDeliveryError() string`

GetNotificationDeliveryError returns the NotificationDeliveryError field if non-nil, zero value otherwise.

### GetNotificationDeliveryErrorOk

`func (o *DdMandateRequestLifecycleItem) GetNotificationDeliveryErrorOk() (*string, bool)`

GetNotificationDeliveryErrorOk returns a tuple with the NotificationDeliveryError field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetNotificationDeliveryError

`func (o *DdMandateRequestLifecycleItem) SetNotificationDeliveryError(v string)`

SetNotificationDeliveryError sets NotificationDeliveryError field to given value.


### SetNotificationDeliveryErrorNil

`func (o *DdMandateRequestLifecycleItem) SetNotificationDeliveryErrorNil(b bool)`

 SetNotificationDeliveryErrorNil sets the value for NotificationDeliveryError to be an explicit nil

### UnsetNotificationDeliveryError
`func (o *DdMandateRequestLifecycleItem) UnsetNotificationDeliveryError()`

UnsetNotificationDeliveryError ensures that no value is present for NotificationDeliveryError, not even an explicit nil
### GetNotificationDeliveryUpdatedAt

`func (o *DdMandateRequestLifecycleItem) GetNotificationDeliveryUpdatedAt() string`

GetNotificationDeliveryUpdatedAt returns the NotificationDeliveryUpdatedAt field if non-nil, zero value otherwise.

### GetNotificationDeliveryUpdatedAtOk

`func (o *DdMandateRequestLifecycleItem) GetNotificationDeliveryUpdatedAtOk() (*string, bool)`

GetNotificationDeliveryUpdatedAtOk returns a tuple with the NotificationDeliveryUpdatedAt field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetNotificationDeliveryUpdatedAt

`func (o *DdMandateRequestLifecycleItem) SetNotificationDeliveryUpdatedAt(v string)`

SetNotificationDeliveryUpdatedAt sets NotificationDeliveryUpdatedAt field to given value.


### SetNotificationDeliveryUpdatedAtNil

`func (o *DdMandateRequestLifecycleItem) SetNotificationDeliveryUpdatedAtNil(b bool)`

 SetNotificationDeliveryUpdatedAtNil sets the value for NotificationDeliveryUpdatedAt to be an explicit nil

### UnsetNotificationDeliveryUpdatedAt
`func (o *DdMandateRequestLifecycleItem) UnsetNotificationDeliveryUpdatedAt()`

UnsetNotificationDeliveryUpdatedAt ensures that no value is present for NotificationDeliveryUpdatedAt, not even an explicit nil
### GetPdfDocuments

`func (o *DdMandateRequestLifecycleItem) GetPdfDocuments() []DdMandatePdfReference`

GetPdfDocuments returns the PdfDocuments field if non-nil, zero value otherwise.

### GetPdfDocumentsOk

`func (o *DdMandateRequestLifecycleItem) GetPdfDocumentsOk() (*[]DdMandatePdfReference, bool)`
...
`func (o *DdMandateRequestLifecycleItem) SetPdfDocuments(v []DdMandatePdfReference)`
