...
// checks if the StorefrontAvailability type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StorefrontAvailability{}

// StorefrontAvailability Derived availability (capacity + oversell − reserved − confirmed). `unknown` when the product does not track availability.
type StorefrontAvailability struct {
	Status string `json:"status"`
	Remaining NullableInt32 `json:"remaining"`
	DisplayMode string `json:"display_mode"`
	LowStockThreshold NullableInt32 `json:"low_stock_threshold"`
	AdditionalProperties map[string]interface{}
}

type _StorefrontAvailability StorefrontAvailability
...
// GetLowStockThreshold returns the LowStockThreshold field value
// If the value is explicit nil, the zero value for int32 will be returned
func (o *StorefrontAvailability) GetLowStockThreshold() int32 {
	if o == nil || o.LowStockThreshold.Get() == nil {
		var ret int32
		return ret
	}
...
// GetLowStockThresholdOk returns a tuple with the LowStockThreshold field value
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// SetLowStockThreshold sets field value
func (o *StorefrontAvailability) SetLowStockThreshold(v int32) {
	o.LowStockThreshold.Set(&v)
}

func (o StorefrontAvailability) MarshalJSON() ([]byte, error) {
...
func (o StorefrontAvailability) ToMap() (map[string]interface{}, error) {
...
func (o *StorefrontAvailability) UnmarshalJSON(data []byte) (err error) {
	...
	varStorefrontAvailability := _StorefrontAvailability{}

	err = json.Unmarshal(data, &varStorefrontAvailability)

	if err != nil {
		return err
	}

	*o = StorefrontAvailability(varStorefrontAvailability)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "low_stock_threshold")
...
type NullableStorefrontAvailability struct {
	value *StorefrontAvailability
	isSet bool
}

func (v NullableStorefrontAvailability) Get() *StorefrontAvailability {
	return v.value
}

func (v *NullableStorefrontAvailability) Set(val *StorefrontAvailability) {
	v.value = val
	v.isSet = true
}

func (v NullableStorefrontAvailability) IsSet() bool {
	return v.isSet
}

func (v *NullableStorefrontAvailability) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStorefrontAvailability(val *StorefrontAvailability) *NullableStorefrontAvailability {
	return &NullableStorefrontAvailability{value: val, isSet: true}
}

func (v NullableStorefrontAvailability) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStorefrontAvailability) UnmarshalJSON(src []byte) error {
	v.isSet = true
