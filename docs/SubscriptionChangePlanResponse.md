...
`func NewSubscriptionChangePlanResponse(subscription Subscription, invoiceCreated bool, ) *SubscriptionChangePlanResponse`
...
`func (o *SubscriptionChangePlanResponse) GetSubscription() Subscription`

GetSubscription returns the Subscription field if non-nil, zero value otherwise.

### GetSubscriptionOk

`func (o *SubscriptionChangePlanResponse) GetSubscriptionOk() (*Subscription, bool)`
...
`func (o *SubscriptionChangePlanResponse) SetSubscription(v Subscription)`
