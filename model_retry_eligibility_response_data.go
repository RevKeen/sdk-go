...
// checks if the RetryEligibilityResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RetryEligibilityResponseData{}

// RetryEligibilityResponseData struct for RetryEligibilityResponseData
type RetryEligibilityResponseData struct {
	// Whether the subscription should be retried
	ShouldRetry bool `json:"should_retry"`
	// Explanation for the retry decision
	Reason string `json:"reason"`
	LastAttempt RetryEligibilityResponseDataLastAttempt `json:"last_attempt"`
	AdditionalProperties map[string]interface{}
}

type _RetryEligibilityResponseData RetryEligibilityResponseData
...
func NewRetryEligibilityResponseData(shouldRetry bool, reason string, lastAttempt RetryEligibilityResponseDataLastAttempt) *RetryEligibilityResponseData {
	this := RetryEligibilityResponseData{}
...
// GetShouldRetry returns the ShouldRetry field value
...
// GetShouldRetryOk returns a tuple with the ShouldRetry field value
// and a boolean to check if the value has been set.
func (o *RetryEligibilityResponseData) GetShouldRetryOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return &o.ShouldRetry, true
}

// SetShouldRetry sets field value
...
func (o *RetryEligibilityResponseData) GetLastAttempt() RetryEligibilityResponseDataLastAttempt {
	if o == nil {
		var ret RetryEligibilityResponseDataLastAttempt
		return ret
	}
...
func (o RetryEligibilityResponseData) MarshalJSON() ([]byte, error) {
...
func (o RetryEligibilityResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["should_retry"] = o.ShouldRetry
...
func (o *RetryEligibilityResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varRetryEligibilityResponseData := _RetryEligibilityResponseData{}

	err = json.Unmarshal(data, &varRetryEligibilityResponseData)

	if err != nil {
		return err
	}

	*o = RetryEligibilityResponseData(varRetryEligibilityResponseData)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "should_retry")
		delete(additionalProperties, "reason")
		delete(additionalProperties, "last_attempt")
...
type NullableRetryEligibilityResponseData struct {
	value *RetryEligibilityResponseData
	isSet bool
}

func (v NullableRetryEligibilityResponseData) Get() *RetryEligibilityResponseData {
	return v.value
}

func (v *NullableRetryEligibilityResponseData) Set(val *RetryEligibilityResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableRetryEligibilityResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableRetryEligibilityResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRetryEligibilityResponseData(val *RetryEligibilityResponseData) *NullableRetryEligibilityResponseData {
	return &NullableRetryEligibilityResponseData{value: val, isSet: true}
}

func (v NullableRetryEligibilityResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRetryEligibilityResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
