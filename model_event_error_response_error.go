...
// checks if the EventErrorResponseError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EventErrorResponseError{}

// EventErrorResponseError struct for EventErrorResponseError
...
type _EventErrorResponseError EventErrorResponseError
...
func (o EventErrorResponseError) MarshalJSON() ([]byte, error) {
...
func (o EventErrorResponseError) ToMap() (map[string]interface{}, error) {
...
func (o *EventErrorResponseError) UnmarshalJSON(data []byte) (err error) {
	...
	varEventErrorResponseError := _EventErrorResponseError{}

	err = json.Unmarshal(data, &varEventErrorResponseError)

	if err != nil {
		return err
	}

	*o = EventErrorResponseError(varEventErrorResponseError)
...
type NullableEventErrorResponseError struct {
	value *EventErrorResponseError
	isSet bool
}

func (v NullableEventErrorResponseError) Get() *EventErrorResponseError {
	return v.value
}

func (v *NullableEventErrorResponseError) Set(val *EventErrorResponseError) {
	v.value = val
	v.isSet = true
}

func (v NullableEventErrorResponseError) IsSet() bool {
	return v.isSet
}

func (v *NullableEventErrorResponseError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEventErrorResponseError(val *EventErrorResponseError) *NullableEventErrorResponseError {
	return &NullableEventErrorResponseError{value: val, isSet: true}
}

func (v NullableEventErrorResponseError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEventErrorResponseError) UnmarshalJSON(src []byte) error {
	v.isSet = true
