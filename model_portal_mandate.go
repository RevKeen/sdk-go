...
// checks if the PortalMandate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PortalMandate{}

// PortalMandate A customer-facing Direct Debit mandate projection. Bank details are masked — only the last 4 digits of the account number are exposed.
type PortalMandate struct {
	Id string `json:"id"`
	...
	NextCollectionDate NullableString `json:"next_collection_date"`
	CreatedAt NullableTime `json:"created_at"`
	AdditionalProperties map[string]interface{}
}

type _PortalMandate PortalMandate
...
// GetNextCollectionDate returns the NextCollectionDate field value
// If the value is explicit nil, the zero value for string will be returned
func (o *PortalMandate) GetNextCollectionDate() string {
	if o == nil || o.NextCollectionDate.Get() == nil {
		var ret string
		return ret
	}
...
// GetNextCollectionDateOk returns a tuple with the NextCollectionDate field value
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// SetNextCollectionDate sets field value
...
func (o PortalMandate) MarshalJSON() ([]byte, error) {
...
func (o PortalMandate) ToMap() (map[string]interface{}, error) {
...
func (o *PortalMandate) UnmarshalJSON(data []byte) (err error) {
	...
	varPortalMandate := _PortalMandate{}

	err = json.Unmarshal(data, &varPortalMandate)

	if err != nil {
		return err
	}

	*o = PortalMandate(varPortalMandate)
...
type NullablePortalMandate struct {
	value *PortalMandate
	isSet bool
}

func (v NullablePortalMandate) Get() *PortalMandate {
	return v.value
}

func (v *NullablePortalMandate) Set(val *PortalMandate) {
	v.value = val
	v.isSet = true
}

func (v NullablePortalMandate) IsSet() bool {
	return v.isSet
}

func (v *NullablePortalMandate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePortalMandate(val *PortalMandate) *NullablePortalMandate {
	return &NullablePortalMandate{value: val, isSet: true}
}

func (v NullablePortalMandate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePortalMandate) UnmarshalJSON(src []byte) error {
	v.isSet = true
