...
func NewWebhookDeliveryResponse(data WebhookDelivery) *WebhookDeliveryResponse {
...
func (o *WebhookDeliveryResponse) GetData() WebhookDelivery {
	if o == nil {
...
func (o *WebhookDeliveryResponse) GetDataOk() (*WebhookDelivery, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *WebhookDeliveryResponse) SetData(v WebhookDelivery) {
	o.Data = v
}
...
func (o *WebhookDeliveryResponse) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varWebhookDeliveryResponse)
