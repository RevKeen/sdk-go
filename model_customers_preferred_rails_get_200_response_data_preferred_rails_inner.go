...
type CustomersPreferredRailsGet200ResponseDataPreferredRailsInner struct {
	...
	MandateRef NullableString `json:"mandate_ref,omitempty"`
...
// GetMandateRef returns the MandateRef field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *CustomersPreferredRailsGet200ResponseDataPreferredRailsInner) GetMandateRef() string {
	if o == nil || IsNil(o.MandateRef.Get()) {
		var ret string
		return ret
	}
	return *o.MandateRef.Get()
}

// GetMandateRefOk returns a tuple with the MandateRef field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *CustomersPreferredRailsGet200ResponseDataPreferredRailsInner) GetMandateRefOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return o.MandateRef.Get(), o.MandateRef.IsSet()
}

// HasMandateRef returns a boolean if a field has been set.
func (o *CustomersPreferredRailsGet200ResponseDataPreferredRailsInner) HasMandateRef() bool {
	if o != nil && o.MandateRef.IsSet() {
		return true
	}
...
// SetMandateRef gets a reference to the given NullableString and assigns it to the MandateRef field.
func (o *CustomersPreferredRailsGet200ResponseDataPreferredRailsInner) SetMandateRef(v string) {
	o.MandateRef.Set(&v)
}
// SetMandateRefNil sets the value for MandateRef to be an explicit nil
func (o *CustomersPreferredRailsGet200ResponseDataPreferredRailsInner) SetMandateRefNil() {
	o.MandateRef.Set(nil)
}

// UnsetMandateRef ensures that no value is present for MandateRef, not even an explicit nil
func (o *CustomersPreferredRailsGet200ResponseDataPreferredRailsInner) UnsetMandateRef() {
	o.MandateRef.Unset()
}
...
func (o CustomersPreferredRailsGet200ResponseDataPreferredRailsInner) ToMap() (map[string]interface{}, error) {
	...
	if o.MandateRef.IsSet() {
		toSerialize["mandate_ref"] = o.MandateRef.Get()
	}
