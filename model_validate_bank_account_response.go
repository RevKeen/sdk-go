...
// checks if the ValidateBankAccountResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ValidateBankAccountResponse{}

// ValidateBankAccountResponse Result of a Direct Debit bank-account validation check.
type ValidateBankAccountResponse struct {
	...
	DdEnabled bool `json:"dd_enabled"`
	// Validation error messages, if any
	Errors []string `json:"errors,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _ValidateBankAccountResponse ValidateBankAccountResponse
...
func NewValidateBankAccountResponse(valid bool, bankName NullableString, ddEnabled bool) *ValidateBankAccountResponse {
	this := ValidateBankAccountResponse{}
	this.Valid = valid
...
// GetDdEnabled returns the DdEnabled field value
...
// GetDdEnabledOk returns a tuple with the DdEnabled field value
// and a boolean to check if the value has been set.
func (o *ValidateBankAccountResponse) GetDdEnabledOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return &o.DdEnabled, true
}

// SetDdEnabled sets field value
...
func (o ValidateBankAccountResponse) MarshalJSON() ([]byte, error) {
...
func (o ValidateBankAccountResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["valid"] = o.Valid
	toSerialize["bank_name"] = o.BankName.Get()
	toSerialize["dd_enabled"] = o.DdEnabled
	if o.Errors != nil {
...
func (o *ValidateBankAccountResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varValidateBankAccountResponse := _ValidateBankAccountResponse{}

	err = json.Unmarshal(data, &varValidateBankAccountResponse)

	if err != nil {
		return err
	}

	*o = ValidateBankAccountResponse(varValidateBankAccountResponse)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "dd_enabled")
...
type NullableValidateBankAccountResponse struct {
	value *ValidateBankAccountResponse
	isSet bool
}

func (v NullableValidateBankAccountResponse) Get() *ValidateBankAccountResponse {
	return v.value
}

func (v *NullableValidateBankAccountResponse) Set(val *ValidateBankAccountResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableValidateBankAccountResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableValidateBankAccountResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableValidateBankAccountResponse(val *ValidateBankAccountResponse) *NullableValidateBankAccountResponse {
	return &NullableValidateBankAccountResponse{value: val, isSet: true}
}

func (v NullableValidateBankAccountResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableValidateBankAccountResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
