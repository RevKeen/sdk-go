...
// checks if the CreateSubscriptionItemInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateSubscriptionItemInput{}

// CreateSubscriptionItemInput Parameters for adding a new line item to an existing subscription.
...
type _CreateSubscriptionItemInput CreateSubscriptionItemInput
...
func NewCreateSubscriptionItemInput(currency string, unitAmountMinor int32) *CreateSubscriptionItemInput {
	this := CreateSubscriptionItemInput{}
...
func (o CreateSubscriptionItemInput) MarshalJSON() ([]byte, error) {
...
func (o CreateSubscriptionItemInput) ToMap() (map[string]interface{}, error) {
...
func (o *CreateSubscriptionItemInput) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateSubscriptionItemInput := _CreateSubscriptionItemInput{}

	err = json.Unmarshal(data, &varCreateSubscriptionItemInput)

	if err != nil {
		return err
	}

	*o = CreateSubscriptionItemInput(varCreateSubscriptionItemInput)
...
type NullableCreateSubscriptionItemInput struct {
	value *CreateSubscriptionItemInput
	isSet bool
}

func (v NullableCreateSubscriptionItemInput) Get() *CreateSubscriptionItemInput {
	return v.value
}

func (v *NullableCreateSubscriptionItemInput) Set(val *CreateSubscriptionItemInput) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateSubscriptionItemInput) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateSubscriptionItemInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateSubscriptionItemInput(val *CreateSubscriptionItemInput) *NullableCreateSubscriptionItemInput {
	return &NullableCreateSubscriptionItemInput{value: val, isSet: true}
}

func (v NullableCreateSubscriptionItemInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateSubscriptionItemInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
