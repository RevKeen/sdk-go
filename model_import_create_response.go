...
// ImportCreateResponse The created import job in 'pending' status.
...
func NewImportCreateResponse(data Import) *ImportCreateResponse {
...
func (o *ImportCreateResponse) GetData() Import {
	if o == nil {
		var ret Import
		return ret
	}
...
func (o *ImportCreateResponse) GetDataOk() (*Import, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *ImportCreateResponse) SetData(v Import) {
	o.Data = v
}
...
func (o *ImportCreateResponse) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varImportCreateResponse)
