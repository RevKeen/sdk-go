...
// checks if the StorefrontKeyStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StorefrontKeyStatus{}

// StorefrontKeyStatus Managed Cart key presence. Key material is never returned.
type StorefrontKeyStatus struct {
...
type _StorefrontKeyStatus StorefrontKeyStatus
...
func (o StorefrontKeyStatus) MarshalJSON() ([]byte, error) {
...
func (o StorefrontKeyStatus) ToMap() (map[string]interface{}, error) {
...
func (o *StorefrontKeyStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varStorefrontKeyStatus := _StorefrontKeyStatus{}

	err = json.Unmarshal(data, &varStorefrontKeyStatus)

	if err != nil {
		return err
	}

	*o = StorefrontKeyStatus(varStorefrontKeyStatus)
...
type NullableStorefrontKeyStatus struct {
	value *StorefrontKeyStatus
	isSet bool
}

func (v NullableStorefrontKeyStatus) Get() *StorefrontKeyStatus {
	return v.value
}

func (v *NullableStorefrontKeyStatus) Set(val *StorefrontKeyStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableStorefrontKeyStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableStorefrontKeyStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStorefrontKeyStatus(val *StorefrontKeyStatus) *NullableStorefrontKeyStatus {
	return &NullableStorefrontKeyStatus{value: val, isSet: true}
}

func (v NullableStorefrontKeyStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStorefrontKeyStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
