...
type ProductsAPI interface {
	...
	*/
	...
	/*
	ProductsExternalBatch Batch upsert products by external ID
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiProductsExternalBatchRequest
	*/
	ProductsExternalBatch(ctx context.Context) ApiProductsExternalBatchRequest

	// ProductsExternalBatchExecute executes the request
	//  @return ProductsExternalBatch200Response
	ProductsExternalBatchExecute(r ApiProductsExternalBatchRequest) (*ProductsExternalBatch200Response, *http.Response, error)

	/*
	ProductsExternalUpsert Upsert product by external ID

	Create or update a product by external system ID. Uses stale update protection.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param source Integration source (e.g., practicehub, wodify)
	@param externalId External system's product ID
	@return ApiProductsExternalUpsertRequest
	*/
	ProductsExternalUpsert(ctx context.Context, source string, externalId string) ApiProductsExternalUpsertRequest

	// ProductsExternalUpsertExecute executes the request
	//  @return ProductsExternalUpsert200Response
	ProductsExternalUpsertExecute(r ApiProductsExternalUpsertRequest) (*ProductsExternalUpsert200Response, *http.Response, error)
	...
	*/
	...
	/*
	ProductsRetrieve Get product by ID
	...
	*/
	ProductsRetrieve(ctx context.Context, id string) ApiProductsRetrieveRequest

	// ProductsRetrieveExecute executes the request
	//  @return ProductRetrieveResponse
	ProductsRetrieveExecute(r ApiProductsRetrieveRequest) (*ProductRetrieveResponse, *http.Response, error)
...
type ApiProductsExternalBatchRequest struct {
	ctx context.Context
	ApiService ProductsAPI
	productsExternalBatchRequest *ProductsExternalBatchRequest
}

func (r ApiProductsExternalBatchRequest) ProductsExternalBatchRequest(productsExternalBatchRequest ProductsExternalBatchRequest) ApiProductsExternalBatchRequest {
	r.productsExternalBatchRequest = &productsExternalBatchRequest
	return r
}

func (r ApiProductsExternalBatchRequest) Execute() (*ProductsExternalBatch200Response, *http.Response, error) {
	return r.ApiService.ProductsExternalBatchExecute(r)
}
...
Create or update multiple products by external system ID. Supports up to 100 products per request with stale update protection.
 ...
 @return ApiProductsExternalBatchRequest
*/
func (a *ProductsAPIService) ProductsExternalBatch(ctx context.Context) ApiProductsExternalBatchRequest {
	return ApiProductsExternalBatchRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return ProductsExternalBatch200Response
func (a *ProductsAPIService) ProductsExternalBatchExecute(r ApiProductsExternalBatchRequest) (*ProductsExternalBatch200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ProductsExternalBatch200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ProductsAPIService.ProductsExternalBatch")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/products/external/batch"
	...
	// body params
	localVarPostBody = r.productsExternalBatchRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["apiKey"]; ok {
...
type ApiProductsExternalUpsertRequest struct {
	ctx context.Context
	ApiService ProductsAPI
	source string
	externalId string
...
func (r ApiProductsExternalUpsertRequest) ProductsExternalUpsertRequest(productsExternalUpsertRequest ProductsExternalUpsertRequest) ApiProductsExternalUpsertRequest {
	r.productsExternalUpsertRequest = &productsExternalUpsertRequest
	return r
}

func (r ApiProductsExternalUpsertRequest) Execute() (*ProductsExternalUpsert200Response, *http.Response, error) {
	return r.ApiService.ProductsExternalUpsertExecute(r)
}
...
Create or update a product by external system ID. Uses stale update protection.
 ...
 @return ApiProductsExternalUpsertRequest
*/
func (a *ProductsAPIService) ProductsExternalUpsert(ctx context.Context, source string, externalId string) ApiProductsExternalUpsertRequest {
	return ApiProductsExternalUpsertRequest{
		ApiService: a,
		ctx: ctx,
		source: source,
...
// Execute executes the request
//  @return ProductsExternalUpsert200Response
func (a *ProductsAPIService) ProductsExternalUpsertExecute(r ApiProductsExternalUpsertRequest) (*ProductsExternalUpsert200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ProductsExternalUpsert200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ProductsAPIService.ProductsExternalUpsert")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/products/external/{source}/{externalId}"
	...
	// body params
	localVarPostBody = r.productsExternalUpsertRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["apiKey"]; ok {
...
func (r ApiProductsRetrieveRequest) Execute() (*ProductRetrieveResponse, *http.Response, error) {
...
Get a product by its ID. Requires 'products:read' scope.
 ...
 @return ApiProductsRetrieveRequest
*/
func (a *ProductsAPIService) ProductsRetrieve(ctx context.Context, id string) ApiProductsRetrieveRequest {
	return ApiProductsRetrieveRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return ProductRetrieveResponse
func (a *ProductsAPIService) ProductsRetrieveExecute(r ApiProductsRetrieveRequest) (*ProductRetrieveResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
