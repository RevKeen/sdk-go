...
// checks if the UpdateTaxRateRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateTaxRateRequest{}

// UpdateTaxRateRequest Parameters for updating a tax rate. Active tax rates on existing invoices are not retroactively changed.
...
type _UpdateTaxRateRequest UpdateTaxRateRequest
...
func (o *UpdateTaxRateRequest) SetDescriptionNil() {
...
func (o *UpdateTaxRateRequest) SetJurisdictionNil() {
...
func (o *UpdateTaxRateRequest) SetCountryNil() {
	o.Country.Set(nil)
}
...
func (o *UpdateTaxRateRequest) SetStateNil() {
	o.State.Set(nil)
}
...
func (o UpdateTaxRateRequest) MarshalJSON() ([]byte, error) {
...
func (o UpdateTaxRateRequest) ToMap() (map[string]interface{}, error) {
...
func (o *UpdateTaxRateRequest) UnmarshalJSON(data []byte) (err error) {
	varUpdateTaxRateRequest := _UpdateTaxRateRequest{}

	err = json.Unmarshal(data, &varUpdateTaxRateRequest)

	if err != nil {
		return err
	}

	*o = UpdateTaxRateRequest(varUpdateTaxRateRequest)
...
type NullableUpdateTaxRateRequest struct {
	value *UpdateTaxRateRequest
	isSet bool
}

func (v NullableUpdateTaxRateRequest) Get() *UpdateTaxRateRequest {
	return v.value
}

func (v *NullableUpdateTaxRateRequest) Set(val *UpdateTaxRateRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateTaxRateRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateTaxRateRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateTaxRateRequest(val *UpdateTaxRateRequest) *NullableUpdateTaxRateRequest {
	return &NullableUpdateTaxRateRequest{value: val, isSet: true}
}

func (v NullableUpdateTaxRateRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateTaxRateRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
