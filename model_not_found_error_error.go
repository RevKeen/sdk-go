...
// checks if the NotFoundErrorError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NotFoundErrorError{}
...
type _NotFoundErrorError NotFoundErrorError
...
func (o NotFoundErrorError) ToMap() (map[string]interface{}, error) {
...
func (o *NotFoundErrorError) UnmarshalJSON(data []byte) (err error) {
	...
	varNotFoundErrorError := _NotFoundErrorError{}

	err = json.Unmarshal(data, &varNotFoundErrorError)

	if err != nil {
		return err
	}

	*o = NotFoundErrorError(varNotFoundErrorError)
