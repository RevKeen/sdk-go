...
// PriceTransformQuantity Optional quantity transform (package pricing) applied before tier lookup. Immutable after creation.
...
type _PriceTransformQuantity PriceTransformQuantity
...
func (o *PriceTransformQuantity) UnmarshalJSON(data []byte) (err error) {
	...
	varPriceTransformQuantity := _PriceTransformQuantity{}

	err = json.Unmarshal(data, &varPriceTransformQuantity)

	if err != nil {
		return err
	}

	*o = PriceTransformQuantity(varPriceTransformQuantity)
