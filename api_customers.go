...
type CustomersAPI interface {
	...
	*/
	...
	/*
	CustomersRetrieve Get customer by ID

	Retrieve detailed information about a specific customer

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id Customer UUID
	@return ApiCustomersRetrieveRequest
	*/
	CustomersRetrieve(ctx context.Context, id string) ApiCustomersRetrieveRequest

	// CustomersRetrieveExecute executes the request
	//  @return CustomerRetrieveResponse
	CustomersRetrieveExecute(r ApiCustomersRetrieveRequest) (*CustomerRetrieveResponse, *http.Response, error)
...
type ApiCustomersRetrieveRequest struct {
	ctx context.Context
	ApiService CustomersAPI
	id string
}

func (r ApiCustomersRetrieveRequest) Execute() (*CustomerRetrieveResponse, *http.Response, error) {
	return r.ApiService.CustomersRetrieveExecute(r)
}
...
Retrieve detailed information about a specific customer
 ...
 @return ApiCustomersRetrieveRequest
*/
func (a *CustomersAPIService) CustomersRetrieve(ctx context.Context, id string) ApiCustomersRetrieveRequest {
	return ApiCustomersRetrieveRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return CustomerRetrieveResponse
func (a *CustomersAPIService) CustomersRetrieveExecute(r ApiCustomersRetrieveRequest) (*CustomerRetrieveResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CustomersAPIService.CustomersRetrieve")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
