...
// checks if the CreateImportRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateImportRequest{}

// CreateImportRequest Parameters for creating a bulk data import. Either provide a file_url or upload the CSV via multipart form data.
type CreateImportRequest struct {
	...
	ColumnMapping map[string]interface{} `json:"column_mapping,omitempty"`
...
type _CreateImportRequest CreateImportRequest
...
func NewCreateImportRequest(resourceType string) *CreateImportRequest {
	this := CreateImportRequest{}
	this.ResourceType = resourceType
	var onDuplicate string = "skip"
...
func (o CreateImportRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateImportRequest) ToMap() (map[string]interface{}, error) {
...
func (o *CreateImportRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateImportRequest := _CreateImportRequest{}

	err = json.Unmarshal(data, &varCreateImportRequest)

	if err != nil {
		return err
	}

	*o = CreateImportRequest(varCreateImportRequest)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "column_mapping")
		delete(additionalProperties, "on_duplicate")
...
type NullableCreateImportRequest struct {
	value *CreateImportRequest
	isSet bool
}

func (v NullableCreateImportRequest) Get() *CreateImportRequest {
	return v.value
}

func (v *NullableCreateImportRequest) Set(val *CreateImportRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateImportRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateImportRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateImportRequest(val *CreateImportRequest) *NullableCreateImportRequest {
	return &NullableCreateImportRequest{value: val, isSet: true}
}

func (v NullableCreateImportRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateImportRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
