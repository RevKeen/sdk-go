...
// PayOrderRequest Parameters for paying an order, specifying the payment method and optional partial amount.
...
type _PayOrderRequest PayOrderRequest
...
func (o *PayOrderRequest) UnmarshalJSON(data []byte) (err error) {
	varPayOrderRequest := _PayOrderRequest{}

	err = json.Unmarshal(data, &varPayOrderRequest)

	if err != nil {
		return err
	}

	*o = PayOrderRequest(varPayOrderRequest)
