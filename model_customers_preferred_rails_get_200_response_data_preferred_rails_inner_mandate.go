...
type CustomersPreferredRailsGet200ResponseDataPreferredRailsInnerMandate struct {
	...
	BureauSuspendConfirmed NullableBool `json:"bureau_suspend_confirmed,omitempty"`
...
// GetBureauSuspendConfirmed returns the BureauSuspendConfirmed field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *CustomersPreferredRailsGet200ResponseDataPreferredRailsInnerMandate) GetBureauSuspendConfirmed() bool {
	if o == nil || IsNil(o.BureauSuspendConfirmed.Get()) {
		var ret bool
		return ret
	}
	return *o.BureauSuspendConfirmed.Get()
}

// GetBureauSuspendConfirmedOk returns a tuple with the BureauSuspendConfirmed field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *CustomersPreferredRailsGet200ResponseDataPreferredRailsInnerMandate) GetBureauSuspendConfirmedOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return o.BureauSuspendConfirmed.Get(), o.BureauSuspendConfirmed.IsSet()
}

// HasBureauSuspendConfirmed returns a boolean if a field has been set.
func (o *CustomersPreferredRailsGet200ResponseDataPreferredRailsInnerMandate) HasBureauSuspendConfirmed() bool {
	if o != nil && o.BureauSuspendConfirmed.IsSet() {
		return true
	}
...
// SetBureauSuspendConfirmed gets a reference to the given NullableBool and assigns it to the BureauSuspendConfirmed field.
func (o *CustomersPreferredRailsGet200ResponseDataPreferredRailsInnerMandate) SetBureauSuspendConfirmed(v bool) {
	o.BureauSuspendConfirmed.Set(&v)
}
// SetBureauSuspendConfirmedNil sets the value for BureauSuspendConfirmed to be an explicit nil
func (o *CustomersPreferredRailsGet200ResponseDataPreferredRailsInnerMandate) SetBureauSuspendConfirmedNil() {
	o.BureauSuspendConfirmed.Set(nil)
}

// UnsetBureauSuspendConfirmed ensures that no value is present for BureauSuspendConfirmed, not even an explicit nil
func (o *CustomersPreferredRailsGet200ResponseDataPreferredRailsInnerMandate) UnsetBureauSuspendConfirmed() {
	o.BureauSuspendConfirmed.Unset()
}
...
func (o CustomersPreferredRailsGet200ResponseDataPreferredRailsInnerMandate) ToMap() (map[string]interface{}, error) {
	...
	if o.BureauSuspendConfirmed.IsSet() {
		toSerialize["bureau_suspend_confirmed"] = o.BureauSuspendConfirmed.Get()
	}
...
func (o *CustomersPreferredRailsGet200ResponseDataPreferredRailsInnerMandate) UnmarshalJSON(data []byte) (err error) {
	...
	*o = CustomersPreferredRailsGet200ResponseDataPreferredRailsInnerMandate(varCustomersPreferredRailsGet200ResponseDataPreferredRailsInnerMandate)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "bureau_suspend_confirmed")
