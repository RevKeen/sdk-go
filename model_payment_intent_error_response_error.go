...
// checks if the PaymentIntentErrorResponseError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaymentIntentErrorResponseError{}

// PaymentIntentErrorResponseError struct for PaymentIntentErrorResponseError
...
type _PaymentIntentErrorResponseError PaymentIntentErrorResponseError
...
func NewPaymentIntentErrorResponseError(type_ string, code string, message string) *PaymentIntentErrorResponseError {
	this := PaymentIntentErrorResponseError{}
	this.Type = type_
	this.Code = code
...
func (o PaymentIntentErrorResponseError) MarshalJSON() ([]byte, error) {
...
func (o PaymentIntentErrorResponseError) ToMap() (map[string]interface{}, error) {
...
func (o *PaymentIntentErrorResponseError) UnmarshalJSON(data []byte) (err error) {
	...
	varPaymentIntentErrorResponseError := _PaymentIntentErrorResponseError{}

	err = json.Unmarshal(data, &varPaymentIntentErrorResponseError)

	if err != nil {
		return err
	}

	*o = PaymentIntentErrorResponseError(varPaymentIntentErrorResponseError)
...
type NullablePaymentIntentErrorResponseError struct {
	value *PaymentIntentErrorResponseError
	isSet bool
}

func (v NullablePaymentIntentErrorResponseError) Get() *PaymentIntentErrorResponseError {
	return v.value
}

func (v *NullablePaymentIntentErrorResponseError) Set(val *PaymentIntentErrorResponseError) {
	v.value = val
	v.isSet = true
}

func (v NullablePaymentIntentErrorResponseError) IsSet() bool {
	return v.isSet
}

func (v *NullablePaymentIntentErrorResponseError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaymentIntentErrorResponseError(val *PaymentIntentErrorResponseError) *NullablePaymentIntentErrorResponseError {
	return &NullablePaymentIntentErrorResponseError{value: val, isSet: true}
}

func (v NullablePaymentIntentErrorResponseError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaymentIntentErrorResponseError) UnmarshalJSON(src []byte) error {
	v.isSet = true
