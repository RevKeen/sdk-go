...
// checks if the InvoiceSubscriptionTerms type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InvoiceSubscriptionTerms{}

// InvoiceSubscriptionTerms Subscription billing terms for recurring invoices
...
type _InvoiceSubscriptionTerms InvoiceSubscriptionTerms
...
func (o InvoiceSubscriptionTerms) MarshalJSON() ([]byte, error) {
...
func (o InvoiceSubscriptionTerms) ToMap() (map[string]interface{}, error) {
...
func (o *InvoiceSubscriptionTerms) UnmarshalJSON(data []byte) (err error) {
	...
	varInvoiceSubscriptionTerms := _InvoiceSubscriptionTerms{}

	err = json.Unmarshal(data, &varInvoiceSubscriptionTerms)

	if err != nil {
		return err
	}

	*o = InvoiceSubscriptionTerms(varInvoiceSubscriptionTerms)
...
type NullableInvoiceSubscriptionTerms struct {
	value *InvoiceSubscriptionTerms
	isSet bool
}

func (v NullableInvoiceSubscriptionTerms) Get() *InvoiceSubscriptionTerms {
	return v.value
}

func (v *NullableInvoiceSubscriptionTerms) Set(val *InvoiceSubscriptionTerms) {
	v.value = val
	v.isSet = true
}

func (v NullableInvoiceSubscriptionTerms) IsSet() bool {
	return v.isSet
}

func (v *NullableInvoiceSubscriptionTerms) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInvoiceSubscriptionTerms(val *InvoiceSubscriptionTerms) *NullableInvoiceSubscriptionTerms {
	return &NullableInvoiceSubscriptionTerms{value: val, isSet: true}
}

func (v NullableInvoiceSubscriptionTerms) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInvoiceSubscriptionTerms) UnmarshalJSON(src []byte) error {
	v.isSet = true
