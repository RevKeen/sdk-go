...
// SubscriptionCancelResponse The subscription after cancellation, showing the effective end date and final billing period.
...
func NewSubscriptionCancelResponse(success bool) *SubscriptionCancelResponse {
...
func (o *SubscriptionCancelResponse) GetSuccess() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
func (o *SubscriptionCancelResponse) GetSuccessOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *SubscriptionCancelResponse) SetSuccess(v bool) {
	o.Success = v
}

func (o SubscriptionCancelResponse) MarshalJSON() ([]byte, error) {
...
func (o *SubscriptionCancelResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varSubscriptionCancelResponse := _SubscriptionCancelResponse{}

	err = json.Unmarshal(data, &varSubscriptionCancelResponse)

	if err != nil {
		return err
	}

	*o = SubscriptionCancelResponse(varSubscriptionCancelResponse)
