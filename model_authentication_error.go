...
// AuthenticationError Returned when the API key is missing, invalid, or expired. Verify your x-api-key header contains a valid key.
type AuthenticationError struct {
	Error AuthenticationErrorError `json:"error"`
...
func NewAuthenticationError(error_ AuthenticationErrorError) *AuthenticationError {
...
func (o *AuthenticationError) GetError() AuthenticationErrorError {
	if o == nil {
		var ret AuthenticationErrorError
		return ret
	}
...
func (o *AuthenticationError) GetErrorOk() (*AuthenticationErrorError, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Error, true
...
func (o *AuthenticationError) SetError(v AuthenticationErrorError) {
	o.Error = v
}
...
func (o *AuthenticationError) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varAuthenticationError)
