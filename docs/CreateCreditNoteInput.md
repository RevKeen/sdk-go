...
**AmountMinor** | **float32** | Amount to credit in cents | 
**TaxAmountMinor** | Pointer to **float32** | Tax portion of the credit in cents (for UK/EU VAT compliance) | [optional] 
...
**ProrationDaysTotal** | Pointer to **float32** | Total days in the billing period (for prorated credits) | [optional] 
**ProrationDaysUnused** | Pointer to **float32** | Unused days in the billing period (for prorated credits) | [optional] 
...
**AutoRoute** | Pointer to **bool** | When true, automatically trigger the process-credit-note task for multi-gateway reversal routing. Response will include gateway_operations array. | [optional] [default to false]
**CustomerPresent** | Pointer to **bool** | For terminal (card-present) transactions: whether the customer is physically at the terminal. Defaults to false in API context. | [optional] [default to false]

## Methods

### NewCreateCreditNoteInput

`func NewCreateCreditNoteInput(invoiceId string, amountMinor float32, ) *CreateCreditNoteInput`
...
`func (o *CreateCreditNoteInput) GetAmountMinor() float32`

GetAmountMinor returns the AmountMinor field if non-nil, zero value otherwise.

### GetAmountMinorOk

`func (o *CreateCreditNoteInput) GetAmountMinorOk() (*float32, bool)`
...
`func (o *CreateCreditNoteInput) SetAmountMinor(v float32)`
...
`func (o *CreateCreditNoteInput) GetTaxAmountMinor() float32`

GetTaxAmountMinor returns the TaxAmountMinor field if non-nil, zero value otherwise.

### GetTaxAmountMinorOk

`func (o *CreateCreditNoteInput) GetTaxAmountMinorOk() (*float32, bool)`
...
`func (o *CreateCreditNoteInput) SetTaxAmountMinor(v float32)`
...
`func (o *CreateCreditNoteInput) GetProrationDaysTotal() float32`

GetProrationDaysTotal returns the ProrationDaysTotal field if non-nil, zero value otherwise.

### GetProrationDaysTotalOk

`func (o *CreateCreditNoteInput) GetProrationDaysTotalOk() (*float32, bool)`
...
`func (o *CreateCreditNoteInput) SetProrationDaysTotal(v float32)`
...
`func (o *CreateCreditNoteInput) GetProrationDaysUnused() float32`

GetProrationDaysUnused returns the ProrationDaysUnused field if non-nil, zero value otherwise.

### GetProrationDaysUnusedOk

`func (o *CreateCreditNoteInput) GetProrationDaysUnusedOk() (*float32, bool)`
...
`func (o *CreateCreditNoteInput) SetProrationDaysUnused(v float32)`
...
`func (o *CreateCreditNoteInput) GetCustomerPresent() bool`

GetCustomerPresent returns the CustomerPresent field if non-nil, zero value otherwise.

### GetCustomerPresentOk

`func (o *CreateCreditNoteInput) GetCustomerPresentOk() (*bool, bool)`

GetCustomerPresentOk returns a tuple with the CustomerPresent field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetCustomerPresent

`func (o *CreateCreditNoteInput) SetCustomerPresent(v bool)`

SetCustomerPresent sets CustomerPresent field to given value.

### HasCustomerPresent

`func (o *CreateCreditNoteInput) HasCustomerPresent() bool`

HasCustomerPresent returns a boolean if a field has been set.
