...
// checks if the CreateOrderRequestLineItemsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateOrderRequestLineItemsInner{}

// CreateOrderRequestLineItemsInner struct for CreateOrderRequestLineItemsInner
type CreateOrderRequestLineItemsInner struct {
...
type _CreateOrderRequestLineItemsInner CreateOrderRequestLineItemsInner
...
func NewCreateOrderRequestLineItemsInner(description string, unitPrice int32) *CreateOrderRequestLineItemsInner {
	this := CreateOrderRequestLineItemsInner{}
...
func (o CreateOrderRequestLineItemsInner) MarshalJSON() ([]byte, error) {
...
func (o CreateOrderRequestLineItemsInner) ToMap() (map[string]interface{}, error) {
...
func (o *CreateOrderRequestLineItemsInner) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateOrderRequestLineItemsInner := _CreateOrderRequestLineItemsInner{}

	err = json.Unmarshal(data, &varCreateOrderRequestLineItemsInner)

	if err != nil {
		return err
	}

	*o = CreateOrderRequestLineItemsInner(varCreateOrderRequestLineItemsInner)
...
type NullableCreateOrderRequestLineItemsInner struct {
	value *CreateOrderRequestLineItemsInner
	isSet bool
}

func (v NullableCreateOrderRequestLineItemsInner) Get() *CreateOrderRequestLineItemsInner {
	return v.value
}

func (v *NullableCreateOrderRequestLineItemsInner) Set(val *CreateOrderRequestLineItemsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateOrderRequestLineItemsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateOrderRequestLineItemsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateOrderRequestLineItemsInner(val *CreateOrderRequestLineItemsInner) *NullableCreateOrderRequestLineItemsInner {
	return &NullableCreateOrderRequestLineItemsInner{value: val, isSet: true}
}

func (v NullableCreateOrderRequestLineItemsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateOrderRequestLineItemsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
