...
type PricesAPI interface {
	...
	*/
	...
	/*
	PricesRetrieve Retrieve a price

	Retrieves a price by its ID.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id Price ID
	@return ApiPricesRetrieveRequest
	*/
	PricesRetrieve(ctx context.Context, id string) ApiPricesRetrieveRequest

	// PricesRetrieveExecute executes the request
	//  @return Price
	PricesRetrieveExecute(r ApiPricesRetrieveRequest) (*Price, *http.Response, error)
...
type ApiPricesRetrieveRequest struct {
	ctx context.Context
	ApiService PricesAPI
	id string
}

func (r ApiPricesRetrieveRequest) Execute() (*Price, *http.Response, error) {
	return r.ApiService.PricesRetrieveExecute(r)
}
...
Retrieves a price by its ID.
 ...
 @return ApiPricesRetrieveRequest
*/
func (a *PricesAPIService) PricesRetrieve(ctx context.Context, id string) ApiPricesRetrieveRequest {
	return ApiPricesRetrieveRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return Price
func (a *PricesAPIService) PricesRetrieveExecute(r ApiPricesRetrieveRequest) (*Price, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PricesAPIService.PricesRetrieve")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
