...
type AnalyticsRevenueMrrSummary200Response struct {
	...
	PreviousMrr float32 `json:"previous_mrr"`
	// Net MRR growth in minor units
	Growth float32 `json:"growth"`
	// MRR from new subscriptions
	NewMrr float32 `json:"new_mrr"`
	// MRR lost to churn
	ChurnedMrr float32 `json:"churned_mrr"`
	// MRR gained from upgrades
	ExpansionMrr float32 `json:"expansion_mrr"`
	// MRR lost to downgrades
	ContractionMrr float32 `json:"contraction_mrr"`
...
func (o AnalyticsRevenueMrrSummary200Response) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["current_mrr"] = o.CurrentMrr
	toSerialize["previous_mrr"] = o.PreviousMrr
	toSerialize["growth"] = o.Growth
	toSerialize["new_mrr"] = o.NewMrr
	toSerialize["churned_mrr"] = o.ChurnedMrr
	toSerialize["expansion_mrr"] = o.ExpansionMrr
	toSerialize["contraction_mrr"] = o.ContractionMrr
	toSerialize["as_of_date"] = o.AsOfDate
...
func (o *AnalyticsRevenueMrrSummary200Response) UnmarshalJSON(data []byte) (err error) {
	...
	*o = AnalyticsRevenueMrrSummary200Response(varAnalyticsRevenueMrrSummary200Response)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "current_mrr")
		delete(additionalProperties, "previous_mrr")
		delete(additionalProperties, "growth")
		delete(additionalProperties, "new_mrr")
		delete(additionalProperties, "churned_mrr")
		delete(additionalProperties, "expansion_mrr")
		delete(additionalProperties, "contraction_mrr")
		delete(additionalProperties, "as_of_date")
