...
// checks if the BatchIngestResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BatchIngestResult{}

// BatchIngestResult Result of a batch ingest operation showing how many events were accepted, skipped, duplicated, or rejected. duplicate means the event's idempotency_key has already been seen for this merchant.
type BatchIngestResult struct {
	Object string `json:"object"`
	Summary BatchIngestResultSummary `json:"summary"`
	Data []BatchIngestResultDataInner `json:"data"`
	AdditionalProperties map[string]interface{}
}

type _BatchIngestResult BatchIngestResult
...
func (o *BatchIngestResult) GetSummary() BatchIngestResultSummary {
	if o == nil {
		var ret BatchIngestResultSummary
		return ret
	}
...
func (o *BatchIngestResult) GetData() []BatchIngestResultDataInner {
	if o == nil {
		var ret []BatchIngestResultDataInner
		return ret
	}
...
func (o BatchIngestResult) MarshalJSON() ([]byte, error) {
...
func (o BatchIngestResult) ToMap() (map[string]interface{}, error) {
...
func (o *BatchIngestResult) UnmarshalJSON(data []byte) (err error) {
	...
	varBatchIngestResult := _BatchIngestResult{}

	err = json.Unmarshal(data, &varBatchIngestResult)

	if err != nil {
		return err
	}

	*o = BatchIngestResult(varBatchIngestResult)
...
type NullableBatchIngestResult struct {
	value *BatchIngestResult
	isSet bool
}

func (v NullableBatchIngestResult) Get() *BatchIngestResult {
	return v.value
}

func (v *NullableBatchIngestResult) Set(val *BatchIngestResult) {
	v.value = val
	v.isSet = true
}

func (v NullableBatchIngestResult) IsSet() bool {
	return v.isSet
}

func (v *NullableBatchIngestResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBatchIngestResult(val *BatchIngestResult) *NullableBatchIngestResult {
	return &NullableBatchIngestResult{value: val, isSet: true}
}

func (v NullableBatchIngestResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBatchIngestResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
