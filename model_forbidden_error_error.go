...
// checks if the ForbiddenErrorError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ForbiddenErrorError{}
...
type _ForbiddenErrorError ForbiddenErrorError

// NewForbiddenErrorError instantiates a new ForbiddenErrorError object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewForbiddenErrorError(type_ string, code string, message string) *ForbiddenErrorError {
...
func (o *ForbiddenErrorError) GetCode() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ForbiddenErrorError) GetCodeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Code, true
...
func (o *ForbiddenErrorError) SetCode(v string) {
	o.Code = v
}
...
func (o *ForbiddenErrorError) GetRequestId() string {
...
// and a boolean to check if the value has been set.
func (o *ForbiddenErrorError) GetRequestIdOk() (*string, bool) {
	if o == nil || IsNil(o.RequestId) {
		return nil, false
	}
...
func (o *ForbiddenErrorError) HasRequestId() bool {
	if o != nil && !IsNil(o.RequestId) {
		return true
	}
...
func (o *ForbiddenErrorError) SetRequestId(v string) {
	o.RequestId = &v
}
...
func (o ForbiddenErrorError) ToMap() (map[string]interface{}, error) {
...
func (o *ForbiddenErrorError) UnmarshalJSON(data []byte) (err error) {
	...
	varForbiddenErrorError := _ForbiddenErrorError{}

	err = json.Unmarshal(data, &varForbiddenErrorError)

	if err != nil {
		return err
	}

	*o = ForbiddenErrorError(varForbiddenErrorError)
