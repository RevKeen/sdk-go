...
// checks if the FinanceGetIncome200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FinanceGetIncome200Response{}

// FinanceGetIncome200Response struct for FinanceGetIncome200Response
type FinanceGetIncome200Response struct {
	Summary FinanceGetIncome200ResponseSummary `json:"summary"`
	// Income report rows
	Rows []map[string]interface{} `json:"rows"`
	AdditionalProperties map[string]interface{}
}

type _FinanceGetIncome200Response FinanceGetIncome200Response
...
func NewFinanceGetIncome200Response(summary FinanceGetIncome200ResponseSummary, rows []map[string]interface{}) *FinanceGetIncome200Response {
	this := FinanceGetIncome200Response{}
...
func (o *FinanceGetIncome200Response) GetSummary() FinanceGetIncome200ResponseSummary {
	if o == nil {
		var ret FinanceGetIncome200ResponseSummary
		return ret
	}
...
func (o FinanceGetIncome200Response) MarshalJSON() ([]byte, error) {
...
func (o FinanceGetIncome200Response) ToMap() (map[string]interface{}, error) {
...
func (o *FinanceGetIncome200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varFinanceGetIncome200Response := _FinanceGetIncome200Response{}

	err = json.Unmarshal(data, &varFinanceGetIncome200Response)

	if err != nil {
		return err
	}

	*o = FinanceGetIncome200Response(varFinanceGetIncome200Response)
...
type NullableFinanceGetIncome200Response struct {
	value *FinanceGetIncome200Response
	isSet bool
}

func (v NullableFinanceGetIncome200Response) Get() *FinanceGetIncome200Response {
	return v.value
}

func (v *NullableFinanceGetIncome200Response) Set(val *FinanceGetIncome200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableFinanceGetIncome200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableFinanceGetIncome200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFinanceGetIncome200Response(val *FinanceGetIncome200Response) *NullableFinanceGetIncome200Response {
	return &NullableFinanceGetIncome200Response{value: val, isSet: true}
}

func (v NullableFinanceGetIncome200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFinanceGetIncome200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
