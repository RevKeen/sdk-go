...
func main() {
	id := "38400000-8cf0-11bd-b23e-10b96e4ef00d" // string | Credit note UUID
	limit := int32(56) // int32 | Maximum number of line items to return (1-100, default 100). (optional) (default to 100)
 ...
 **limit** | **int32** | Maximum number of line items to return (1-100, default 100). | [default to 100]
